...
<button type="button" class="btn btn-info  btn-ml" onClick="boxPopup('<?=linkboxPopup();?>pop_add_poll.php?poll_id=<?=$poll_id;?>');" title="<?=$txt_poll_add;;?>"  target="_self">
<i class="fas fa-plus-circle"></i>&nbsp;<?=$txt_poll_add;?>
</button>

<button type="button" class="btn btn-info  btn-ml " onclick="boxPopup('<?=linkboxPopup();?>pop_search_poll.php');" title="<?=$txt_poll_search;?>" >
...
<div class="btn-group ">
        ...
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a onClick="boxPopup('<?=linkboxPopup();?>pop_add_poll.php?poll_id=<?=$poll_id;?>');" ><i class="fas fa-plus-circle"></i>&nbsp;<?=$txt_poll_add;;?></a></li>
          	<li><a onClick="boxPopup('<?=linkboxPopup();?>pop_search_poll.php');" ><i class="fas fa-search"></i>&nbsp;<?=$txt_poll_search;?></a></li>
		</ul>
</div>
</div>	
</div>
        ...
        <div class="panel panel-default ">
            ...
            <div id="collapseOne<?=$i;?>" class="panel-collapse collapse">
                <div class="panel-body">
					...
					&nbsp;&nbsp;<?=$a_data['c_start'];?> to <?=$a_data['c_stop'];?> 
					</div>
					<br>
...
<a href="#" onclick="boxPopup('<?=linkboxPopup();?>poll_ans_view.php?c_id=<?php echo $a_data['c_id'];?>&no=<?php echo ($i+1);?>');" data-toggle="tooltip" data-placement="right" title="ดูผลโหวต">					
<button type="button" class="btn btn-default btn-circle btn-sm "  >
<i class="fas fa-search" aria-hidden="true"></i>
</button>
</a>

<a href="poll_builder.php?c_id=<?=$a_data['c_id'];?>" data-toggle="tooltip" data-placement="right" title="แก้ไขคำตอบ">					
<button type="button" class="btn btn-default btn-circle btn-sm "  >
<i class="fa fa-th-list   text-dark" aria-hidden="true"></i>
</button>
</a>

<a onClick="boxPopup('<?=linkboxPopup();?>pop_edit_poll.php?c_id=<?=$a_data['c_id'];?>');" data-toggle="tooltip" data-placement="right" title="<?=$txt_poll_edit;?>">					
<button type="button" class="btn btn-default btn-circle btn-sm "  >
<i class="far fa-edit" aria-hidden="true"></i>
</button>
</a>

<a onClick="JQDel_Poll('<?=$a_data['c_id'];?>');" data-toggle="tooltip" data-placement="right" title="<?php echo $txt_poll_delete;?>">
<button type="button" class="btn btn-default  btn-circle  btn-sm "  >
<i class="far fa-trash-alt" aria-hidden="true"></i>
</button>
</a>
...
<button type="button" class="btn btn-default btn-circle btn-sm " id="lang<?=$a_data['c_id'];?>" >
<i class="fa fa-language" aria-hidden="true"></i>
</button>
</a>-->
