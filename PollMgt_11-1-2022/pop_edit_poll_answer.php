...
?>
<form id="form_main" name="form_main" method="POST" action="<?=getLocation('func_edit_poll_answer')?>" enctype="multipart/form-data" >
...
<h4 class="modal-title  color-white"><i class="fas fa-plus-circle"></i>  <?='แก้ไขคำตอบแบบสำรวจ';?></h4>
</div>
...
<label for="poll_title" class="col-sm-12 control-label"><b><?='คำตอบแบบสำรวจ';?> <span class="text-danger"><code>*</code></span> :</b></label>
<div class="col-md-12 col-sm-12 col-xs-12" >
<textarea class="form-control" placeholder="<?='คำตอบแบบสำรวจ';?>"  rows="6" id="poll_ans_title" name="poll_ans_title"  required="required" ><?=$a_data['a_name'];?></textarea>
</div>
</div>
