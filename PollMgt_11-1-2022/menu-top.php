...
<img src="<?=$IMG_PATH ;?>images/Polls.png" class="animated fadeInDown " style="height: 60px;width: 60px;">  
<span class="animated fadeInDown text-large hidden-xs"><?=$txt_poll_module;?></span>
</div>
...
<button type="button" class="btn btn-default btn-sm" >
          <i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?=$txt_poll_menu_main;?>
</button>
</a>
...
<div class="btn-group ">
        ...
        <ul class="dropdown-menu dropdown-menu-right">
            ...
            <li><a href="faq_group.php"><i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?=$txt_poll_menu_main;?></a></li>
		</ul>
</div>
</div>
