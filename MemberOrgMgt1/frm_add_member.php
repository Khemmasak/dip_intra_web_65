...
<?php /*<table width="94%" border="0" align="center" cellpadding="0" cellspacing="0" class="ewtfunctionmenu">
    <tr>
      <td align="right">
	  <?php if($_GET[proc]!='edit'){ ?>&nbsp;<a href="MemberList.php"><img src="../theme/main_theme/g_back.png" width="16" height="16" border="0" align="absmiddle"> 
     กลับ</a><?php } ?>
        <hr>
      </td>
    </tr>
...
<td height="50" bgcolor="#FFFFFF" colspan="3">ข้อมูลบุคลากร </td>
</tr>
