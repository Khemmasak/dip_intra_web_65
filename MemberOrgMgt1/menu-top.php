...
<img src="<?=$IMG_PATH ;?>images/Artboard 20.png" class="animated fadeInDown " style="height: 60px;width: 60px;">  
<span class="animated fadeInDown text-large hidden-xs"><?=$txt_org_module ;?></span>
</div>
...
<button type="button" class="btn btn-default btn-sm" >
          <i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?=$txt_org_menu_main;?>
</button>
</a>
<?php if($db->check_permission("org","u","")){ ?>
<a href="org_list.php"  target="_self">
<button type="button" class="btn btn-default btn-sm" >
          <i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?=$txt_org_menu_list;?>
</button>
</a>
<?php } if($db->check_permission("org","o","")){ ?>
<a href="org_group.php" target="_self">
<button type="button" class="btn btn-default btn-sm" >
           <i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?=$txt_org_menu_group;?>
</button>
</a>
<?php } if($db->check_permission("org","p","")){ ?>
<a href="org_position.php"  target="_self">
<button type="button" class="btn btn-default btn-sm" >
          <i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?=$txt_org_menu_postion;?>
</button>
</a>
...
<button type="button" class="btn btn-default btn-sm" >
         <i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?=$txt_org_menu_nametitle;?>
</button>
</a>
<?php } 

/*if($db->check_permission("org","m","")){ ?>
<a href="org_chart.php"  target="_self">
<button type="button" class="btn btn-default btn-sm" >
         <i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?=$txt_org_menu_chart;?>
</button>
</a>
<?php }*/ ?>
</div>
...
<div class="btn-group ">
        ...
        <ul class="dropdown-menu dropdown-menu-right">
            ...
            <li><a href="org_dashboard.php"><i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?=$txt_org_menu_main;?></a></li>
			<li><a href="org_list.php"><i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?=$txt_org_menu_list;?></a></li>
			<li><a href="org_position.php"><i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?=$txt_org_menu_group;?></a></li>
			<li><a href="org_title.php"><i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?=$txt_org_menu_postion;?></a></li>
			<li><a href="org_chart.php"><i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?=$txt_org_menu_chart;?></a></li>
