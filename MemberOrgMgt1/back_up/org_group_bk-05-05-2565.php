...
<tr class="success">
                ...
                <th width="60%" class="text-center" ><?php echo $txt_org_group_name;?></th>
                <th width="15%" class="text-center" ><?php echo $txt_ewt_multilang;?></th>
...
<a onClick="txt_data('<?php echo $a_video['vdo_id'];?>','')" >
<button type="button" class="btn btn-info  btn-circle  btn-xs " id="lang<?php echo $a_video['vdo_id'];?>" data-toggle="tooltip" data-placement="top" title="<?php echo $txt_ewt_create_multilang;?>" >
...
while($a_data = $db->db_fetch_array($s_sql)){
?>	
<div class="panel panel-default " id="<?php echo $a_data['org_id'];?>"  >
            ...
            <div id="collapseOne<?php echo $i;?>" class="panel-collapse collapse">
                <div class="panel-body">
                   	<div><b><?php echo $txt_org_group_name;?> :</b> <?php echo $a_data['name_org'];?></div><br> 
					<div><b><?php echo $txt_org_group_name_short;?> :</b> <?php echo $a_data['short_name'];?></div><br>
					<div><b><?php echo $txt_org_group_tel;?> :</b> <?php echo $a_data['tel'];?></div><br> 
					<div><b><?php echo $txt_org_group_fax;?> :</b> <?php echo $a_data['fax'];?></div><br> 
					<div><b><?php echo $txt_org_group_email;?> :</b> <?php echo $a_data['email'];?></div><br> 
					<div><!--<?php org::chkStatusOrg($a_data['org_status']);?>--></div><br> 					
					<div class="text-left">
					<span class="label label-primary "><?php echo $txt_ewt_multilang; ?></span> 
					<?php if(show_icon_lang_ewt($a_data['org_id'],'org_name')) { ?>
					<button  type="button" class="btn btn-default   btn-sm " data-toggle="tooltip" data-placement="top" title="" >-->
					<?//=show_icon_lang_ewt($a_data['org_id'],'org_name');?>
					<!--</button>-->
					<?php } ?>
					</div>
				</div>	
...
<a onClick="txt_data('<?php echo $a_data['org_id'];?>','')" >
<button type="button" class="btn btn-info  btn-circle  btn-xs " id="lang<?php echo $a_data['org_id'];?>" data-toggle="tooltip" data-placement="top" title="<?php echo $txt_ewt_create_multilang;?>" >
<i class="fa fa-language" aria-hidden="true"></i>
</button>
</a>
<a onClick="boxPopup('<?php echo linkboxPopup();?>pop_edit_org_group.php?org_id=<?php echo $a_data['org_id'];?>');">
<button type="button" class="btn btn-default  btn-circle  btn-xs "  data-toggle="tooltip" data-placement="top" title="<?php echo $txt_org_edit_group;?>" >
<i class="fa fa-edit" aria-hidden="true"></i>
</button>
</a>
<a onClick="JQDel_Org_Group('<?php echo $a_data['org_id'];?>');" >
<button type="button" class="btn btn-default  btn-circle  btn-sm " data-toggle="tooltip" data-placement="top" title="<?php echo $txt_org_delete_group;?>"   >
<i class="far fa-trash-alt" aria-hidden="true"></i>
</button>
</a>
