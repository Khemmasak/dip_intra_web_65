...
<div class="col-md-12 col-sm-12 col-xs-12" >
<input type="text" class="form-control phone"  placeholder="<?php echo $txt_org_list_tel_in;?>" id="txt_org_list_tel_in" name="txt_org_list_tel_in"  required="required"  value="<?php echo $a_genuser['tel_in'];?>"  />
<span class="text-danger">
<code>
Ex. 999-999-9999
</code>
...
<div class="col-md-12 col-sm-12 col-xs-12" >
<div class="radio">
  <label><input type="radio" name="org_status" value="1" <?php if($a_genuser['status'] == '1'){ echo 'checked'; }?> ><?php echo $txt_org_status_y;?>
  <span class="cr"><i class="cr-icon fas fa-check color-ewt"></i></span>
  </label>
</div>
<div class="radio">
  <label><input type="radio" name="org_status" value="2" <?php if($a_genuser['status'] == '2'){ echo 'checked'; }?> ><?php echo $txt_org_status_n;?>
  <span class="cr"><i class="cr-icon fas fa-check color-ewt"></i></span>
  </label>
</div>
</div>
...
<div class="form-group row " ><hr>
	...
	<div class="col-md-12 col-sm-12 col-xs-12" >
		<div class="radio">
			<label><input type="radio" name="ldap_use" value="0" <?php if($a_genuser['ldap_user']==0){echo "checked";} ?>> No
			<span class="cr"><i class="cr-icon fas fa-check color-ewt"></i></span>
			</label>
		</div>
		<div class="radio">
			<label><input type="radio" name="ldap_use" value="1" <?php if($a_genuser['ldap_user']==1){echo "checked";} ?>> Yes
			<span class="cr"><i class="cr-icon fas fa-check color-ewt"></i></span>
			</label>
		</div>
	</div>
...
<div class="form-group row userpass_section " <?php if($a_genuser['ldap_user']==1){echo "hidden";} ?> >
