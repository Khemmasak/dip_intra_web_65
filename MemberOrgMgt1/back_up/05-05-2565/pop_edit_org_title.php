...
$title_id = (int)(!isset($_GET['title_id']) ? 0 : $_GET['title_id']);

$db->query("USE ".$EWT_DB_USER);	
$s_sql	=	$db->query("SELECT * FROM `title`  WHERE  `title_id` = '{$title_id}' ");
...
<input type="hidden" name="title_id" id="title_id"  value="<?=$a_data['title_id'];?>" >
<div class="container" >   
...
<label for="org_title_name" class="col-sm-12 control-label"><b><?=$txt_org_group_name;?> <span class="text-danger"><code>*</code></span> :</b></label>
<div class="col-md-12 col-sm-12 col-xs-12" >
<textarea class="form-control" placeholder="<?=$txt_org_group_name;?>"  rows="6" id="org_title_name" name="org_title_name"  required="required" ><?=$a_data['title_thai'];?></textarea>
</div>
</div>
