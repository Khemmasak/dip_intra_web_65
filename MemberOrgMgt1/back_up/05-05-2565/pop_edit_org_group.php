...
$org_id = (int)(!isset($_GET['org_id']) ? 0 : $_GET['org_id']);

$db->query("USE ".$EWT_DB_USER);	
$s_sql	=	$db->query("SELECT * FROM `org_name`  WHERE  `org_id` = '{$org_id}' ");
...
<input type="hidden" name="org_id" id="org_id"  value="<?=$a_data['org_id'];?>" >
<div class="container" >   
...
<textarea class="form-control" placeholder="<?=$txt_org_group_name;?>"  rows="6" id="org_group_name" name="org_group_name"  required="required" ><?=$a_data['name_org'];?></textarea>
</div>
</div>
<div class="form-group row " >
<label for="org_group_name_short" class="col-sm-12 control-label"><b><?=$txt_org_group_name_short;?>  :</b></label>
<div class="col-md-12 col-sm-12 col-xs-12" >
<textarea class="form-control" placeholder="<?=$txt_org_group_name_short;?>"  rows="6" id="org_group_name_short" name="org_group_name_short"  ><?=$a_data['short_name'];?></textarea>
</div>
</div>
<div class="form-group row " >
<label for="org_group_tel" class="col-sm-12 control-label"><b><?=$txt_org_group_tel;?>  :</b></label>
<div class="col-md-12 col-sm-12 col-xs-12" >
<input class="form-control checknumber" placeholder="<?=$txt_org_group_tel;?>" id="org_group_tel" name="org_group_tel"  type="text" value="<?=$a_data['tel'];?>" >
</div>
</div>
<div class="form-group row " >
<label for="org_group_fax" class="col-sm-12 control-label"><b><?=$txt_org_group_fax;?>  :</b></label>
<div class="col-md-12 col-sm-12 col-xs-12" >
<input class="form-control checknumber" placeholder="<?=$txt_org_group_fax;?>" id="org_group_fax" name="org_group_fax"  type="text" value="<?=$a_data['fax'];?>">
</div>
</div>
<div class="form-group row " >
<label for="org_group_email" class="col-sm-12 control-label"><b><?=$txt_org_group_email;?>  :</b></label>
<div class="col-md-12 col-sm-12 col-xs-12" >
<input class="form-control checkmail" placeholder="<?=$txt_org_group_email;?>" id="org_group_email" name="org_group_email"  type="text"  value="<?=$a_data['email'];?>" >
</div>
</div>
...
<div class="col-md-12 col-sm-12 col-xs-12" >
<div class="radio">
  <label><input type="radio" name="org_group_use" value="Y" <?php if($a_data['org_status'] == 'Y' || $a_data['pos_status'] == ''){ echo 'checked'; } ?>><?=$txt_org_status_y;?>
  <span class="cr"><i class="cr-icon fas fa-check color-ewt"></i></span>
  </label>
</div>
<div class="radio">
  <label><input type="radio" name="org_group_use" value="N" <?php if($a_data['org_status'] == 'N' ){ echo 'checked'; } ?>><?=$txt_org_status_n;?>
  <span class="cr"><i class="cr-icon fas fa-check color-ewt"></i></span>
  </label>
</div>
</div>
