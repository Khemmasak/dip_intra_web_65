...
$sql = "SELECT * FROM USR_POSITION WHERE POS_STATUS = 'Y' AND POS_ID = '{$POS_ID}'";
						...
						<div class="scrollbar scrollbar-near-moon thin">
							<div class="card-body">
								...
								<div class="form-group row ">
									...
									<div class="col-md-12 col-sm-12 col-xs-12">
										<div class="radio">
											<label><input type="radio" name="pos_name_use" value="Y" <?php if ($a_data['POS_STATUS'] == 'Y' || $a_data['POS_STATUS'] == '') {
																											echo 'checked';
																										} ?>><?= $txt_org_status_y; ?>
										...
										<div class="radio">
											<label><input type="radio" name="pos_name_use" value="N" <?php if ($a_data['POS_STATUS'] == 'N') {
																											echo 'checked';
																										} ?>><?= $txt_org_status_n; ?>
												<span class="cr"><i class="cr-icon fas fa-check color-ewt"></i></span>
											</label>
