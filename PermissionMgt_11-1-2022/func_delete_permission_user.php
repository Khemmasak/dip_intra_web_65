...
if($a_data['proc']=='DelPermisUser'){
	
del('web_group_member',"ugm_tid='{$a_data['id']}' AND ug_id='{$_SESSION['EWT_SUID']}' AND ugm_type='U'");
del('permission',"pu_id='{$a_data['id']}'AND UID='{$_SESSION['EWT_SUID']}'AND p_type='U'");
