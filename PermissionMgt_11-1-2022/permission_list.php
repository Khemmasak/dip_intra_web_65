...
<h4><?=$txt_permission_menu_user;?></h4>
<p></p> 
...
<ol class="breadcrumb">
<li><a href="permission_main.php"><?=$txt_permission_menu_main;?></a></li>
<li class=""><?=$txt_permission_menu_user;?></li>       
</ol>
</div>
...
<p><h4><?=$txt_permission_menu_user;?></h4></p>
</div>
</div>
<div class="card-body">
...
<div class="panel panel-default ">
            <div class="panel-heading ewt-bg-success">
                <h4 class="panel-title">
					...
					<?=$a_data['topic'];?> <?=complain_category($a_data['flag']);?>
					</a>					
                </h4>
            </div>
            ...
            <div id="collapseOne<?=$i;?>" class="panel-collapse collapse">
                <div class="panel-body">
                   	<div><b><?=$txt_complain_detail;?> :</b> <?=$a_data['detail'];?></div><br> 
					<div><b><?=$txt_complain_name;?> :</b> <?php $name = explode('#@#',$a_data['name']);
					echo $name[0]." - ".$name[1];
					?>
					</div><br> 
					<div><b><?=$txt_complain_email;?> :</b> <?=$a_data['email'];?></div><br> 
					<div><b><?=$txt_complain_tel;?> :</b> <?=$a_data['tel'];?></div><br> 
                </div>
