...
<?php /*<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 m-b-sm">
<a class="card card-banner card-blue-light" onclick="window.location.href='permission_group.php'"  >
<!-- The number of first-time users during the selected date range.    -->
<div class="card-body">
<i class="icon fas fa-database fa-4x"></i>
    <div class="content">
      <div class="title"><h4>กลุ่มสิทธิ์ผู้ใช้งานระบบ <!--ู้เข้าชมเว็บไซต์ใหม่--></h4></div>
      <div class="value"><span class="sign"></span><span class="counter"></span></div>
    </div>
  </div>
</a>
</div>
