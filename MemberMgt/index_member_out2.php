...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#333333">
  ...
  <tr> 
    <td width="60" height="58"><img src="../theme/main_theme/g_member_64.gif"> </td>
                <td><span class="ewthead">Edit Profile</span>
  ...
  <tr> 
    <td valign="top" bgcolor="#FFFFFF"><table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
                      <tr> 
                        <td bgcolor="#FFFFFF"><iframe name="member_body" src="frm_edit_member.php?proc=edit"  frameborder="0"  width="100%" height="100%" scrolling="yes"></iframe></td>
                      </tr>
