...
<label for="topic"><?php echo "หัวข้อ";?><span class="text-danger">*</span> : </label>        
<?php echo $a_feed['egp_list_title'];?>	
</div>
</div>
<div class="form-group row">
<div class="col-md-12 col-sm-12 col-xs-12">
<label for="topic"><?php echo "ประเภทประกาศ";?><span class="text-danger">*</span> : </label>        
<?php echo $a_feed['egp_type_name'];?>		
</div>
</div>
<div class="form-group row">
<div class="col-md-12 col-sm-12 col-xs-12">
<label for="topic"><?php echo "วีธีการจัดหา";?><span class="text-danger">*</span> : </label>        
<?php echo $a_feed['egp_process_name'];?>		
</div>
</div>

<div class="form-group row">
<div class="col-md-12 col-sm-12 col-xs-12">
<label for="topic"><?php echo "ชื่อหน่วยงาน";?><span class="text-danger">*</span> : </label>        
<?php echo $a_feed['egp_dept_name'];?>		
</div>
</div>

<div class="form-group row">
<div class="col-md-12 col-sm-12 col-xs-12">
<label for="topic"><?php echo "ไฟล์แนบ";?><span class="text-danger">*</span> : </label> 
<a href="<?php echo $a_feed['egp_list_url'];?>" target="blank">      
<button type="button" class="btn btn-info  btn-ml "  >
		<span class="glyphicon glyphicon-file "></span>&nbsp;<?php echo "เปิดดูไฟล์";?>
		</button>	
		</a>
</div>
</div>
		...
		<span class="glyphicon glyphicon-remove"></span>&nbsp;<?php echo "ปิด";?>
		</button>
