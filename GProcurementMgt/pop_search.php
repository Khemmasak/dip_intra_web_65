...
<h4 class="modal-title  color-white"><i class="fas fa-plus-circle"></i> <?php echo $txt_menu_search;?></h4>
</div>

	
<form name="form_main" id="form_main" method="GET" action="<?php echo getLocation('gprocurement')?>"  >
...
<label for="keyword" class="col-sm-12 control-label"><b><?php echo $txt_ewt_keyword; ?>  :</b></label>
...
<button onclick="JQSearch_Menu($('#form_main'));" class="btn btn-success btn-lm" data-toggle="tooltip" data-placement="top" title="<?php echo $txt_ewt_submit;?>" >
...
function JQSearch_Menu(form,id){	
