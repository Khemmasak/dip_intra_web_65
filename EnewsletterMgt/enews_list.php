...
<ol class="breadcrumb">
<li><a href="calendar_list.php"><?=$txt_enews_member;?></a></li>
<li class=""></li>       
</ol>
</div>
...
<i class="fas fa-plus-circle"></i>&nbsp;<?=$txt_enews_sent_enews;?>
</button>
</a>
...
<div class="panel panel-default ">
            ...
            <div id="collapseOne<?=$i;?>" class="panel-collapse collapse">
                <div class="panel-body">
                   	<div><?=$a_data['event_detail'];?></div><br> 
					<div><i class="far fa-clock"></i>&nbsp;&nbsp;<?=$a_data['event_date_start'];?> to  <?=$a_data['event_date_end'];?></div> 
...
<a onClick="JQDelete_Calendar(<?=$a_data['event_id']?>);" data-toggle="tooltip" data-placement="top" title="<?=$txt_calendar_delete;?>" > 
<button type="button" class="btn btn-default  btn-circle  btn-sm "  >
<i class="far fa-trash-alt" aria-hidden="true"></i>
</button>

<a onClick="boxPopup('<?=linkboxPopup();?>pop_edit_calendar.php?cal_id=<?=$a_data['event_id'];?>');" data-toggle="tooltip" data-placement="top" title="<?=$txt_calendar_edit;?>">					
<button type="button" class="btn btn-default btn-circle btn-sm "  >
