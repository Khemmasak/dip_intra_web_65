...
$ExecSel = mysqli_query($Sel);
$nof = mysqli_num_fields($ExecSel); 
$totalrows = mysqli_num_rows($ExecSel);
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="ewtfunctionmenu">
  <tr>
    <td align="right"><!--<a href="javascript:void(0);" onClick="load_divForm('../FavoritesMgt/favorites_add.php?name=<?php echo urlencode("จดหมายข่าว");?>&module=newsletter&url=<?php echo urlencode("temp_mod.php");?>', 'divForm', 300, 80, -1,433, 1);"><img src="../images/star_yellow_add.gif" width="16" height="16" border="0" align="middle">&nbsp;Add to favorites </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
	<!--../ewt/<?php //echo $_SESSION["EWT_SUSER"]; ?>/temp_add.php?Flag=Add -->
	<a href="#" onClick="window.open('temp_add.php?Flag=Add','TempAdd','height=450,width=970,resizable=1,scrollbars=1');" ><img src="../theme/main_theme/g_add.gif" width="16" height="16" border="0" align="absmiddle"> 
      เพิ่มจดหมายข่าว </a>
	  
	  <!--<a href="#" class="btn btn-info btn-sm" onclick="boxPopup('<?//=linkboxPopup();?>temp_add.php');" ><img src="../theme/main_theme/g_add.gif" width="16" height="16" border="0" align="absmiddle"> 
      เพิ่มจดหมายข่าว </a>-->
      <hr>
    </td>
  </tr>
        ...
        <table width="90%" align="center" class="table table-bordered">
		  ...
		  if($totalrows != 0){
$i = 0;
while($R = mysqli_fetch_array($ExecShow )){
?>
          <tr bgcolor="ECEBF0"> 
		  <td align="center" bgcolor="#FFFFFF"><nobr>
		  <a href="#" onClick="window.open('temp_preview.php?tid=<?php echo $R['t_name'];?>','TempPreview','height=550,width=600,resizable=1,scrollbars=1');"><img src="../theme/main_theme/g_view.gif" width="16" height="16" border="0" alt="เรียกดู"> </a>
      <a href="#" onClick="window.open('temp_add.php?tid=<?php echo $R['t_id'];?>&Flag=Edit','TempEdit','height=450,width=970,resizable=1,scrollbars=1');"><img src="../theme/main_theme/g_edit.gif" width="16" height="16" border="0" alt="แก้ไข"></a>
