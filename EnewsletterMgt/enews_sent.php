...
<h4><i class="far fa-paper-plane"></i>&nbsp;<?=$txt_enews_sent_enews;?></h4>
<p></p> 
...
<li><?=$txt_enews_sent_enews;?></li>  
</ol>
</div>

<div class="col-md-12 col-sm-12 col-xs-12 float-right text-right hidden-xs"  >	  

<button type="button" class="btn btn-info  btn-ml"  onClick="boxPopup('<?=linkboxPopup();?>pop_add_enews.php"  title="<?=$txt_enews_sent_enews;?>"  target="_self">
