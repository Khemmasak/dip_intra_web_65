...
<div class="modal-content">
        <div class="modal-header ewt-bg-color b-t-l-6 b-t-r-6">
          ...
          <h4 class="modal-title color-white"><i class="fas fa-search"></i> <?php echo $txt_banner_search;?></h4>
        </div>
		
<form name="form_main" id="form_main" method="GET" action="<?php echo getLocation('banner_search')?>"  >
...
<div class="form-group row " >
<label for="banner_gid" class="col-sm-12 control-label"><b><?php echo $txt_banner_cate;?>  :</b></label>
<div class="col-md-12 col-sm-12 col-xs-12" >
<select name="banner_gid" id="banner_gid" class="form-control"  >
<option value=""selected="" disabled="disabled" ><?php echo $txt_banner_select_cate;?></option> 
<?php
