...
<div class="container-fluid">
	...
	if (trim($keyword) != "") {
		$name_cond = " AND banner_name LIKE '%" . $keyword . "%' ";
	}
	...
	$s_banner = $db->query("SELECT * FROM banner WHERE 1=1 $group_cond $name_cond ORDER BY banner_position ASC,banner_id ASC");
		...
		<div class="col-md-12 col-sm-12 col-xs-12 m-b-sm">
			...
			<div class="card">
				...
				<div class="card-header">
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12 m-b-sm">
							<h4><?= "การจัดการแบนเนอร์"; ?></h4>
							<p></p>
						</div>
						<div class="col-md-12 col-sm-12 col-xs-12 m-b-sm">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<ol class="breadcrumb">
									<li><a href="banner_group.php"><?= "การจัดการแบนเนอร์"; ?></a></li>
									<li class=""></li>
								</ol>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-md-2 col-sm-2 col-xs-12 text-center hidden-xs">
								...
								<div class="col-md-4 col-sm-4 col-xs-12 float-center text-center hidden-xs">
									...
									<!-- boxPopup('<?= linkboxPopup(); ?>pop_search_banner.php'); -->
									<a href="#" target="_self" onclick="bannerSearch();" data-toggle="tooltip" data-placement="buttom" title="Search">
										<button type="button" class="btn btn-info btn-ml ">
									...
									<table width="100%" class="table table-bordered" id="table-1" align="center">
										<thead>
											<tr class="nodrop nodrag success">
												<th width="10%"></th>
												<th width="40%" class="text-center"><?php echo "รูปแบนเนอร์"; ?></th>
												<th width="30%" class="text-center"><?php echo "ชื่อแบนเนอร์"; ?></th>
											...
											<?php } else { ?>
												<tr>
													<th colspan="3" scope="col">
														<div align="center" style="color:#FF0000"><?php echo $text_genbanner_notfound ?></div>
													</th>
												</tr>
											<?php
											}
