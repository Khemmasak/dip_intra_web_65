            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <span class="animated fadeInDown text-large hidden-xs"><?= "Banner Management"; ?></span>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 float-right text-right hidden-xs" style="top:18px;">
                        ...
                        <a href="banner_group.php">
                            <button type="button" class="btn btn-default btn-sm">
                                <i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?= $txt_banner_cate; ?>
                            </button>
                        </a>

                        <!-- <a href="banner_stat.php">
                            <button type="button" class="btn btn-default btn-sm">
                                <i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?= $txt_banner_stat; ?>
                            </button>
                        </a> -->
                    </div>
