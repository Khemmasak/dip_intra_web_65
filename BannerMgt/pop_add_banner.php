...
?>	
<form id="form_main" name="form_main" method="POST" action="<?php echo getLocation('func_add_banner')?>" enctype="multipart/form-data" >
...
<h4 class="modal-title  color-white"><i class="fas fa-plus-circle"></i> <?php echo $txt_banner_add;?></h4>
</div>
...
<label for="banner_name" class="col-sm-6 control-label"><b><?php echo $txt_banner_name;?> <span class="text-danger"><code>*</code></span> :</b></label>
<div class="col-md-12 col-sm-12 col-xs-12" >
<input class="form-control" placeholder="<?php echo $txt_banner_name;?>" name="banner_name" type="text" id="banner_name"  value="" required="required" />
</div>
</div>
<!--ซ่อนไว้ก่อน <div class="form-group row " >
<label for="banner_detail" class="col-sm-6 control-label"><b><?php echo $txt_banner_detail;?> :</b></label>
<div class="col-md-12 col-sm-12 col-xs-12" >
<textarea class="form-control" placeholder="<?php echo $txt_banner_detail;?>"  rows="5" id="banner_detail" name="banner_detail"  ></textarea>
</div>
</div> -->
<div class="form-group row " >
<label for="banner_category" class="col-sm-12 control-label"><b><?php echo $txt_banner_cate;?> <span class="text-danger"><code>*</code></span> : <b></label>
<div class="col-md-12 col-sm-12 col-xs-12" >
<select name="banner_category" id="banner_category" class="form-control" required="required" >
<option value=""selected="" disabled="disabled" ><?php echo $txt_banner_cate;?></option> 
<?php
...
<!--<div class="form-group row " >
<label for="banner_pic" class="col-sm-6 control-label"><b><?php echo $txt_banner_image ;?> <span class="text-danger"><code>*</code></span> :</b></label>
<div class="col-md-10 col-sm-10 col-xs-12" >
<input class="form-control" placeholder="<?php echo $txt_banner_image ;?>"  name="banner_pic" type="text" id="banner_pic"  value="" required="required" />
</div>
...
<div class="col-md-12 col-sm-12 col-xs-12" >
<input type="file" name="banner_pic" id="banner_pic" placeholder="<?php echo $txt_banner_image ;?>" class="form-control" onchange="JSCheck_Img_vdo(this.id,this.value);" required="required" />
<?php
if(!empty($a_data['banner_pic'])){
?>
<span><?php echo $a_data['banner_pic'];?></span><br>
<?php } ?>
...
<div class="form-group row " >
<label for="banner_link" class="col-sm-6 control-label"><b><?php echo $txt_banner_link;?> <span class="text-danger"><code>*</code></span> :</b></label>
<div class="col-md-7 col-sm-7 col-xs-12" >
<input class="form-control" placeholder="<?php echo $txt_banner_link;?>" name="banner_link" type="text" id="banner_link"  value="" required="required" />   
</div>
<div class="col-md-2 col-sm-2 col-xs-12" >
...
<div class="col-md-12 col-sm-12 col-xs-12" >
<input class="form-control" placeholder="<?php echo $text_genbanner_formalt;?>"  name="banner_alt" type="text" id="banner_alt"  value=""  />
</div>
</div>
<div class="form-group row">
...
<label for="start_date"><b><?php echo "วันที่ในการแสดงผลเริ่มต้น";?> : </b></label>
            <div class='input-group date' id='datetimepicker1'>
                <input type='text' class="form-control datepicker cal" placeholder="<?php echo "วันที่ใช้ในการแสดงผลเริ่มต้น";?>" name="start_date"  id="start_date" value="" >
...
<label for="end_date"><b><?php echo "วันที่ในการแสดงผลสิ้นสุด";?> : </b></label>
            <div class='input-group date' id='datetimepicker2'>
                <input type='text' class="form-control datepicker cal" placeholder="<?php echo "วันที่ใช้ในการแสดงผลสิ้นสุด";?>"  name="end_date"  id="end_date" value="" >
                <span class="input-group-addon">
                    <i class="far fa-calendar-alt"></i>
                </span>
            </div>
