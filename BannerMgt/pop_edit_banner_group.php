...
<input type="text" class="form-control" placeholder="<?=$txt_banner_w_placeholder;?>"  id="banner_w" name="banner_w"  value="<?=$a_group['banner_w'];?>"/> 
...
<input type="text" class="form-control" placeholder="<?=$txt_banner_w_placeholder;?>"  id="banner_h" name="banner_h" value="<?=$a_group['banner_h'];?>"/> 
