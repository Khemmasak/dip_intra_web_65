...
<h4><?php echo $txt_calendar_cate;?></h4>
<p></p> 
...
<ol class="breadcrumb">
<li><a href="calendar_list.php"><?php echo $txt_calendar_cate;?></a></li>
<li class=""></li>       
</ol>
</div>
...
<button type="button" class="btn btn-info  btn-ml" onClick="boxPopup('<?php echo linkboxPopup();?>pop_add_calendar_group.php?cal_cid=<?php echo $cal_cid;?>');">
...
<div class="panel panel-default ">
            <div class="panel-heading ewt-bg-success">			
                <h4 class="panel-title"><img src="<?php echo $IMG_PATH ;?>images/grabme.svg">  
					...
					<?php echo $a_data['cat_name'];?> 
					</a>	<span class="pull-right">	
					<a onClick="JQDelete_Calendar_Cat(<?php echo $a_data['cat_id']?>);"  > 
<button type="button" class="btn btn-danger  btn-circle  btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo $txt_calendar_delete_cate;?>"  >
<i class="far fa-trash-alt" aria-hidden="true"></i>
</button>
</a>
                    <a onClick="boxPopup('<?php echo linkboxPopup();?>pop_edit_calendar_group.php?cat_id=<?php echo $a_data['cat_id'];?>');" >					
<button type="button" class="btn btn-warning btn-circle btn-sm"  data-toggle="tooltip" data-placement="top" title="<?php echo $txt_calendar_edit_cate;?>" >
...
<div class="m-b"><h4><i class="fas fa-angle-right color-ewt" _style="color:#FFBE7D;"></i> <span class="text-danger"> จำนวนปฏิทินกิจกรรมภายในหมวด  <?php echo $a_row_event;?>	 กิจกรรม </span></h4></div>
<div class="m-b"><b><i class="fas fa-angle-right color-ewt" _style="color:#FFBE7D;"></i> สีหมวดปฏิทินกิจกรรม : </b><i class="fas fa-stop fa-2x" style="color:<?php echo $a_data['cat_color'];?> ;" ></i></div>
<div class="m-b"><b><i class="fas fa-angle-right color-ewt" _style="color:#FFBE7D;"></i> ประเภท : </b> <?php echo getCateType($a_data['cat_type']);?> </div>
<?php
if($a_data['cat_type'] == '2'){
?>
<div class="m-b"><b><i class="fas fa-angle-right color-ewt" _style="color:#FFBE7D;"></i> ผู้บริหาร : </b> <span class='text-default'><img src='<?php echo $a_data_user['m_images'];?>' alt='' class='img-circle img-rounded ' style='width:30px;height:30px;'> <?php echo $a_data_user['m_name']; ?> <?php echo $a_data_user['m_surname']; ?></span> </div>
<?php } ?>
<br><div class="m-b"><h4><span class="label label-primary "><?php echo $txt_ewt_multilang; ?></span></h4> 
<?php if(show_icon_lang($a_data['cat_id'],'cal_category')) { ?>
<button  type="button" class="btn btn-default  btn-ml " <?php echo $disabled;?> data-toggle="tooltip" data-placement="top" title="<?php echo $a_data['lang_config_name'];?>" ><?php echo show_icon_lang($a_data['cat_id'],'cal_category');?></button>
<?php } ?>
</div>
</div> 
...
<!-- <a onClick="txt_data('<?php echo $a_data['cat_id'];?>','')" >
<button type="button" class="btn btn-info  btn-circle  btn-xs" id="lang<?php echo $a_data['cat_id'];?>" data-toggle="tooltip" data-placement="top" title="<?php echo $txt_ewt_create_multilang;?>" >
