...
$page_link = "<a href=\"faq_sub.php\"><img src=\"../theme/main_theme/g_back.gif\" width=\"16\" height=\"16\" align=\"absmiddle\" border=\"0\">".$page_name."</a>";
}else{
	if($_GET["flag"]=='add'){
		...
		$t_parent =  $R_EDIT[f_parent];
		$t_subid =  $R_EDIT[f_sub_id];
	}
	$page_name = $text_general_back;
...
$function_name1 = "<a href=\"faq_sub.php\">".$text_genfaq_category." : ".$R1[f_cate]."</a> >>".$function_name;
//}else{
...
<table width="94%" border="0" align="center" cellpadding="5" cellspacing="0" class="ewtfunctionmenu">
  <tr>
    <td align="right"><a href="javascript:void(0);" onClick="load_divForm('../FavoritesMgt/favorites_add.php?name=<?php echo urlencode($function_name.">".$t_topic);?>&module=faq&url=<?php echo urlencode("faq_add.php?type=category_sub&flag=".$_GET["flag"]."&f_sub_id=".$_GET["f_sub_id"]."&f_id=".$_GET["f_id"]);?>', 'divForm', 300, 80, -1,433, 1);"><img src="../images/star_yellow_add.gif" width="16" height="16" border="0" align="middle">&nbsp;Add to favorites </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $page_link;?>
    <hr> </td>
  </tr>
</table>
<table width="70%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CECECE"  class="ewttableuse">
  ...
  <tr valign="top" bgcolor="#FFFFFF"> 
		  ...
		  <td><DIV style="HEIGHT: 300;OVERFLOW-Y: scroll;WIDTH: 100%;">
			  <input type="radio" name="c_parent" value="0" <?php if($t_parent == "0"){ echo "checked"; } ?>>
			  <img src="../images/folder_closed.gif" width="16" height="16" border="0" align="absmiddle">กลุ่ม FAQ<br>
			 <?php  showgroup(0,0,$t_subid,$t_parent,"");  ?></DIV>
		</td>
 </tr>
 <?php } ?>
  <tr valign="top" bgcolor="#FFFFFF"> 
