...
<table width="80%" border="0" align="center" cellpadding="5" cellspacing="0">
  <tr> 
    <td><img src="../theme/main_theme/logo.gif" width="32" height="32" align="absmiddle"> <span class="ewtfunction"> รายงานจำนวนครั้งที่ถูกค้น </span> </td>
  </tr>
</table>
<table width="94%" border="0" align="center" cellpadding="5" cellspacing="0" class="ewtfunctionmenu">
  <tr>
    <td align="right"><a href="javascript:void(0);" onClick="load_divForm('../FavoritesMgt/favorites_add.php?name=<?php echo urlencode("รายงานจำนวนครั้งที่ถูกค้น");?>&module=faq&url=<?php echo urlencode("faq_stat2.php");?>', 'divForm', 300, 80, -1,433, 1);"><img src="../images/star_yellow_add.gif" width="16" height="16" border="0" align="middle">&nbsp;Add to favorites </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <hr> </td>
  </tr>
</table>
...
<table width="95%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#000000" class="ewttableuse">
  <tr  class="ewttablehead">
    ...
    <td width="20%" align="center">จำนวนครั้งที่ถูกค้น</td>
  </tr>
  <?php
  $sql="SELECT faq.fa_id, faq.fa_name,COUNT(faq_stat.faq_stat_id) AS countstat FROM faq LEFT JOIN faq_stat ON faq.fa_id = faq_stat.fa_id  and  type_status ='Y'  $con WHERE f_sub_id = '".$_REQUEST[fid]."'  GROUP BY faq.fa_id, faq.fa_name ORDER BY countstat DESC";
