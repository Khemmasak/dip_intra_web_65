...
$pdf->str_date=$date_name;
  ...
  $sql=$db->query("SELECT faq.fa_id, faq.fa_name,COUNT(faq_stat.faq_stat_id) AS countstat FROM faq LEFT JOIN faq_stat ON faq.fa_id = faq_stat.fa_id  and  type_status ='Y'  $con WHERE f_sub_id = '".$_REQUEST[fid]."'  GROUP BY faq.fa_id, faq.fa_name ORDER BY countstat DESC");
