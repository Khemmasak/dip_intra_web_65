...
<table width="94%" border="0" align="center" cellpadding="0" cellspacing="0" class="ewtfunctionmenu">
  <tr>
    <td align="right"><a href="addfaq.php?f_sub_id=<?php echo $f_sub_id;?>&f_id=<?php echo $f_id;?>"><img src="../theme/main_theme/g_add.gif" alt="เพิ่ม" width="16" height="16" border="0" align="absmiddle"> 
		<?php echo $text_general_add;?></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="faq_sub.php?f_id=<?php echo $f_id;?>"><img src="../theme/main_theme/g_back.gif" alt="กลับ" width="16" height="16" border="0" align="absmiddle"> 
...
<table width="94%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#CECECE" class="ewttableuse">
  <tr bgcolor="#E7E7E7"  class="ewttablehead"> 
   ...
   while($R = mysql_fetch_array($Execsql)){ 
	?>
  <tr bgcolor="#FFFFFF"> 
    <td align="center"><a href="addfaq.php?fa_id=<?php echo $R[fa_id]; ?>&f_sub_id=<?php echo $R[f_sub_id]; ?>&f_id=<?php echo $f_id;?>"><img src="../theme/main_theme/g_edit.gif" alt="แก้ไข" width="16" height="16" border="0"></a> </td>
