...
<table width="80%" border="0" align="center" cellpadding="5" cellspacing="0">
  <tr> 
    <td><img src="../theme/main_theme/logo.gif" width="32" height="32" align="absmiddle"> <span class="ewtfunction"> <?php echo $text_genfaq_stat;?> </span> </td>
  </tr>
</table>
<table width="94%" border="0" align="center" cellpadding="5" cellspacing="0" class="ewtfunctionmenu">
  <tr>
    <td align="right"><a href="javascript:void(0);" onClick="load_divForm('../FavoritesMgt/favorites_add.php?name=<?php echo urlencode($text_genfaq_stat);?>&module=faq&url=<?php echo urlencode("faq_stat.php");?>', 'divForm', 300, 80, -1,433, 1);"><img src="../images/star_yellow_add.gif" width="16" height="16" border="0" align="middle">&nbsp;Add to favorites </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <hr> </td>
  </tr>
</table>
...
<table width="95%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#ffffff" >
  <tr>
    <td align="right"><a  href="faq_print1.php?start_date=<?php echo $start_date;?>&end_date=<?php echo $end_date;?>&orderby=<?php echo $orderby;?>&adesc=<?php echo $_REQUEST["adesc"];?>&fid=<?php echo $RG[f_sub_id ];?>" target="_blank" class="ewtfunctionmenu"><img src="../images/windows.gif" width="16" height="16" border="0" align="absmiddle">&nbsp;Export to pdf</a>
	<a  href="faq_stat1_excel.php?start_date=<?php echo $start_date;?>&end_date=<?php echo $end_date;?>&orderby=<?php echo $orderby;?>&adesc=<?php echo $_REQUEST["adesc"];?>&fid=<?php echo $RG[f_sub_id ];?>&FlagE=excel&flag=<?php echo $_POST[flag];?>" target="_blank" class="ewtfunctionmenu"><img src="../images/windows.gif" width="16" height="16" border="0" align="absmiddle">&nbsp;Export to excel</a></td>
  </tr>
  <tr>
    <td align="center" class="ewtfunction">รายงานอันดับความนิยมหมวด  : <?php echo $RG[f_subcate ];?></td>
  </tr>
  <tr>
