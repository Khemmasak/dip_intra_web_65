...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#333333">
  ...
  <tr> 
    <td width="60" height="58"><img src="../theme/main_theme/faq_module.gif" width="58" height="58"> </td>
          <td><span class="ewthead"><?php echo $text_genfaq_module;?></span>
                  <hr width="100%" size="1"  align="left"  color="#D8D2BD">
                  <span class="ewtsubmenu"><img src="../theme/main_theme/faq_modulesub_main.gif" width="16" height="16" align="absmiddle"><a href="faq_cate.php" target="faq_body"> <?php echo $text_genfaq_modulesub_main;?> </a></span>&nbsp;&nbsp;&nbsp;&nbsp;
				  <span class="ewtsubmenu"><img src="../theme/main_theme/faq_modulesub_stat.gif" width="16" height="16" align="absmiddle"><a href="faq_stat.php" target="faq_body"> <?php echo $text_genfaq_modulesub_stat;?> </a></span>&nbsp;&nbsp;&nbsp;&nbsp;
				  <span class="ewtsubmenu"><img src="../theme/main_theme/faq_modulesub_fromuser.gif" width="16" height="16" align="absmiddle"><a href="faq_user.php" target="faq_body"> <?php echo $text_genfaq_modulesub_user;?></a> </span>&nbsp;&nbsp;</td>
  </tr>
</table>
	  </td>
  </tr>
  ...
  <tr> 
    <td valign="top" bgcolor="#FFFFFF"><table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
                      <tr> 
                        <td bgcolor="#FFFFFF"><iframe name="faq_body" src="faq_cate.php"  frameborder="0"  width="100%" height="100%" scrolling="yes"></iframe></td>
                      </tr>
