...
function orderby(field,adesc){
     location.href='faq_stat.php?orderby='+field+'&adesc='+adesc+'&offset=&Flag=<?php echo $_REQUEST["Flag"];?>&start_date=<?php echo $_REQUEST["start_date"];?>&end_date=<?php echo $_REQUEST["end_date"];?>';
}
</script>
</head>
...
<div align="center">
 ...
 <form name="form1" method="post" action=""> <tr>
      ...
      <td align="right"><a href="javascript:void(0);" onClick="load_divForm('../FavoritesMgt/favorites_add.php?name=<?php echo urlencode($text_genfaq_stat);?>&module=faq&url=<?php echo urlencode("faq_stat.php");?>', 'divForm', 300, 80, -1,433, 1);"><img src="../images/star_yellow_add.gif" width="16" height="16" border="0" align="middle">&nbsp;Add to favorites </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  href="print2.php?start_date=<?php echo $start_date;?>&end_date=<?php echo $end_date;?>&orderby=<?php echo $orderby;?>&adesc=<?php echo $_REQUEST["adesc"];?>" target="_blank"><img src="../images/windows.gif" width="16" height="16" border="0" align="absmiddle">&nbsp;Export to pdf</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
 </tr> </form>
  <tr height="4">
          ...
          <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF"  class="ewttableuse">
              <tr align="center" bgcolor="#999999" class="ewttablehead"> 
                <td width="70%"><?php echo $text_genfaq_ask;?></td>
					<td width="11%" ><a href="javascript:orderby('sum_fa_id','<?php echo $adesc;?>')"><?php echo $text_genfaq_usrecount;?></a></td>
              <!-- <td width="19%">&nbsp;</td>-->
              </tr>
              <?php
