...
<div class="title" >IP (Internet Protocal Address)</div>
...
<a href="#set-7" class="hi-icon hi-icon-list text-dark" title="View more" onclick="boxPopup('<?=linkboxPopup();?>pop_stat_ipaddress.php');">View more</a>
</div>-->
</div>
</div>
</div>