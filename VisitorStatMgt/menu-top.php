...
<span class="animated fadeInDown text-large hidden-xs"><?="VisitorStat Management";?></span>
</div>
...
<button type="button" class="btn btn-default btn-sm" >
          <i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?="VisitorStat Dashboard";?>
</button>
</a>
</div>
...
<div class="btn-group ">
        ...
        <ul class="dropdown-menu dropdown-menu-right">
            ...
            <li><a href="stat_index.php"><i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?="VisitorStat Dashboard";?></a></li>
		</ul>
</div>
</div>
