...
<div class="title" >ความละเอียดหน้าจอ (Resolution)</div>
...
<ul class="list-group">
<?php
$s_isp = $db->query("SELECT sv_resolution,count(sv_id) AS ct 
...
<a href="#View more" class="hi-icon hi-icon-list text-dark" title="View more" onclick="boxPopup('<?=linkboxPopup();?>pop_stat_resolution.php');">View more</a>
</div>-->
</div>
</div>
</div>