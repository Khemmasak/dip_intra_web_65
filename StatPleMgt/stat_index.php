...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#333333">
  ...
  <tr> 
    <td width="60" height="58"><img src="../theme/main_theme/g_member_64.gif"> </td>
                <td><span class="ewthead"> ระบบสถิติ</span>
                  <hr width="100%" size="1"  align="left"  color="#D8D2BD">
				  <span class="ewtsubmenu"><nobr><a href="main_stat_index.php" target="iframe_data"><img src="../theme/main_theme/bullet.gif"  border="0" width="16" height="16" align="absmiddle"> ข้อมูลสถิติ</a></nobr></span></td>
  </tr>
</table>
	  </td>
  </tr>
