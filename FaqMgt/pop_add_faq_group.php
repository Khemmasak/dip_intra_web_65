...
<h4 class="modal-title  color-white"><i class="fas fa-plus-circle"></i> <?=$txt_faq_cate_add;?></h4>
</div>
...
<input class="form-control" placeholder="<?=$txt_faq_cate_name;?>" name="category_title" type="text" id="category_title"  value="" required="required" />
</div>
</div>
<!-- <div class="form-group row " >
...
<div class="col-md-12 col-sm-12 col-xs-12" >
<textarea class="form-control" placeholder="<?=$txt_faq_cate_detail;?>"  rows="6" id="category_detail" name="category_detail"  required="required" ></textarea>
</div>
</div> -->
<div class="form-group row " >
...
<select name="category_parent" id="category_parent" class="form-control" disabled >
...
<input class="form-control checknumber" placeholder="<?=$txt_faq_cate_order;?>" name="category_order" type="text" id="category_order"  value="" required="required" />
</div>
</div>
</div>
</div>	
