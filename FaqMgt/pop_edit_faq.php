...
$_sql = $db->query("SELECT * FROM faq  WHERE  fa_id = '{$fa_id}' ");
$a_data = $db->db_fetch_array($_sql);
?>
<form id="form_main" name="form_main" method="POST" action="<?=getLocation('func_edit_faq')?>" enctype="multipart/form-data" >
...
<h4 class="modal-title  color-white"><i class="fas fa-plus-circle"></i> <?=$txt_faq_edit;?></h4>
</div>
...
<textarea class="form-control" placeholder="<?=$txt_faq_title;?>"  rows="6" id="faq_title" name="faq_title"  required="required" ><?=$a_data['fa_name'];?></textarea>
</div>
</div>
<!-- <div class="form-group row " >
<label for="faq_detail" class="col-sm-12 control-label"><b><?=$txt_faq_detail;?> <span class="text-danger"><code>*</code></span> :</b></label>
<div class="col-md-12 col-sm-12 col-xs-12" >
<textarea class="form-control" placeholder="<?=$txt_faq_detail;?>"  rows="6" id="faq_detail" name="faq_detail"  required="required" ><?php echo stripslashes($a_data['fa_detail']);?></textarea>
</div>
</div> -->
<div class="form-group row " >
<label for="faq_answer" class="col-sm-12 control-label"><b><?=$txt_faq_answer;?> <span class="text-danger"><code>*</code></span> :</b></label>
<div class="col-md-12 col-sm-12 col-xs-12" >
<textarea class="form-control" placeholder="<?=$txt_faq_answer;?>"  rows="6" id="faq_answer" name="faq_answer"  required="required" ><?php echo $a_data['fa_ans'];?></textarea>
</div>
</div>
<div class="form-group row " >
...
<div class="form-group row " >
<label for="category_order" class="col-sm-12 control-label"><b><?=$txt_faq_show;?> <span class="text-danger"><code>*</code></span> :</b></label>
<div class="col-md-12 col-sm-12 col-xs-12" >
<div class="radio">
  <label><input type="radio" name="faq_show"  value="Y" <?php if($a_data['faq_use'] == 'Y'){ echo 'checked="checked"';}?>><?=$txt_faq_status_show;?>
  <span class="cr"><i class="cr-icon fas fa-check color-ewt"></i></span>
  </label>
</div>
<div class="radio">
  <label><input type="radio" name="faq_show"  value="N" <?php if($a_data['faq_use'] == 'N'){ echo 'checked="checked"';}?> /><?=$txt_faq_status_notshow;?>
  <span class="cr"><i class="cr-icon fas fa-check color-ewt"></i></span>
  </label>
</div>
</div>
...
<div class="form-group row " >
<label for="category_order" class="col-sm-12 control-label"><b><?=$txt_faq_interesting ;?> <span class="text-danger"><code>*</code></span> :</b></label>
<div class="col-md-12 col-sm-12 col-xs-12" >
<div class="checkbox">
          <label>
			<input  name="faq_interesting" id="faq_interesting" type="checkbox" value="Y" <?php if($a_data['faq_top'] == 'Y'){ echo 'checked="checked"';}?> />
            <span class="cr"><i class="cr-icon fas fa-check color-ewt"></i></span>
			<?=$txt_faq_showinter;?>
          </label>
</div>
...
<button onclick="JQEdit_Faq($('#form_main'));" type="button" class="btn btn-success  btn-ml " >
