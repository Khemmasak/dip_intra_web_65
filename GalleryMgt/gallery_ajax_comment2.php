...
<table width="600" border="0" cellpadding="0" cellspacing="1">
  <tr>
    <th scope="col"><div align="right">
      <input type="button" name="Submit32" value="ลบความคิดเห็นทั้งหมด" style="width:115" onclick="if(confirm('ยืนยันการลบ')){location.href = 'gallery_process_comment.php?category_id=<?php echo $category_id?>&amp;img_id=<?php echo $img_id?>&amp;flag=del&amp;type=all';}" />
    </div></th>
  </tr>
</table>
  ...
  <tr>
	...
	?>
        <table width="580" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <th scope="col"><div align="right">
                <input type="button" name="Submit3" value="ลบความคิดเห็น" onclick=" if(confirm('ยืนยันการลบ')){location.href = 'gallery_process_comment.php?comment_id=<?php echo $rs_comment[comment_id]?>&amp;category_id=<?php echo $category_id?>&amp;img_id=<?php echo $img_id?>&amp;flag=del&amp;type=not_all';}" />
            </div></th>
          </tr>
        </table>
