    ...
    <td valign="top"><table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#006699">
      <tr>
		...
		<table  border="0" cellpadding="1" cellspacing="1" bgcolor="#999999" width="<?php echo $wi;?>" height="<?php echo $hi;?>">
          <tr>
            <td bgcolor="#FFFFFF" align="center" valign="top"><img src="phpThumb.php?src=<?php echo $Globals_Dir.$rs_img[img_path_b]?>&h=<?php echo $wi;?>&w=<?php echo $hi;?>" hspace="0" vspace="0" ></td>
          </tr>
        </table>
		<br>
...
<?php 		
			...
			if($herf){
					print '<img src="images/half_star_yellow.gif" height="16" width="8" align="absmiddle"><br><br>';
			}
		}
		?>
		</strong></td>
...
<table width="600" border="0">
  <tr>
    <th scope="col"><div align="right">
      <input type="button" name="Button" value=" back " onClick="location.href = 'gallery_view_category2.php?category_id=<?php echo $category_id?>&page=<?php echo $page_cat?>'; ">
    </div></th>
  </tr>
</table>
<script>
