...
if($_POST[flag]=='set_lang'){
	...
	?>
      <script language="JavaScript">
          ...
          location.href='../CalendarMgt/calendar_category.php';
     </script>
   <?php
   exit;
}
$modulename = 'cal_category';
?>
<html>
<head>
...
<form name="form1" method="post" action="calendar_category.php" onSubmit="return chk();">
  <?php
 $sql = $db->query("SELECT * FROM cal_category where cat_id  = '$id'  ");
$R = mysql_fetch_array($sql);
$LastTopic=$R[cat_name];
  ...
  <tr>
    <td width="21%" height="11" valign="top" bgcolor="#FFFFFF">ชื่อหมวด : <span class="style1">* </span></td>
    <td width="32%" height="0" bgcolor="#FFFFFF"><input name="lang_detail[0]" type="text" size="50" value="<?php echo select_lang_detail($_GET[id],$_GET[langid],'cat_name',$modulename);?>"><input type="hidden" name="lang_field[0]" value="cat_name"></td>
