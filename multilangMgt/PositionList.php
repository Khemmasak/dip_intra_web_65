...
if($_POST[flag]=='set_lang'){
	...
	?>
      <script language="JavaScript">
          ...
          location.href='../MemberMgt/PositionList.php';
     </script>
   <?php
   exit;
}
$modulename = 'position_name';
?>
<html>
<head>
...
<form name="form1" method="post" action="PositionList.php" onSubmit="return chk();">
  <?php
 $sql = $db->query("SELECT * FROM position_name where pos_id  = '$id' ");
$R = mysql_fetch_array($sql);
$LastTopic=$R[pos_name];
 
  ?>
  <table width="80%" border="0" align="center" cellpadding="5" cellspacing="0">
    <tr>
      <td><img src="../theme/main_theme/article_logo.gif" width="32" height="32" align="absmiddle" /><span class="ewtfunction">บริหารตำแหน่งภายในหน่วยงาน</span></td>
    </tr>
  </table>
  <table width="94%" border="0" align="center" cellpadding="0" cellspacing="0" class="ewtfunctionmenu">
    <tr>
      <td align="right"> <a href="../MemberMgt/PositionList.php"><img src="../theme/main_theme/g_back.gif" width="16" height="16" border="0" align="absmiddle" />กลับ</a> 
          <hr />
      </td>
    </tr>
  </table>
  ...
  <tr>
    <td width="21%" height="11" valign="top" bgcolor="#FFFFFF">ตำแหน่งงาน : <span class="style1">* </span></td>
    <td width="32%" height="0" bgcolor="#FFFFFF"><input name="lang_detail[0]" type="text" size="50" value="<?php echo select_lang_detail($_GET[id],$_GET[langid],'pos_name',$modulename);?>"><input type="hidden" name="lang_field[0]" value="pos_name"></td>
