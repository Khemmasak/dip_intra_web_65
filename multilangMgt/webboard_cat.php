...
if($_POST[flag]=='set_lang'){
	...
	?>
      <script language="JavaScript">
          ...
          location.href='../WebboardMgt/index_cate.php';
     </script>
   <?php
   exit;
}
...
$LastDetail=$R[c_detail];
  ...
  <table width="94%" border="0" align="center" cellpadding="0" cellspacing="0" class="ewtfunctionmenu">
    <tr>
      <td align="right"> <a href="../WebboardMgt/index_cate.php"><img src="../theme/main_theme/g_back.gif" width="16" height="16" border="0" align="absmiddle" />กลับ</a> 
          <hr />
      </td>
    </tr>
  </table>
