...
<div class="card ">
	...
	<div class="card-body">
		...
		<div class="float-right text-right" style="top:18px;margin-bottom:10px;"> 
			...
			<a href="webboard_add_subadmin.php" title="<?=$txt_webboard_menu_main ;?>"  target="_self">
				<button type="button" class="btn btn-default btn-sm" >
					<i class="fas fa-plus"></i>&nbsp;เพิ่มผู้ดูแลหมวดกระทู้
				</button>
			</a>
		...
		<div class = "col-md-2 col-sm-4 col-xs-6">
			<a href ="webboard_edit_subadmin.php?t_id=<?=$a_data['t_id']?>">
