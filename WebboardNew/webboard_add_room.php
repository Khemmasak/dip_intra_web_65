...
if($_POST["webboardroom_name"]){
	...
	$_POST["webboardroom_name"]   = safety_clean($_POST["webboardroom_name"]);
	$_POST["webboardroom_detail"] = safety_clean($_POST["webboardroom_detail"]);
	...
	$db->write_log("create","webboard room","สร้างห้อง   ".$_POST[webboardroom_name]);
