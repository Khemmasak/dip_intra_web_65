...
<img src="<?=$IMG_PATH ;?>images/Artboard 22.png" class="animated fadeInDown " style="height: 60px;width: 60px;">  
<span class="animated fadeInDown text-large hidden-xs"><?="Video Management";?></span>
</div>
...
<a href="vdo_group.php">
<button type="button" class="btn btn-default btn-sm" >
          <i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?="หมวดวีดีโอ";?>
</button>
</a>
</div>
...
<div class="btn-group ">
        ...
        <ul class="dropdown-menu dropdown-menu-right">
            ...
            <li><a href="faq_group.php"><i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?="หมวดวีดีโอ";?></a></li>
		</ul>
</div>
</div>
