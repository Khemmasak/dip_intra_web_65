...
<img src="<?=$IMG_PATH ;?>images/Menu.png" class="animated fadeInDown " style="height: 60px;width: 60px;">  
<span class="animated fadeInDown text-large hidden-xs"><?=$txt_menu_module;?></span>
</div>
...
<button type="button" class="btn btn-default btn-sm" >
          <i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?=$txt_menu_menu_main;?>
</button>
</a>
...
<div class="btn-group ">
        ...
        <ul class="dropdown-menu dropdown-menu-right ">
            <li class=""><a href="../EWT_ADMIN/main.php" ><i class="fas fa-home"></i>&nbsp;<?=$txt_ewt_home;?></a></li>
            <li class=""><a href="menu_list.php"><i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?=$txt_menu_menu_main;?></a></li>
		</ul>
</div>
</div>
