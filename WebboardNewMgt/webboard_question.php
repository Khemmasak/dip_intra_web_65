...
<ol class="breadcrumb">
<li><a href="webboard_main.php"><?php echo $txt_webboard_menu_main;?></a></li>
...
<div class="card ">
	<div class="card-header ewt-bg-color m-b-sm" >
		<div class="card-title text-left color-white">
			<p><h4><?php echo $question_info["t_name"];?></h4></p>
		</div>
	</div>
	<div class="card-body">
	...
	<div class="panel-group" id="accordion">
		...
		<div class="panel panel-default ">
			...
			<div id="collapseOne<?php echo $i;?>" class="">
				<div class="panel-body">
					<div><?php echo question_html($question_info["t_detail"]);?><br> 
					...
					<?php if($question_info['q_name']){?>
						<b> User: </b> <?php echo $question_info['q_name'];?> <br>
					<?php } else { ?>
						<b> User: </b> - <br>
					<?php } ?>
					<b> Create Date/Time: </b><?php echo $question_info['t_date'];?> <?php echo $question_info['t_time'];?> <br>
					<b> IP Address: </b><?php echo $question_info['t_ip'];?> <br></div>
				</div>
				...
				<div class="panel-footer ewt-bg-white text-right">
					...
					<div class="ewt-icon-wrap ewt-icon-effect-1 ewt-icon-effect-1b">
						...
						<button value="<?php echo $question_info['t_id'];?>" type="button" class="edit_question btn btn-default  btn-circle  btn-sm " data-toggle="tooltip" data-placement="top" title="<?php echo $txt_webboard_edit_question;?>" >
							<i class="far fa-edit"></i>
						</button>

						<button value="<?php echo $question_info['t_id'];?>" type="button" class="delete_question btn btn-default  btn-circle  btn-sm " data-toggle="tooltip" data-placement="top" title="<?php echo $txt_webboard_delete_question;?>" >
			...
			<table border="0" width="80%">
				<tr>
					...
					<td style="padding: 10px; background-color: #FFFFFF; border-top-right-radius:18px;">
						<textarea id="comment_desc" name="comment_desc" style="width: 100%; height:100px; resize: none;" required><?php echo  $_POST["data_comment_desc"]; ?></textarea>
		...
		?>	
			...
			<div class="panel panel-default ">
				<div width="100%" style="background-color: #FFC153;padding: 10px;">
					<b>Comment # <?php echo $i;?>
				</div>
			
				<div class=""> 
					<div class="panel-body">
						<div><b><?php echo $txt_complain_detail;?> :</b> 
						<?php echo $a_data["a_detail"];?>
						</div><br> 
						
						<div>
							<b> Create Date/Time: </b><?php echo $a_data['a_date'];?> <?php echo $a_data['a_time'];?> <br>
							<?php 
								if($a_data["a_attact"]){ 
							?>
							...
							?>
							<b>IP Address :</b> <?php echo $a_data['a_ip'];?><br>
							<b>Status :</b>
					...
					<div class="panel-footer ewt-bg-white text-right" style="background-color: #FFC153;padding: 10px;">
						...
						<div class="ewt-icon-wrap ewt-icon-effect-1 ewt-icon-effect-1b">
							...
							<?php } else { ?>
								<button value="<?php echo $a_data['a_id'];?>" type="button" class="disapprove_comment btn btn-default  btn-circle  btn-sm " data-toggle="tooltip" data-placement="top" title="<?php echo $txt_webboard_disapprove_comment; ?>" >
									<i class="far fa-times-circle"></i>
								</button>
							<?php } ?>

							<button value="<?php echo $a_data['a_id'];?>" type="button" class="delete_comment btn btn-default  btn-circle  btn-sm " data-toggle="tooltip" data-placement="top" title="<?php echo $txt_webboard_delete_comment; ?>" >
								<i class="far fa-trash-alt" aria-hidden="true"></i>
							</button>
...
<?php echo pagination_ewt($statement,$perpage,$page,$url='webboard_question.php?t_id=3&');?>	
</div>
</div>
