...
if($_POST["proc"]=="del_vulgar"){
	...
	?>
		<script>
			location.href = "webboard_vul_index.php";
		</script>
...
<div class="card ">
	...
	<div class="card-body">
		...
		<div class="float-right text-right" style="top:18px;margin-bottom:10px;"> 
			...
			<a href="webboard_add_vul.php" title="เพิ่มคำที่ไม่สุภาพ/โฆษณา"  target="_self">
				<button type="button" class="btn btn-default btn-sm" >
					<i class="fas fa-plus"></i>&nbsp;เพิ่มคำที่ไม่สุภาพ/โฆษณา
				</button>
			</a>
		...
		<div class="panel-body text-left">
			<div class = "col-md-2 col-sm-4 col-xs-6">
				<a href ="webboard_edit_vul.php?v_id=<?=$a_data['vulgar_id']?>">
				<button type="button" class="btn btn-default  btn-circle  btn-sm " data-toggle="tooltip" data-placement="top" title="แก้ไข" >
				<i class="fas fa-edit" aria-hidden="true"></i>
				</button>
				</a>
				<button type="button" class="btn btn-default  btn-circle  btn-sm del_vulgar" data-toggle="tooltip" data-placement="top" title="ลบ" value="<?php echo $a_data['vulgar_id']?>">
