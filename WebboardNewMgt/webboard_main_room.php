												...
												<h4 class="panel-title">
													...
													<!-- <div class="ewt-icon-wrap ewt-icon-effect-1 ewt-icon-effect-1b"> -->
														<!-- <div class="text-right"> -->
															...
															if ($a_data['t_web_name'] == 0) {
																$web_name = "btn-default";
															} else {
																$web_name = "btn-info";
															}
															?>
															...
															<input name="web_name<?php echo $a_data['t_id']; ?>" type="hidden" id="web_name<?php echo $a_data['t_id']; ?>" value="<?php echo $a_data['t_web_name']; ?>">
															<a href="#" onClick="FuncCheckWebName('<?php echo $a_data['t_id']; ?>');">
																<button type="button" class="btn <?php echo $web_name; ?>  btn-circle btn-xs red" id="marker-<?php echo $a_data['t_id']; ?>" data-toggle="tooltip" data-placement="top" title="<?php echo $a_data['t_web_name'] == 0 ? 'แสดงชื่อนามสมมุติ' : 'ไม่แสดงชื่อนามสมมุติ'; ?>">
																	<i class="fas fa-user" aria-hidden="true"></i>
																</button>
															</a>
															<input name="top<?php echo $a_data['t_id']; ?>" type="hidden" id="top<?php echo $a_data['t_id']; ?>" value="<?php echo $a_data['t_top']; ?>">
															<a href="#" onClick="FuncCheckMarker('<?php echo $a_data['t_id']; ?>');">
																<button type="button" class="btn <?php echo $top; ?>  btn-circle btn-xs red" id="marker-<?php echo $a_data['t_id']; ?>" data-toggle="tooltip" data-placement="top" title="<?php echo $a_data['t_top'] == 0 ? 'ปักหมุด' : 'ยกเลิกปักหมุด'; ?>">
																	<i class="fas fa-map-marker-alt" aria-hidden="true"></i>
																</button>
															</a>
															<?php if ($a_data['s_id'] == 0) { ?>
																<button value="<?php echo $a_data['t_id']; ?>" type="button" class="approve_question btn btn-warning  btn-circle  btn-sm " data-toggle="tooltip" data-placement="top" title="<?php echo $txt_webboard_approve_question; ?>">
															...
															<?php } ?>
															<a href="webboard_main_question.php?t_id=<?php echo $a_data['t_id']; ?>">
																<button type="button" class="btn btn-info btn-circle btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo $txt_webboard_read_question; ?>">
																	<i class="fa fa-th-list " aria-hidden="true"></i>
																</button>
															</a>
															<button type="button" class="delete_question btn btn-danger  btn-circle  btn-sm " data-toggle="tooltip" data-placement="top" title="<?php echo $txt_webboard_delete_question; ?>" value="<?php echo $a_data['t_id']; ?>">
