...
break;
	...
	$s_data['t_name']   =  	$a_data['q_name'];
	$s_data['t_detail'] =  	$a_data['q_detail'];
	$s_data['t_date']   =	datetimetool::getnow();
	$s_data['t_time']	=  	datetimetool::getnow();
	$s_data['t_ip']		=  	getIP();
	$s_data['q_name']	=  	$_SESSION["EWT_SMUSER"];
	$s_data['q_email']	=  	'';
	$s_data['user_id']	=  	$_SESSION['EWT_SMID'];
	$s_data['t_sts']	=   $a_data['q_status'];   
	...
	$result = insert('w_question',$s_data);
	sys::save_log('create','webboard','เพิ่มหัวข้อกระทู้  '.$a_data['q_name']); 	
