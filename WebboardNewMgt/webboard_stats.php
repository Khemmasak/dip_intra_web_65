		...
		<div class="panel-group" id="accordion" align="center">
			...
			<table border="1" width="90%">
				<tr>
					...
					<th width="20%"><center>จำนวนหมวดกระทู้ย่อย</center></th>
					<th width="20%"><center>จำนวนกระทู้ภายใต้หมวดทั้งหมด</center></th>
				</tr>

				<?php 
					$list_room = list_webboard_room(0); 
					for($n=0;$n<sizeof($list_room);$n++){
				...
				?>
					<tr>
						<td><?php echo room_name($list_room[$n]); ?></td>
						<td align="center"><?php echo subgroup_number($list_room[$n]); ?></td>
						<td align="center"><?php echo  total_question_number($list_room[$n]); ?></td>
					</tr>
				<?php
					}
				?>
