...
if($_POST["question_topic"]){
	...
	if(trim($_SESSION[EWT_SMID]=="")){
		...
		$uid = $_SESSION[EWT_SMID];
	}
	
	$sql_group = " INSERT INTO w_question (c_id,t_name,t_detail,t_date,t_time,t_ip,q_name,q_email,user_id) 
		           VALUES ('$_POST[question_room]','$_POST[question_topic]','$_POST[question_desc]','$date','$time','$IPn','$_POST[question_by]','$_POST[question_email]','$uid')";
	...
	$id         = mysqli_fetch_array($tid_result); 
	$current_id = $id[t_id];
	...
	if($_FILES[question_file][name]){
		...
		//echo $file."<br>";
		//echo $Globals_Dir.'webboard_attach/'.$picname."<br>";
	...
	$db->write_log("create","webboard question","สร้างหัวข้อกระทู้   ".$_POST[question_topic]);
...
<h4><?=$txt_webboard_new_question;?></h4>
<p></p> 
...
<ol class="breadcrumb">
	...
	<li class=""><?=$txt_webboard_new_question;?></li> 
</ol>
</div>
        ...
        <ul class="dropdown-menu dropdown-menu-right">
            <li>
				<a onClick="boxPopup('<?=linkboxPopup();?>pop_add_calendar_group.php?cal_cid=<?=$cal_cid;?>');" >
					<i class="fas fa-plus-circle"></i>&nbsp;<?=$txt_webboard_new_question;?>
				</a>
			</li>
...
<div class="card ">
	<div class="card-header ewt-bg-color m-b-sm" >
		<div class="card-title text-left color-white">
			<p><h4><?=$txt_webboard_new_question;?></h4></p>
		</div>
	</div>
	<div class="card-body">
		...
		<table border="0" width="80%">
			<tr>
				...
				<td width="80%" style="padding: 10px">
					<input type="text" name="question_topic" style="width: 100%" required value="<?php echo $_POST["data_question_topic"]; ?>">
			...
			<tr>
				...
				<td style="padding: 10px">
					<textarea name="question_desc" id="question_desc" style="width: 100%; height:100px; resize: none;" required><?php echo $_POST["data_question_desc"]; ?></textarea>
				</td>
			</tr> 
			<tr>
				<td>
			...
			<tr>
				...
				<td width="80%" style="padding: 10px">
					<input type="text" name="question_by" style="width: 100%" value="<?php echo $_POST["data_question_by"]; ?>" required>
				</td>
			</tr>
			<tr>
				<td width="20%" style="padding: 10px">
				...
				<td width="80%" style="padding: 10px">
					<input type="text" name="question_email" style="width: 100%" value="<?php echo $_POST["data_question_email"]; ?>">
				</td>
			</tr>
			<!-- <tr>
				<td style="padding: 10px">
