...
$db->write_log("view","rss","เข้าสู่ Module การจัดการ RSS Reader ");
if($_GET[url] != ''){
$link = $_GET[url];
}else{
$link = 'rss.php';
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#333333">
  ...
  <tr> 
    <td width="60" height="58"><img src="../theme/main_theme/g_rss_64.gif"> </td>
                <td><span class="ewthead"><?php echo $text_genrss_module;?></span>
                  <hr width="100%" size="1"  align="left"  color="#D8D2BD">
                   <span class="ewtsubmenu"><a href="rss.php" target="iframe_data"><img src="../theme/main_theme/bullet.gif" width="16" height="16" align="absmiddle" border="0"> <?php echo $text_genrss_modulesub_main1;?></a></span>
		 		</td>
  </tr>
</table>
	  </td>
