...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#333333">
  ...
  <tr> 
    <td width="60" height="58"><img src="../theme/main_theme/g_statsearch_64.gif"> </td>
                <td><span class="ewthead">สถิติการค้นหาข้อมูลเว็บไซต์</span>
                  <hr width="100%" size="1"  align="left"  color="#D8D2BD">
                  <span class="ewtsubmenu">
				   <span class="ewtsubmenu"><a href="search_stat.php" target="iframe_data"><img src="../theme/main_theme/bullet.gif" width="16" height="16" border="0" align="absmiddle"> 
            คำค้นที่มีการค้นหามากที่สุด</a></span>&nbsp;&nbsp;&nbsp;&nbsp;<!--<span class="ewtsubmenu"><a href="article_stat.php" target="article_data"><img src="../theme/main_theme/bullet.gif" width="16" height="16" border="0" align="absmiddle"> 
            รายงานสถิติ</a></span> --></td>
  </tr>
</table>
	  </td>
  </tr>
  ...
  <tr> 
    <td valign="top" bgcolor="#FFFFFF"><table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
                      <tr> 
                        <td bgcolor="#FFFFFF"><iframe name="iframe_data" src="search_stat.php" frameborder="0"  width="100%" height="100%" scrolling="yes"></iframe></td>
                      </tr>
