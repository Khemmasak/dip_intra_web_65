...
<ol class="breadcrumb">
<li><a href="faq_group.php"><?=$text_genfaq_modulesub_main;?></a></li>
<?=faq_parent($faq_cid);?>       
</ol>
</div>

<div class="col-md-12 col-sm-12 col-xs-12 float-right text-right hidden-xs"  >	  
<a onClick="boxPopup('<?=linkboxPopup();?>pop_add_faq_group.php?faq_cid=<?=$faq_cid;?>');" data-toggle="tooltip" data-placement="bottom" title="<?="เพิ่มหมวด FAQ";?>"  target="_self">
<button type="button" class="btn btn-info  btn-ml">
<i class="fas fa-plus-circle"></i>&nbsp;<?="เพิ่มหมวด FAQ";?>
</button>
</a>
<a onClick="boxPopup('<?=linkboxPopup();?>pop_add_faq.php?faq_cid=<?=$faq_cid;?>');" data-toggle="tooltip" data-placement="bottom" title="<?="เพิ่ม FAQ";?>"  target="_self">
<button type="button" class="btn btn-info  btn-ml">
<i class="fas fa-plus-circle"></i>&nbsp;<?="เพิ่ม FAQ";?>
</button>
</a>
<a  target="_self" onclick="boxPopup('<?=linkboxPopup();?>pop_search_faq.php');" data-toggle="tooltip" data-placement="buttom" title="<?="Search FAQ";?>">
<button type="button" class="btn btn-info  btn-ml " >
<i class="fas fa-search"></i>&nbsp;<?="Search FAQ";?>
</button>
</a>
...
<div class="btn-group ">
        ...
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a onClick="boxPopup('<?=linkboxPopup();?>pop_add_faq_group.php?faq=<?=$gid;?>');" ><i class="fas fa-plus-circle"></i>&nbsp;<?="เพิ่มหมวด FAQ";?></a></li>
...
$_sql = $db->query("SELECT * FROM faq WHERE faq_use = 'Y' AND f_sub_id = '{$faq_cid}' {$wh} ORDER BY fa_id DESC LIMIT {$start} , {$perpage} ");

$statement = "SELECT count(fa_id) AS b
			  FROM faq 
			  WHERE faq_use = 'Y' AND f_sub_id = '{$faq_cid}' {$wh} ";
