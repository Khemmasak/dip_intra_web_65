...
<?php
if($_GET["register_type"]==1){
$topic = '"จองเข้าเยี่ยมชมกิจการและดูงานของ สทอภ. สำนักงานใหญ่ ศูนย์ราชการฯ ถนนแจ้งวัฒนะ กรุงเทพมหานคร"';
}
else if($_GET["register_type"]==2){
$topic = '"จองเข้าเยี่ยมชมกิจการและดูงานของ สทอภ. อำเภอศรีราชา จังหวัดชลบุรี"';
}
?>
<h4>
แก้ไขหัวข้อการเยี่ยมชมของ <?php echo $topic; ?>
</h4>
<p></p> 
