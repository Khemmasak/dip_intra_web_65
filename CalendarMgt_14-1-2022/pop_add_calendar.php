...
<form id="form_main" name="form_main" method="POST" action="<?=getLocation('func_add_calendar')?>" enctype="multipart/form-data" >
...
<h4 class="modal-title"> <?=$txt_calendar_add;?></h4>
</div>
...
<textarea class="form-control" placeholder="<?=$txt_calendar_title;?>"  rows="6" id="calendar_title" name="calendar_title"  required="required" ></textarea>
</div>
</div>
<div class="form-group row " >
...
<div class="col-md-12 col-sm-12 col-xs-12" >
<textarea class="form-control" placeholder="<?=$txt_calendar_detail;?>"  rows="6" id="calendar_detail" name="calendar_detail"  required="required" ></textarea>
</div>
</div>
...
while($a_data_cat = $db->db_fetch_row($_sql_cate)){
	$sel = ($a_data_cat[0] == trim($faq_cid)) ? "selected":"";
?>
...
<label for="event_date_start"><b><?=$txt_calendar_statdate;?><span class="text-danger"><code>*</code></span> : </b></label>
            <div class='input-group date datepicker' id='datetimepicker1'>
                <input readonly type='text' class="form-control " placeholder="<?=$txt_calendar_statdate;?>" name="event_date_start"  id="event_date_start" value="" required="required" />
...
<label for="event_date_end"><b><?=$txt_calendar_enddate;?><span class="text-danger"><code>*</code></span> : </b></label>
            <div class='input-group date datepicker' id='datetimepicker2'>
                <input readonly type='text' class="form-control " placeholder="<?=$txt_calendar_enddate;?>"  name="event_date_end"  id="event_date_end" value="" required="required" />
                <span class="input-group-addon ewt-bg-color color-white border-ewt">
                    <i class="far fa-calendar-alt"></i>
                </span>
            </div>
...
<input class="form-control" placeholder="<?=$txt_calendar_attack;?>"  name="event_link" id="event_link" type="text" value="" >		
</div>
...
<input class="form-control" placeholder="<?=$txt_calendar_contact;?>" name="calendar_contact" type="text" id="calendar_contact"  value=""  />
</a> 
</div>
<div class="col-md-2 col-sm-2 col-xs-2 "  >
...
<div class="col-md-12 col-sm-12 col-xs-12" >
<textarea class="form-control" placeholder="<?=$txt_calendar_location;?>"  rows="6" id="calendar_location" name="calendar_location"  required="required" ></textarea>
</div>
</div>
...
<div class="col-md-12 col-sm-12 col-xs-12" >
<div class="radio">
  <label><input type="radio" name="calendar_setregis" id="calendar_setregis" value="Y" onclick="JQCheck_SetRegis($('#calendar_setregis'));" /><?=$txt_calendar_registor;?>
  <span class="cr"><i class="cr-icon fas fa-check color-ewt"></i></span>
  </label>
</div>
<div class="radio">
  <label><input type="radio" name="calendar_setregis" id="calendar_setregis1"  value="M" onclick="JQCheck_SetRegis($('#calendar_setregis1'));" /><?='ลงทะเบียนจากเว็บอื่น';?>
  <span class="cr"><i class="cr-icon fas fa-check color-ewt"></i></span>
  </label>
</div>
</div>
...
<div class="col-md-12 col-sm-12 col-xs-12" >
<input class="form-control "  placeholder="<?="ลิงค์ลงทะเบียนจากเว็บอื่น";?>" name="calendar_link_to" type="text" id="calendar_link_to"  value=""  />
</div>
</div>
...
<div class="col-md-12 col-sm-12 col-xs-12" >
<input class="form-control number"  placeholder="<?=$txt_calendar_num;?>" name="calendar_num" type="text" id="calendar_num"  value=""  />
</div>
</div>
...
<label for="start_date"><b><?=$txt_calendar_statdate_show;?> : </b></label>
            <div class='input-group date' id='txt_calendar_statdate_show'>
                <input readonly type='text' class="form-control datepicker" placeholder="<?=$txt_calendar_statdate_show;?>" name="start_date"  id="start_date" value="" >
                <span class="input-group-addon ewt-bg-color color-white border-ewt">
                    <i class="far fa-calendar-alt"></i>
                </span>
            </div>
...
<label for="end_date"><b><?=$txt_calendar_enddate_show;?> : </b></label>
            <div class='input-group date' id='txt_calendar_enddate_show'>
                <input readonly type='text' class="form-control datepicker" placeholder="<?=$txt_calendar_enddate_show;?>"  name="end_date"  id="end_date" value="" >
                <span class="input-group-addon ewt-bg-color color-white border-ewt">
                    <i class="far fa-calendar-alt"></i>
                </span>
            </div>
