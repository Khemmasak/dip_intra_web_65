...
<div class="panel panel-default ">
            <div class="panel-heading ewt-bg-success">
                <h4 class="panel-title">
					...
					<?php
					if($a_data["reg_approve"]=="Y"){
					?><font color="green"><i class="fas fa-check-square"></i></font><?php
					}
					else{
					?><font color="red"><i class="fas fa-times"></i></font><i class="fas fa-times-square"></i><?php
					}
					?>
					<?php echo $a_data["reg_from"]; ?>
					</a>					
                </h4>
            </div>
            ...
            <div id="collapseOne<?php echo $i;?>" class="panel-collapse collapse">
                <div class="panel-body">
					<div>
						<?php echo $reg_type[$a_data["reg_type"]]; ?>
					</div><br>
					<div>
						<i class="fas fa-school"></i>&nbsp;&nbsp;<b>ชื่อหน่วยงาน/สถาบันการศึกษา :</b> <?php echo $a_data["reg_from"]; ?>
					</div><br>
					<div>
						<i class="fas fa-pen-square"></i>&nbsp;&nbsp;<b>วัตถุประสงค์ :</b> <?php echo $a_data["reg_purpose"]; ?>
					</div><br>
					<div>
						<i class="far fa-handshake"></i>&nbsp;&nbsp;<b>แนวทางความร่วมมือในอนาคต :</b> <?php echo $a_data["reg_union"]; ?>
					</div><br>
					<div>
						<i class="far fa-clock"></i>&nbsp;&nbsp;<b>วันเวลา :</b> <?php echo $a_data["reg_date"]; ?> [<?php echo $time_array[$a_data["reg_time"]]; ?>]
					</div><br>
					<div>
						<i class="fas fa-clipboard"></i>&nbsp;&nbsp;<b>หัวข้อ :</b> 
							<ul>
							<?php foreach($topic_array[$a_data["reg_id"]] AS $topic_id){ ?>
								<li style="margin-left:20px;"> <b>*</b> <?php echo $topicname_array[$topic_id]; ?></li>
							<?php } ?>
							</ul>
					</div><br>
					<div>
						<i class="fas fa-book-reader"></i>&nbsp;&nbsp;<b>ผู้ประสานงาน :</b> <?php echo $a_data["reg_coordinator"]; ?>
					</div><br>
					<div>
						<i class="fas fa-phone-square"></i>&nbsp;&nbsp;<b>เบอร์ติดต่อ :</b> <?php echo $a_data["reg_tel"]; ?>
					</div><br>
					<div>
						<i class="fas fa-video"></i>&nbsp;&nbsp;<b>อนุญาตให้ สทอภ. บันทึกภาพนิ่ง/ภาพเคลื่อนไหว :</b> <?php echo $reg_permission[$a_data["reg_permission"]]; ?>
					</div><br>
					<div>
						<i class="fas fa-paperclip"></i>&nbsp;&nbsp;<b>หนังสือขออนุญาตเข้าเยี่ยมชม :</b> [ <a href="../ewt/<?php echo $_SESSION["EWT_SUSER"]; ?>/calendar_register/<?php echo $a_data['reg_file'];?>" download> Download</a> ]
					</div><br>
				...
				<a onClick="calendar_visit_delete(<?php echo $a_data['reg_id']?>);" > 
					<button type="button" class="btn btn-default  btn-circle  btn-sm " data-toggle="tooltip" data-placement="top" title="ลบ"   >
					<i class="far fa-trash-alt" aria-hidden="true"></i>
					</button>
				</a>
				<a onClick="boxPopup('<?php echo linkboxPopup();?>pop_edit_calendar_visit.php?reg_id=<?php echo $a_data['reg_id']?>');" >					
