...
if($db->db_num_rows($sql_menu) > 0){
	...
	array_push($menu_id,$R["d_id"]);
	array_push($menu_name,$R["d_name"]);
	array_push($menu_img,$R["d_bottom_content"]);
	}
}
?>
<html >
...
<script language="JavaScript">
		...
		self.location.href = "site_wizard_02.php?d_id=" + c;
		}
</script>
</head>
...
<table width="600" border="0">
    ...
    <td width="80%" height="206" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
      <tr>
        <td><table width="100%" border="0" cellpadding="2" cellspacing="1">
          <tr>
            <td height=25 background="images/block_bg_orange.jpg" bgcolor="#000066"><span class="style1">Step 1: Choose your design</span></td>
          </tr>
          <tr>
            <td height="30" valign="top" bgcolor="#FFFFFF">
			<div style="overflow:-moz-scrollbars-vertical; overflow-x:auto;overflow-y:auto; width:100%; height:370; " >
  ...
  <?php
	$i=0;
  		$numfile = count($menu_id);
				for($y=0;$y<$numfile;$y++){
			if($i%2== 0){
				echo "<tr bgcolor=\"#FFFFFF\"  align=center height=\"55\">";
			}
			$preview_path = "../ewt/template/images/thumbnails/template_".$menu_id[$y];
			
			
  ?>
  <td width="25%" valign="top" align="center" ><table width="164" height="164" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#999999">
    <tr>
      <td align="center" valign="middle" bgcolor="#FFFFFF" onClick="applydesign('<?php echo $menu_id[$y]; ?>')">
	  <img src="img.php?p=<?php echo base64_encode($preview_path); ?>" border="0" align="absmiddle"  style="cursor:hand" width="150"></td>
    </tr>
  </table>
  <table width="100%" border="0" cellspacing="2" cellpadding="3">
<tr>
				  <td align="center" valign="middle" bgcolor="#FFFFFF" ><?php echo $menu_name[$y]; ?></td>
				</tr>
				<tr>
				  <td align="right" valign="middle" bgcolor="#FFFFFF" ><a href="#"  onClick="applydesign('<?php echo $menu_id[$y]; ?>')"><img src="../images/magic-wand2.gif" border="0" align="absmiddle"><span class="style12">เลือก design นี้</span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				</tr>
				<tr>
    ...
    <td width="20%" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
      <tr>
        <td><table width="100%" border="0" cellpadding="2" cellspacing="1">
          ...
          <tr>
            <td height="30" valign="top" bgcolor="#FFFFFF"><span class="style11">เลือกรูปแบบของเว็บไซต์ที่คุณต้องการ</span><span class="style3"><br />
                  <br />
            </span></td>
          </tr>
        </table></td>
