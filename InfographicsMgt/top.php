...
<img src="<?=$IMG_PATH ;?>images/gallery_image.png" class="animated fadeInDown"> 

</div>
<div class="col-md-10 col-sm-10 col-xs-12" style="text-align:left;">   
<h3><span class="home-cms pull-left animated fadeInDown">Infographics Management</span></h3>  
 </div>
</div>
...
<a href="index.php">
<button type="button" class="btn btn-default btn-sm" >
          <span class="glyphicon glyphicon-circle-arrow-right"></span>  หน้าหลัก Infographics
</button>
</a>
</div>
</div>
