...
$statement = "SELECT count(banner_id) AS b
			  FROM banner 
			  WHERE banner_gid = '{$ban_cid}' {$wh} ";
...
<ol class="breadcrumb">
<li><a href="banner_group.php"><?=$txt_banner_cate;?></a></li>
<li class=""><?=banner_category($ban_cid);?></li>       
</ol>
</div>

<div class="col-md-12 col-sm-12 col-xs-12 float-right text-right hidden-xs"  >	  

<button type="button" class="btn btn-info  btn-ml" onClick="boxPopup('<?=linkboxPopup();?>pop_add_banner_group.php?ban_cid=<?=$ban_cid;?>');" >
<i class="fas fa-plus-circle"></i>&nbsp;<?=$txt_banner_add_cate;?>
</button>

<button type="button" class="btn btn-info  btn-ml"  onClick="boxPopup('<?=linkboxPopup();?>pop_add_banner.php?ban_cid=<?=$ban_cid;?>');" >
<i class="fas fa-plus-circle"></i>&nbsp;<?=$txt_banner_add;?>
</button>

<button type="button" class="btn btn-info  btn-ml " onclick="boxPopup('<?=linkboxPopup();?>pop_search_banner.php');" >
<i class="fas fa-search"></i>&nbsp;<?=$txt_banner_search;?>
</button>
...
<div class="btn-group ">
        ...
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a onClick="boxPopup('<?=linkboxPopup();?>pop_add_banner_group.php?ban_cid=<?=$ban_cid;?>');" ><i class="fas fa-plus-circle"></i>&nbsp;<?=$txt_banner_add_cate;?></a></li>
			<li><a onClick="boxPopup('<?=linkboxPopup();?>pop_add_banner.php?ban_cid=<?=$ban_cid;?>');" ><i class="fas fa-plus-circle"></i>&nbsp;<?=$txt_banner_add;?></a></li>
          	<li><a onClick="boxPopup('<?=linkboxPopup();?>pop_search_banner.php');" ><i class="fas fa-search"></i>&nbsp;<?=$txt_banner_search;?></a></li>
...
<tr class="nodrop nodrag success">
							...
							<th  width="10%" class="text-center"><?='Popup Intro';?></th>  
...
<nobr>
<a onClick="boxPopup('<?=linkboxPopup();?>pop_edit_banner.php?proc=edit&bid=<?=$a_banner['banner_id']?>&gid=<?=$gid;?>');" data-toggle="tooltip" data-placement="right" title="<?=$text_genbanner_altedit;?>" > 
<button type="button" class="btn btn-warning  btn-circle  btn-xs " >
<i class="fa fa-edit" aria-hidden="true"></i>
</button>
</a>
<a onClick="boxPopup('<?=linkboxPopup();?>pop_edit_banner.php?proc=edit&bid=<?=$a_banner['banner_id']?>&gid=<?=$gid;?>');" data-toggle="tooltip" data-placement="right" title="<?=$text_genbanner_altdel;?>" > 
<button type="button" class="btn btn-danger  btn-circle  btn-xs " >
<i class="far fa-trash-alt" aria-hidden="true"></i>
</button>
</a>
<a onClick="boxPopup('<?=linkboxPopup();?>pop_view_banner.php?bid=<?=$a_banner['banner_id']?>');" data-toggle="tooltip" data-placement="right" title="<?="ดูรูปภาพ";?>">
...
<div class="card m-b-sm DivCategoryLevel1" id="<?=$a_data['banner_id'];?>"  style="width:100%;height:240px;max-height:240px;">
<div class="card-body">
<img src="<?=$Globals_Dir?><?=$a_data['banner_pic']; ?>"  style="width:100%;height:auto;max-height:160px;" class=" m-b-sm">
<input class="input-inline-sm text-center" name="banner_order[]" 
	id="banner_order<?=$a_data['banner_position'];?>"  type="text" value="<?php echo $a_data['banner_position']; ?>" readonly />

<nobr>
<a onClick="boxPopup('<?=linkboxPopup();?>pop_edit_banner.php?ban_id=<?=$a_data['banner_id']?>&ban_cid=<?=$ban_cid;?>');" data-toggle="tooltip" data-placement="right" title="<?=$text_genbanner_altedit;?>" > 
<button type="button" class="btn btn-warning  btn-circle  btn-xs " >
<i class="fa fa-edit" aria-hidden="true"></i>
</button>
</a>
<a onClick="JQDel_Banner('<?=$a_data['banner_id']?>');" data-toggle="tooltip" data-placement="right" title="<?=$text_genbanner_altdel;?>" > 
<button type="button" class="btn btn-danger  btn-circle  btn-xs " >
<i class="far fa-trash-alt" aria-hidden="true"></i>
</button>
</a>
<a onClick="boxPopup('<?=linkboxPopup();?>pop_view_banner.php?ban_id=<?=$a_data['banner_id']?>');" data-toggle="tooltip" data-placement="right" title="<?="ดูรูปภาพ";?>">
<button type="button" class="btn btn-success  btn-circle  btn-xs " >
<i class="fas fa-search" aria-hidden="true"></i>
</button>
</a> 					
