...
?>	
<form id="form_main" name="form_main" method="POST" action="<?=getLocation('func_edit_banner')?>" enctype="multipart/form-data" >
<input type="hidden" name="proc" id="proc"  value="Edit_Banner">
<input type="hidden" name="banner_gid" id="banner_gid"  value="<?=$ban_cid;?>">
<input type="hidden" name="banner_id" id="banner_id"  value="<?=$ban_id;?>">
<div class="container" >   
...
<h4 class="modal-title  color-white"><i class="fas fa-plus-circle"></i> <?=$text_genbanner_formedit;?></h4>
</div>
...
<input class="form-control" placeholder="<?=$text_genbanner_formname;?>" name="banner_name" type="text" id="banner_name"  value="<?=$a_banner['banner_name'];?>" >
</div>
</div>
<div class="form-group row " >
<label for="banner_detail" class="col-sm-6 control-label"><b><?php echo $text_genbanner_formdetail;?> :</b></label>
<div class="col-md-12 col-sm-12 col-xs-12" >
<textarea class="form-control" placeholder="<?=$text_genbanner_formdetail;?>"  rows="5" id="banner_detail" name="banner_detail"  ><?=$a_banner['banner_detail'];?></textarea>
</div>
</div>
<!--<div class="form-group row " >
...
<input class="form-control" placeholder="<?=$text_genbanner_formpic;?>"  name="banner_pic" type="text" id="banner_pic"  value="<?=$a_banner['banner_pic'];?>" >
</div>
...
<div class="col-md-12 col-sm-12 col-xs-12" >
<input type="file" name="banner_pic" id="banner_pic" placeholder="<?=$txt_banner_image ;?>" class="form-control" onchange="JSCheck_Img(this.id,this.value);" <?php if(empty($a_banner['banner_pic'])){ echo 'required="required"'; } ?> />
<?php
if(!empty($a_banner['banner_pic'])){
?>
<span><code><?=$a_banner['banner_pic'];?></code></span><br>
<?php } ?>
...
<input name="banner_pic_old" type="hidden" id="banner_pic_old" value="<?=$a_banner['banner_pic'];?>">
...
<input class="form-control" placeholder="<?=$text_genbanner_formlink;?>" name="banner_link" type="text" id="banner_link"  value="<?=$a_banner['banner_link'];?>" >   
</div>
<div class="col-md-2 col-sm-2 col-xs-12" >
...
<div class="col-md-12 col-sm-12 col-xs-12" >
<input class="form-control" placeholder="<?=$text_genbanner_formalt;?>"  name="banner_alt" type="text" id="banner_alt"  value="<?=$a_banner['banner_alt'];?>" >
</div>
</div>
<div class="form-group row">
...
<label for="start_date"><b><?="วันที่ในการแสดงผลเริ่มต้น";?> : </b></label>
            <div class='input-group date datepicker' id='datetimepicker1'>
                <input type='text' class="form-control cal" placeholder="<?="วันที่ใช้ในการแสดงผลเริ่มต้น";?>" name="start_date"  id="start_date" value="<?=$a_banner['banner_show_start'];?>" >
...
<label for="end_date"><b><?="วันที่ในการแสดงผลสิ้นสุด";?> : </b></label>
            <div class='input-group date datepicker' id='datetimepicker2'>
                <input type='text' class="form-control cal" placeholder="<?="วันที่ใช้ในการแสดงผลสิ้นสุด";?>"  name="end_date"  id="end_date" value="<?=$a_banner['banner_show_end'];?>" >
                <span class="input-group-addon">
                    <i class="far fa-calendar-alt"></i>
                </span>
            </div>
