...
?>	
<form id="form_main" name="form_main" method="POST" action="<?=getLocation('func_add_banner_group')?>" enctype="multipart/form-data" >
...
<h4 class="modal-title  color-white"><i class="fas fa-plus-circle"></i> <?=$txt_banner_add_cate;?></h4>
</div>
...
<input class="form-control" placeholder="<?=$txt_banner_cate_name;?>" name="banner_name" type="text" id="banner_name"  value="" required="required" />
</div>
</div>
<div class="form-group row " >
<label for="banner_detail" class="col-sm-6 control-label"><b><?=$txt_banner_cate_detail;?> :</b></label>
<div class="col-md-12 col-sm-12 col-xs-12" >
<textarea class="form-control" placeholder="<?=$txt_banner_cate_detail;?>"  rows="5" id="banner_detail" name="banner_detail"  ></textarea>
</div>
</div>
...
<input type="text" class="form-control" placeholder="<?=$txt_banner_h_placeholder;?>"  id="banner_w" name="banner_w"  /> 
...
<input type="text" class="form-control" placeholder="<?=$txt_banner_w_placeholder;?>"  id="banner_h" name="banner_h"  />  
