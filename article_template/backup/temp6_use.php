...
<?php echo stripslashes($C1["ad_des"]); ?></td>
    ...
    <td valign="top" align="<?php echo $C1["ad_align"]; ?>"> 
      <?php if($C1["ad_pic_s"] != ""){ ?>
 <div><a href="<?php if($C1["ad_pic_b"] != ""){ echo "images/article/news".$nid."/".$C1["ad_pic_b"]; }else{ echo "../../images/o.gif"; } ?>" class="lightbox" rel="flowers"  id="<?php echo $b; ?>"><img src="<?php if($C1["ad_pic_s"] != ""){ echo "images/article/news".$nid."/".$C1["ad_pic_s"]; }else{ echo "../../images/o.gif"; } ?>" name="imgx1y<?php echo $b; ?>" id="imgx1y<?php echo $b; ?>" style="border-color:'#C3C3C3'" border=1></a></div>
      <?php } ?>
<?php echo stripslashes($C1["ad_des"]); ?></td>
    <?php
