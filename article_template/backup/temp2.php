...
?>
  <tr bgcolor="#FFFFFF"> 
    <td width="65%" valign="top"><span  id="previewex<?php echo $a; ?>y<?php echo $b; ?>"><form action="article_editor.php" method="post"  name="formex<?php echo $a; ?>y<?php echo $b; ?>" target="ftargetx<?php echo $a; ?>y<?php echo $b; ?>"><strong>รายละเอียด: 
						...
						<input name="posdisp" type="hidden" id="posdisp" value="x<?php echo $a; ?>y<?php echo $b; ?>">
						  ...
						  <textarea style="display:none" name="dx<?php echo $a; ?>y<?php echo $b; ?>" cols="40" rows="5" wrap="VIRTUAL" id="dx<?php echo $a; ?>y<?php echo $b; ?>"><?php
							  ...
							  ?></textarea>
							<table width="400" height="320" cellpadding="3" cellspacing="2" border="0" style="cursor:hand;border:#999999 dashed 1px;" onmouseover="this.style.borderColor='#FF0000'" onmouseout="this.style.borderColor='#999999'" title="Click To Edit"  onClick="this.style.display='none';generate_wysiwyg('dx<?php echo $a; ?>y<?php echo $b; ?>','400','250');document.all.hbOtx<?php echo $a; ?>y<?php echo $b; ?>.style.display='';">
							  <tr>
...
<input type="button" name="save" value=" บันทึก " style="width:60 px"  onClick="sendCode('dx<?php echo $a; ?>y<?php echo $b; ?>',document.formex<?php echo $a; ?>y<?php echo $b; ?>,document.all.pex<?php echo $a; ?>y<?php echo $b; ?>)"><input type="button" name="cancel" value=" ยกเลิก " style="width:60 px"    onClick="cancelCode('dx<?php echo $a; ?>y<?php echo $b; ?>',document.formex<?php echo $a; ?>y<?php echo $b; ?>,document.all.pex<?php echo $a; ?>y<?php echo $b; ?>)"></div>
  ...
  <?php $b++; }} ?>
  <tr bgcolor="#FFFFFF"> 
    <td colspan="2" align="right" valign="top"><input name="allx" type="hidden" id="allx" value="2">
      <input name="ally" type="hidden" id="ally" value="<?php echo $b; ?>"></td>
  </tr>
</table>
