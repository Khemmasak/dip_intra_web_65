...
<?php
  ...
  <tr align="<?php echo $C1["ad_align"]; ?>" > 
    <td width="99%" valign="top"><font color="<?php echo $C1["ad_color"]; ?>" size="<?php echo $C1["ad_size"]; ?>" face="<?php echo $C1["ad_font"]; ?>" style="<?php echo $C1["ad_bold"]; ?><?php echo $C1["ad_italic"]; ?>"><?php echo $C1["ad_des"]; ?></font>      </td>
  </tr>
  <?php
$b = 1;
