  ...
  ?>
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="1">
      <tr >
		...
		<?php if(!empty($B_id[0])){?><img src="<?php echo icon_block2($B_id[1],'../'); ?>" width="20" height="20" align="absmiddle"><?php//php echo $B_id[2];?><?php } ?><?php echo  listname_block($B_id[1],$B_id[3],$B_id[0]);?></td>
      </tr>
      <tr >
        <td height="20"></td>
      </tr>
