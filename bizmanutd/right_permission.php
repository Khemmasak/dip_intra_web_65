...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td class="ewtfunction">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../images/arrow_r.gif" width="7" height="7" align="absmiddle" border="0">&nbsp;รายงานสิทธิ์ผู้ใช้งานระบบ</td>
  </tr>
  <tr valign="top"> 
    <td> 
      <?php
      ...
      <table width="96%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
		...
		?>
          <tr bgcolor="#FFFFFF"> 
            ...
            <td colspan="2" align="center"><a href="#set" onClick="window.open('ewt_permission0.php?UID=<?php echo $R["UID"]; ?>','view','width=750,height=550,scrollbars=1,resizable=1');">View</a></td>
          </tr>
          <?php $i++; } ?>
