...
<span id="divhtml" style="display:none"></span>
 ...
 $i=0;
  ...
  $sql_sadmin = $db->query_db("SELECT * FROM permission WHERE p_type = '$mtype' AND pu_id = '$mid' AND UID = '$UID' AND s_type = '".$ptype."' AND s_permission = '".$ppms."'  AND s_id = '".$U["Main_Group_ID"]."' ",$EWT_DB_NAME);
