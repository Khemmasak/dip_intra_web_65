...
for($i=0;$i<sizeof($arr_mail);$i++){
		...
		$sql="INSERT INTO ecard_history(ech_ecardid,ech_from,ech_to,ech_subject,ech_message,ech_ip,ech_datetime,ech_gen_userid) 
		VALUES('$fid','$sendemail','$targetMail','$subject','$body','$IPn','".date('YmdHis')."','$_SESSION[EWT_MID]')   ";
		$query=$db->query($sql);
