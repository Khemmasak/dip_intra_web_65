...
top.location.href="ewt_login.php?fn=addquestion.php?wcad=<?php echo $wcad; ?>&t=<?php echo $_GET[t];?>";
</script>
<?php
exit;
}
...
$Ex_question= $db->query("SELECT * FROM w_question WHERE c_id = '$wcad' and t_id = '$wtid'");
...
?>
  <tr>
    <td height="25"><strong><a href="m_webboard.php&t=<?php echo $_GET[t]?>"><?php echo $text_genwebboard_pagemain;?></a> <img src="wb_pic/arrow_r.gif" width="7" height="7" align="absmiddle"> <a href="index_question.php?wcad=<?php echo $wcad; ?>&t=<?php echo $_GET[t]?>"><?php echo $QQ[c_name]; ?></a> <img src="wb_pic/arrow_r.gif" width="7" height="7" align="absmiddle"> <?php echo $text_genwebboard_editquation;?></strong></td>
  </tr>
  <tr>
    <td  valign="top">
	<?php echo $design[0];?><table width="60%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="<?php echo $bg_color;?>"  background="<?php echo $Current_Dir1.$bg_img;?>" class="normal_font">
  ...
  <tr >
    <td align="center" background="<?php echo $Current_Dir1.$head_img;?>" bgcolor="<?php echo $head_color;?>"><strong><span class="text_head"><font color="<?php echo $head_font_color;?>"  face="<?php echo $head_font_face;?>"><span style="font-size: <?php echo $head_font_size;?>"><?php echo $text_genwebboard_editquation;?></span></font></span></strong></td>
  </tr>
  <tr >
    <td bgcolor="<?php echo $body_color;?>" background="<?php echo $Current_Dir1.$body_img;?>"><table border=0 cellpadding=2 cellspacing=1 width="100%">
      <tr>
        <td ><table width="100%" border="0" cellpadding="2" cellspacing="0">
            <?php
			$t_detail =  CheckTag($QQ_question[t_detail]);
		$t_detail =  eregi_replace ( "<br>" ,chr(13), $t_detail ) ;
		...
		$db->query("USE ".$EWT_DB_NAME);
		 ...
		 $mail= '';
		  $read = '';
			...
			?>
            <tr>
              <td width="18%" align="right"><span class="text_normal"><font color="<?php echo $body_font_color;?>"  face="<?php echo $body_font_face;?>" ><span style="font-size: <?php echo $body_font_size;?>"><?php echo $text_genwebboard_headboard;?></span></font></span></td>
              <td width="82%"><input name="aque" type=text class=violet id="aque" size=51 maxlength=30 value="<?php echo htmlspecialchars(stripslashes($QQ_question[t_name]));?>">              </td>
            </tr>
            <tr>
              <td width="18%" align="right"><span class="text_normal"><font color="<?php echo $body_font_color;?>"  face="<?php echo $body_font_face;?>" ><span style="font-size: <?php echo $body_font_size;?>"><?php echo $text_genwebboard_detail;?></span></font></span></td>
              <td width="82%">	<textarea rows="5" cols="50" name="amsg" id="amsg" class=violet><?php echo $t_detail;?></textarea>              </td>
            </tr>
            <?php if($R[c_pic] == "Y"){  ?>
            <tr>
              ...
              <td width="80%"><span class="style5">
                <input type="file" name="file">
                <?php echo ereg_replace ("<#size#>", $X[c_sizeupload], $text_genwebboard_filesize);?></span></td>
            </tr>
            <?php } ?>
            <tr>
              <td width="18%" align="right"><span class="text_normal"><font color="<?php echo $body_font_color;?>"  face="<?php echo $body_font_face;?>" ><span style="font-size: <?php echo $body_font_size;?>"><?php echo $text_genwebboard_by;?></span></font></span></td>
              <td width="82%"><input name="aname" type=text class=violet id="aname" value="<?php echo $name_a;?>" size=51 maxlength=30 <?php if($_SESSION["EWT_MID"] != ""){ echo 'readonly';}?>>              </td>
            </tr>
            <tr>
              <td width="18%" align="right"><span class="text_normal"><font color="<?php echo $body_font_color;?>"  face="<?php echo $body_font_face;?>" ><span style="font-size: <?php echo $body_font_size;?>"><?php echo $text_genwebboard_email;?></span></font></span></td>
              <td width="82%"><input name="aemail" type=text class=violet id="aemail" value="<?php echo $mail;?>" size=24 maxlength=50 <?php echo $read;?>>              </td>
            </tr>
        </table></td>
      </tr>
      <tr>
  ...
  <tr >
    <td colspan="2" align="center" height="<?php echo $bottom_height ;?>" background="<?php echo $Current_Dir1.$bottom_img;?>"   bgcolor="<?php echo $bottom_color;?>"><b><font color="#FFFFFF" class=size3>
                        ...
                        <input name="flag" type="hidden" id="flag" value="question_edit">
