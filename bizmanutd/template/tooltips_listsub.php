...
?>
  <tr>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;<img src="mainpic/arrow_r.gif" width="7" height="7" border="0" align="absmiddle" >&nbsp;<a href="#G" onClick="show_detailsub(<?php echo $R[tips_list_id];?>,<?php echo $_GET[gtips_id];?>);"><span  class="text_normal"><?php echo $R[tips_list_title];?></span></a></td>
  </tr>
 <?php } ?>
</table>
<?php $db->db_close(); ?>
