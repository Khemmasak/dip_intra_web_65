...
<DIV><?php echo show_block($LB[0]); ?></DIV>
	...
	$fetch_dis = $db->db_fetch_array($query_dis);
	$html = "";
...
<tr>
  ...
  <tr>
    <td align="right">&nbsp;</td>
    <td height="30" ><img src="../mainpic/icon_news.gif" border="0"   alt="รายละเอียดกิจกรรม">รายละเอียดกิจกรรม</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    ...
    <td><table width="100%" border="0" cellpadding="3" cellspacing="0">
      ...
      <tr>
	    ...
	    <tr>
	      ...
	      <td valign="top"><img src="../mainpic/document_view.gif" alt="ดู" onClick="window.open('calendar_view_link.php?flag=link&amp;img_name=<?php echo $fetch_dis[event_link]?>','calendar_view_link','width=500 , height=400,scrollbars=1,resizable = 1'); " style="cursor:hand"></td>
	      </tr>
		  	<?php } ?>
	  <!--
      <tr>
        <td valign="top" nowrap><?php if($fetch_dis[event_registor] == '1'){ ?>สมัครเข้าร่วมกิจกรรม<?php } ?></td>
        <td valign="top"><?php if($fetch_dis[event_registor] == '1'){ ?><a href="#RG" onClick="window.open('calendar_registor.php?event_id=<?php echo $_GET['event_id'];?>','registor','width=800 , height=750, scrollbars=1,resizable = 0');"><img src="../mainpic/icon_news.gif" alt="สมัครเข้าร่วมสัมมนา" width="21" height="21" border="0" ></a><?php } ?></td>
      </tr>
-->
    </table></td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td rowspan="2">&nbsp;</td>
    <td height="44" ><a href="calendar_all.php?filename=<?php echo $filename;?>">ปฏิทินกิจกรรมทั้งหมด</a></td>
    <td rowspan="2">&nbsp;</td>
  </tr>
  <tr>
