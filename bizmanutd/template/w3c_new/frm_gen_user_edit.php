...
<input type="hidden" name="hfile" value="<?php echo $path_image;?>" >
        ...
        <script language="javascript" type="text/javascript">
            ...
            <tr>
              ...
              <td colspan="2" align="left"> <input name="emp_type_status" type="hidden" value="<?php echo $emp_type_status;?>"><input name="gen_user" type="text" id="gen_user" value="<?php echo $gen_user;?>" size="30" disabled="disabled">&nbsp;&nbsp;
