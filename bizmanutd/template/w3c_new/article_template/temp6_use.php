...
?>
 ...
 <a href="<?php if($C1["ad_pic_b"] != ""){ echo "../images/article/news".$nid."/".$C1["ad_pic_b"]; }else{ echo "../../../images/o.gif"; } ?>"><img src="<?php if($C1["ad_pic_s"] != ""){ echo "../images/article/news".$nid."/".$C1["ad_pic_s"]; }else{ echo "../../../images/o.gif"; } ?>" border="0" alt="<?php if($C1["ad_des"] != ''){echo $C1["ad_des"];}else{ echo $C1["ad_pic_s"];}?>"></a></div>
      <?php } ?>
...
<?php echo preg_replace ($search, $replace,stripslashes($C1["ad_des"])); ?></td>
    ...
    <td  valign="top" align="<?php echo $C1["ad_align"]; ?>"> 
      <?php if($C1["ad_pic_s"] != ""){ ?>
    <div><a href="<?php if($C1["ad_pic_b"] != ""){ echo "../images/article/news".$nid."/".$C1["ad_pic_b"]; }else{ echo "../../../images/o.gif"; } ?>" ><img src="<?php if($C1["ad_pic_s"] != ""){ echo "../images/article/news".$nid."/".$C1["ad_pic_s"]; }else{ echo "../../../images/o.gif"; } ?>" border="0" alt="<?php if($C1["ad_des"] != ''){echo $C1["ad_des"];}else{ echo $C1["ad_pic_s"];}?>"></a>
</div>
      <?php } ?>
<?php echo preg_replace ($search, $replace,stripslashes($C1["ad_des"])); ?></td>
  </tr>
