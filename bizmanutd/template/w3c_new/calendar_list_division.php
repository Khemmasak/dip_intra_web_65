      ...
      <table width="90%" style="height:30px" border="0" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
        <tr>
          <th style="height:30px" bgcolor="#F4F4FF" align="left">&nbsp;
            <img src="images/icon_more.gif" width="12" height="7" alt="icon_more" > <strong>รายชื่อหน่วยงานที่เกี่ยวข้อง</strong></th>
        </tr>
        <tr>
                ...
                <tr>
                  <th bgcolor="#FFFFFF" scope="col"><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" align="center">
                    <tr>
                      ...
                      <td style="height:25px" bgcolor="#F4F4FF"><div align="center"><strong>ชื่อหน่วยงาน</strong></div></td>
                    </tr>
                    <?php
 	$page = $_POST[page];
	if(!$limit) $limit = 10;
  ...
  ?>
	  ...
	  <?php if(count($_POST[id]) == 0 && count($_POST[name]) == 0 && $_POST[Submit2] != "บันทึก"){?>
		...
		<?php }?>
                      ...
                      <td style="height:25px" bgcolor="#FFFFFF"><div align="left"> <?php echo $text_org?> </div></td>
                    </tr>
