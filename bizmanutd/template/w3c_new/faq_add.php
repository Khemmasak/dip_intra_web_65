...
?>
 <table width="80%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#B07331" >
  ...
  <table width="80%" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
    <td height="25" bgcolor="#CCCCCC" >&nbsp; <strong><?php echo $text_genfaq_adddetail;?></strong></td>
    </tr>
  <tr>
	...
	<form name="faq_add" method="post" action="faq_add.php"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#333333" class="normal_font">
                ...
                </table>   </form><a href="http://validator.w3.org/check?uri=referer"><img src="../w3c/checked/images/w3c_gold.bmp" alt="Valid HTML 4.01 Transitional" height="31" width="88" border="0"></a><?php  include("ewt_span.php");?></td>
  </tr>
</table>	  
</body>
</html>
