...
$text_genecard_headtitle="ระบบส่ง E-Card";
              ...
              <tr> 
                <td valign="top" bgcolor="#FFFFFF"><br>
                  <table width="90%" border="0" align="center" cellpadding="10" cellspacing="1" bgcolor="#A9A9E0">
                    <tr>
                      <td bgcolor="#DBDBF2"><font size="4" face="Tahoma"><strong><font color="#666666"><?php echo $text_genecard_headtitle;?></font></strong></font>
                  <hr width="100%" size="1"  align="left"  color="#D8D2BD">
				   <span class="mytext_normal">
				   <strong>
				   <a href="ecard_main.php" target="ecard_body"><img src="mainpic/folder_closed.gif" width="16" height="16" border="0" align="absmiddle"> ส่ง E-card</a>
				   <a href="ecard_history.php" target="ecard_body"><img src="mainpic/folder_closed.gif" width="16" height="16" border="0" align="absmiddle"> ประวัติการส่ง E-card</a>
				</strong>
				</span>					</td>
                    </tr>
                  </table>
...
<table width="100%" height="600" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
                      <tr> 
                        <td bgcolor="#FFFFFF"><iframe name="ecard_body" src="ecard_main.php"  frameborder="0"  width="100%" height="100%" scrolling="yes"></iframe></td>
                      </tr>
