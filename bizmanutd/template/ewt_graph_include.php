...
$txt = '<graph caption=\''.addslashes($graph_title).'\' xAxisName=\''.addslashes($graph_xname).'\' yAxisName=\''.addslashes($graph_yname).'\' decimalPrecision=\'0\' formatNumberScale=\'0\' showNames=\'0\'  baseFont=\'Tahoma\'  baseFontSize=\'11\'  outCnvBaseFontSize=\'11\' outCnvBaseFont=\'Tahoma\' rotateNames=\''.$graph_rotate.'\'  >';
