...
$sql_select_left = $db->query("SELECT COUNT(*) FROM temp_main_group t1, temp_main_group t2 WHERE t1.Main_Position <= t2.Main_Position AND t2.Main_Group_ID = '".$_GET["gid"]."' ");
...
<SCRIPT language=JavaScript>
			...
			function Editfile(c){
				if(self.top.module_obj.document.formTodo.stype.value =="link"  && self.top.module_obj.document.formTodo.Flag.value == "Link" ){
					sendfile(c);
				}else{
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="40" bgcolor="F3F3EE">&nbsp;&nbsp;&nbsp;<a href="<?php echo $up_link; ?>" title="<?php echo $up_title; ?>"><img src="../images/content_folder_up.gif" width="24" height="24" border="0" align="absmiddle"> 
      ...
      Home</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="content_search.php"><img src="../images/content_folder_search.gif" width="24" height="24" border="0" align="absmiddle"> 
      Search</a>--></td>
  </tr>
    <tr>
  ...
  <tr>
    ...
    <td height="40" bgcolor="F3F3EE">&nbsp;&nbsp;&nbsp;<a href="#new" onClick="create_folder();"><img src="../images/content_new_folder.gif" width="24" height="24" border="0" align="absmiddle"> 
      ...
      Delete</a><span style="display:none">
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#security" onClick="setting_file();"><img src="../images/security_set_off.gif" name="s_img" width="24" height="24" border="0" align="absmiddle" id="s_img"> 
      Security</a></span>
	  </td>
  </tr>-->
    <tr>
  ...
  <tr>
    <td height="1" bgcolor="#FFFFFF"></td>
  </tr><form name="Removeform" method="post" action="content_function.php"><input name="direct" type="hidden" id="direct" value="content_view.php?gid=<?php echo $_GET["gid"]; ?>"> 
...
<script language="JavaScript">
						<!--//
							...
							var n = top.content_bottom.document.form1.num.value;
							top.content_left.document.getElementById('ah'+n).removeAttribute("style");
							top.content_left.document.getElementById('ah<?php echo $CTL[0]; ?>').style.backgroundColor = "#B2B4BF";
							top.content_bottom.document.form1.num.value = "<?php echo $CTL[0]; ?>";
							top.content_bottom.document.all.txt_status.innerHTML = "<?php echo $text_status; ?>";
							}
