<?php
	...
	$t=checkPttVar($t);
	$_GET["t"]=checkPttVar($_GET["t"]);
	$_POST["t"]=checkPttVar($_POST["t"]);
	
	if($load){ $load = checkNumeric($load); }
	if($_GET["load"]){ $_GET["load"] = checkNumeric($_GET["load"]); }
	if($_POST["load"]){ $_POST["load"] = checkNumeric($_POST["load"]); }
	//======================================================================
/*
...
function Dot2LongIP ($IPaddr)
{
	...
	// end check OS
		...
		$db->query("INSERT INTO stat_visitor (`sv_url`,`sv_visitor`,`sv_menu`,`sv_ip`,`sv_timestamp`,`sv_date`,`sv_time`,`sv_country`,`sv_language`,`sv_new`,`sv_browser`,`sv_resolution`,`sv_domain`,`sv_isp`,`sv_region`,`sv_city`,`sv_latitude`,`sv_longitude`,`sv_referer`,`sv_search`,`sv_keyword`,`sv_os`,`sv_load`,`sv_member`,`sv_fullurl`,`sv_mem_id`) VALUES ('".$myurl."','".$visitor."','".$_GET["filename"]."','".$myip."','".$mytimestamp."','".$mydate."','".$mytime."','".$mycountry."','".$mylanguage."','".$newvisitor."','".$mybrowser."','".$myresolution."','".$mydomain."','".$myisp."','".$myregion."','".$mycity."','".$mylatitude."','".$mylonditude."','".$myreferer."','".$mysearchengine."','".$mykeyword."','".$myos."','".$myload."','".$mymember."','".$myfullurl."','".$_SESSION["EWT_MID"]."')");
	}else{
		$db->query("USE ".$EWT_DB_NAME);
		if($_SESSION["EWT_MID"] != ''){
		$mymember ='Y';
		}
		$db->query("INSERT INTO stat_visitor (`sv_url`,`sv_visitor`,`sv_menu`,`sv_ip`,`sv_timestamp`,`sv_date`,`sv_time`,`sv_country`,`sv_language`,`sv_new`,`sv_browser`,`sv_resolution`,`sv_domain`,`sv_isp`,`sv_region`,`sv_city`,`sv_latitude`,`sv_longitude`,`sv_referer`,`sv_search`,`sv_keyword`,`sv_os`,`sv_load`,`sv_member`,`sv_fullurl`,`sv_mem_id`) VALUES ('".$myurl."','".$visitor."','".$_GET["filename"]."','".$myip."','".$mytimestamp."','".$mydate."','".$mytime."','',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'".$myload."','".$mymember."','".$myfullurl."','".$_SESSION["EWT_MID"]."')");
	}
}
$db->db_close(); ?>