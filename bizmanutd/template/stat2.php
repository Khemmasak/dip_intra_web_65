...
echo "INSERT INTO stat_visitor (`sv_url`,`sv_visitor`,`sv_menu`,`sv_ip`,`sv_timestamp`,`sv_date`,`sv_time`,`sv_country`,`sv_language`,`sv_new`,`sv_browser`,`sv_resolution`,`sv_domain`,`sv_isp`,`sv_region`,`sv_city`,`sv_latitude`,`sv_longitude`,`sv_referer`,`sv_search`,`sv_keyword`,`sv_os`,`sv_load`) VALUES ('".$myurl."','".$visitor."','".$_GET["filename"]."','".$myip."','".$mytimestamp."','".$mydate."','".$mytime."','".$mycountry."','".$mylanguage."','".$newvisitor."','".$mybrowser."','".$myresolution."','".$mydomain."','".$myisp."','".$myregion."','".$mycity."','".$mylatitude."','".$mylonditude."','".$myreferer."','".$mysearchengine."','".$mykeyword."','".$myos."','".$myload."')";
