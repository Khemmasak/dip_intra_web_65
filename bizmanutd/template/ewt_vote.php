...
if($_POST["vote"] != "" and  $_POST["flag"]<>'1' ){
		...
		if(!isset($_COOKIE["votevote".$_POST["cad_id"]]) OR $diff < 0 OR $skip == "1"){
				...
				alert("<?php echo $text_genpoll_message1;?>");
				//window.close();
				</script>
		<?php
		exit;
		...
		?>
				<script language="JavaScript">
				alert("<?php if($err == "1"){ ?> <?php echo $text_genpoll_message2;?>  <?php echo  DiffToText_new($diff);?><?php } ?>");
				//window.close();
				</script>
		<?php
...
<link  href="css/interface.css" rel="stylesheet" type="text/css"></head>
<?php
if($lang_sh != ''){
...
?>
<div align="center"><br><b><?php echo stripslashes($pollR[c_name]); ?></b> </div>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center"><table width="50%" border="0" cellpadding="2" cellspacing="1" bgcolor="#000000">
  <tr>
