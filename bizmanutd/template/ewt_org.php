...
<?php
//echo "SELECT * FROM org_name WHERE org_id = '".$_GET["oid"]."' ";
	...
	<?php if($sdetail == "Y"){ ?><hr size="1">
      <!--<table width="95%" border="0" align="center" cellpadding="3" cellspacing="0" style="border-collapse:collapse">
        <tr> 
          ...
          <td width="69%"><?php//php echo $R[org_place] ?></td>
        </tr>
        <tr> 
          <td class="bg_color_row">ที่อยู่ :</td>
          <td><?php//php echo $R[org_address] ?></td>
        </tr>
        <tr> 
          <td class="bg_color_row">เบอร์โทรศัพท์ภายใน :</td>
          <td><?php//php echo $R[tel] ?></td>
        </tr>
        <tr> 
          <td class="bg_color_row">Fax :</td>
          <td><?php//php echo $R[fax] ?></td>
        </tr>
        <tr> 
          <td class="bg_color_row">Email : </td>
          <td><?php//php echo $R[email] ?></td>
        </tr>
        <tr> 
          <td class="bg_color_row">URL :</td>
          <td><?php//php echo $R[org_url] ?></td>
        </tr>
      </table>-->
...
<table width="70%" border="0" align="center" cellpadding="3" cellspacing="0">
  ...
  <tr>
    <td>
	<?php
	//echo "SELECT * FROM gen_user WHERE posittion = '".$P["pos_id"]."'  and  gen_user.org_id = '".$R["org_id"]."' order by  level_id ASC,org_type_id DESC,name_thai  ASC";
...
//echo $lang_shw;
	...
	?>
          <td width="33%" align="center"><?php if($spic == "Y"){ ?><img src="img.php?p=<?php echo base64_encode($path_image2); ?>" width="98" height="98" align="absmiddle"><?php } ?><?php if($sname == "Y"){ ?><br><font size="2"><?php echo $U["name_thai"]; ?> <?php echo $U["surname_thai"]; ?><br><?php echo $U["position_person"]; ?></font><?php } ?>
...
<table width="70%" border="0" align="center" cellpadding="3" cellspacing="0">
  ...
  <tr>
	...
	?>
          <td width="33%" align="center"><?php if($spic == "Y"){ ?><img src="img.php?p=<?php echo base64_encode($path_image2); ?>" width="98" height="98" align="absmiddle"><?php } ?><?php if($sname == "Y"){ ?><br><font size="2"><?php echo $U2["name_thai"]; ?> <?php echo $U2["surname_thai"]; ?><br><?php echo $U2["position_person"]; ?></font><?php } ?>
