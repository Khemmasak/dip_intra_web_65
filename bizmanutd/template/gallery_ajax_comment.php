...
<table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC" class="styleMe">
  <tr>
    <th height="20" colspan="2" bgcolor="#5599CC" scope="col"  class="styleMe"><strong style="color:#FFFFFF">ความคิดเห็น</strong></th>
  </tr>
  <tr>
...
<?php
	...
	?>
      <table width="95%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#EBEBEB"  class="styleMe">
          <tr>
      ...
      <br />
        ...
        <table width="95%" border="0" align="center" bgcolor="#FFFFFF">
          <tr>
            <th  class="styleMe"><div align="right">หน้าที่
              <select name="page"  class="styleMe" onchange="var url = 'gallery_ajax_comment.php?page='+this.value+'&amp;category_id=<?php echo $category_id?>&amp;img_id=<?php echo $img_id?>&limit=<?php echo $limit?>';  load_divForm(url,'div_comment','');">
                      <?php
	...
	?>
        <br />
        <table width="95%" border="0" align="center" bgcolor="#EBEBEB"  class="styleMe">
          <tr>
            <th class="styleMe"><div align="center"><strong style="color:#FF0000"> ไม่มีความคิดเห็น </strong></div></th>
          </tr>
        </table>
      <?php }?>
        <br /></td>
