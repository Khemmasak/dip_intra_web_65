...
$server->register('MeetingReport',										// method name
    ...
    array('docid' => 'xsd:string','docdate' => 'xsd:string','docname' => 'xsd:string','docurl' => 'xsd:string','docmid' => 'xsd:string'),	 // output parameters
