...
$DB["host"]   = "localhost"; //"203.147.62.229";
$DB["user"]   = "root"; //"biz";
$DB["pass"]   = ""; //"bizpoten2008"; 
...
$NOW = date('Y-m-d');
$proj_title = "Quiz Game Center"; 
//$titlePage="";
//$admin_email="support@bizpotential.com";
$HTTPROOT = "http://localhost/quizgame/";  //"http://www.sci-educ.nfe.go.th/nfe_dsec/";
$folder_root = "C:\\AppServ\\www\\quizgame\\";  // not sure
