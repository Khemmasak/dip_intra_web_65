...
function img_preview(fileObj, imgObj) {
	...
	function chkLang(lang, objFocus) {
			if(lang=='TH') {
				if((event.keyCode < 3585 || event.keyCode > 3673) && ( event.keyCode != 32 ) && ( event.keyCode != 13 ) && ( event.keyCode != 95 ) ) {
					alert('เธเธฃเธธเธ“เธฒเธเธฃเธญเธเน€เธเนเธเธ เธฒเธฉเธฒเนเธ—เธขเน€เธ—เนเธฒเธเธฑเนเธ');
					objFocus.focus();                       // 13 is ENTER , 95 is _
					return false;
				}
			} else {
				if(event.keyCode >= 3585 && event.keyCode <= 3673) {
					alert('เธเธฃเธธเธ“เธฒเธเธฃเธญเธเน€เธเนเธเธ เธฒเธฉเธฒเธญเธฑเธเธเธคเธฉ เธซเธฃเธทเธญเธ•เธฑเธงเน€เธฅเธเน€เธ—เนเธฒเธเธฑเนเธ');
					objFocus.focus();
					return false;
				}
			}			
	...
	function chkFieldName(objFocus) {
		...
		{ 	
			alert('เธเธฃเธธเธ“เธฒเธเธฃเธญเธเธเธทเนเธญเธ”เนเธงเธข A-Z, a-z, _ เธซเธฃเธทเธญ 0-9 เน€เธ—เนเธฒเธเธฑเนเธ');
			objFocus.focus();
			return false;
		}			 
	}
	function chkSystemText(objName1, objName2 ) {
			...
			for(var j=0;j<SYSTEM_DB_TEXT.length;j++) {
				if( bufText1 == SYSTEM_DB_TEXT[j] ) {
					 alert("เนเธเธฃเธ”เธญเธขเนเธฒเนเธเนเธเธณเธชเธเธงเธ (reserve word) เนเธเธเธฒเธฃเธ•เธฑเนเธเธเธทเนเธญ");
					 objName1.focus();				 
					 return false;
				}
				/*if(objName2 != "") {
					if( bufText2 == SYSTEM_DB_TEXT[j] ) {
						 alert("เนเธเธฃเธ”เธญเธขเนเธฒเนเธเนเธเธณเธชเธเธงเธ (reserve word)");
					 	objName2.focus();				 
					 	return false;
					}
				}*/
...
function chkEnableList( obj, arr_tgt_obj, objtype, r) {
		...
		if(objtype==null) objtype='';
 		...
 		if( objtype.toLowerCase() == 'radio') {
			 //alert(obj[r].checked);
			if(obj[r].checked) {
				setEnable(arr_tgt_obj, 1, 1);
			} else {
				setEnable(arr_tgt_obj, 0, 1);
			}			
		} else if( objtype.toLowerCase() == 'checkbox' ) {
			//alert(obj.name);
...
function setEnable(arr_obj, bool, isdropdown) {
  if(bool) {
	  ...
	  if(document.frm.total_unit.value>0) {
			...
			for(var i=begin_pos;i<=document.frm.total_unit.value;i++) {
					...
					if( document.frm['d_unit_name'+i].value.search(document.getElementById('keyword').value) != -1 || document.frm['d_unit_code'+i].value.search(document.getElementById('keyword').value) != -1 ) {
						...
						begin_pos=i+1;									
						//document.getElementById('sch').innerHTML='<BR><BR>'+br+'<table bgcolor="#FFCC99" border="0" cellspacing="0" cellpadding="2" ><tr><td align="center" >เธเนเธเธซเธฒ</td></tr><tr><td align="center"><input name="keyword" type="text" id="keyword" size="15" border="1" height="15" ></td></tr><tr><td align="center"><img src="../images/text_view.gif" alt="เธ—เธณเธเธฒเธฃเธเนเธเธซเธฒ" style="cursor:hand" onClick="searchUnit();"></td></tr></table>';											
			...
			if(i > document.frm.total_unit.value) {
							//document.getElementById('body1').style.cursor = ''; no work
							found=0;
							alert('เนเธกเนเธเธเธเนเธญเธเธงเธฒเธกเธ—เธตเนเธเนเธเธซเธฒ');
							begin_pos=1;
							return i;
			}
	   }	
	} else {
			alert('เธเธฃเธธเธ“เธฒเธเธฃเธญเธเธเธณเธเนเธเธซเธฒ');
	}
}
...
function move_box(obj, offsetX, offsetY, repeat ) {
	...
	//if(document.body.scrollTop>200) {		
		...
		offsetY1 = offsetY;
	//}
	if(repeat) {  // เธ–เนเธฒเน€เธฃเธตเธขเธเธเธฑเธเธเนเธเธฑเนเธ เธเนเธณ
		repeat1 = repeat;
		setTimeout("move_box(obj1, offsetX1, offsetY1, repeat1)",10);
	} else {
		// เธ—เธณเธเธฒเธเธเธฃเธฑเนเธเน€เธ”เธตเธขเธง
		return 1;
	}
}

function reload_session() {
		alert('เธ–เนเธฒเนเธกเนเนเธเนเธเธฒเธเนเธเธฃเนเธเธฃเธก เธเธฃเธธเธ“เธฒเธญเธญเธเธเธฒเธเธฃเธฐเธเธเธเนเธฒ..');
		s_url='../ajax/reload_session.php';
		load_divForm(s_url,'sp_reload_session'); 
		setTimeout("reload_session()",1200000); 
}
