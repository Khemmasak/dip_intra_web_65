...
session_start();
$path = "../";
if(file_exists("article_html/article_".$_GET["nid"].".php")) {  
	include($path."lib/function.php");
	include($path."lib/user_config.php");
	include($path."lib/connect.php");
				$fp = fopen ("article_html/article_".$_GET["nid"].".php", 'rb');
				$ata = fread( $fp, filesize("article_html/article_".$_GET["nid"].".php"));
				$logo1 = "<a href=
...
border=\"0\"></a>"; 
$stat_code = '<script language="javascript1.2" type="text/javascript"> 
...
$file_template =$Website.$folder .'/main_auto_news.php?nid='.$_GET["nid"].'&filename='.$_GET["filename"].'&SSMID='.$_SESSION["EWT_MID"].'&SSMAIL='.$_SESSION["EWT_MAIL"].'&SSorg='.$_SESSION["EWT_ORG"].$forg;
