				   ...
				   if($_GET["page_type"]==2) {  // Template 
							...
							if(eregi("id=\"ewt_main_structure_body\"" ,$new_contents)) {
									...
									if($arr_check2[1] ) {																								
											...
											$clear_spliter = str_replace('<input name="w3c_spliter" type="hidden" value="111" >','',$arr_check2[1]);										
											$spliter  = '<input name="w3c_spliter" type="hidden" value="111" >'.$clear_spliter;
											//echo "!eregi w3c_spliter<BR>";
