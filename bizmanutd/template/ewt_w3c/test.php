...
<style type="text/css">
 ...
 td.c-8 {background:url(); background-color:#FFFFFF; height:px;}
 table.c-7 {WIDTH: 100%; HEIGHT: 60px}
 td.c-6 {background:url(); background-color:#FFFFFF;}
 td.c-5 {background:url(); background-color:#FFFFFF; height:160px}
 span.c-4 {FONT-SIZE: 10pt; COLOR: #0033ff; FONT-FAMILY: Tahoma}
 td.c-3 {background:url(); background-color:#FFFFFF}
 table.c-2 {WIDTH: 100%; BORDER-COLLAPSE: collapse}
 td.c-1 {background:url(images/design/constitution_and_acts/bg_top.jpg); background-color:; height:300px;}
</style>
</HEAD><body>
...
<tbody>
<tr>
<td width="480"><img height="267" src="../images/design/constitution_and_acts/constitution1_01.jpg" width="480" alt="ธงชาติไทย"></td>
...
<td>คณะกรรมาธิการ
<ul>
<li><a href="ewt_news.php?nid=9589">คณะกรรมาธิการสภาผู้แทนราษฎร</a></li>
<li><a href="ewt_news.php?nid=10611">คณะกรรมาธิการวุฒิสภา</a></li>
</ul>
</td>
<td>|</td>
...
<table width="100%" border="0">
<tr>
<td>ปฏิทินกิจกรรมประจำเดือน สิงหาคม  2552</td>
</tr>
<tr>
...
<td colspan="2"><input type="hidden" name="searchby" value="1" alt="searchby"> <input type="radio" name="chk" alt="เลือกค้นหาจากในเว็บ" checked value="1" onclick="if(this.checked==true){document.search124.searchby.value=this.value;} ">
 ค้นหาจากในเว็บ<br>
<input type="radio" name="chk" alt="เลือกค้นหาจาก Google นะ" value="2" onclick="if(this.checked==true){document.search124.searchby.value=this.value;} ">
 ค้นหาจาก Google</td>
</tr>
</table>
</form>
...
<img src="../ewt_c.php?n=ODc3" alt="000877"></td>
</tr>
</table>
</div>
</td>
<td id="ewt_main_structure_body" width="723" class="c-5"><#w3cbodycud#>
