...
$file_template =$Website.$folder .'/main_auto_question.php?wcad='.$_GET["wcad"].'&t='.$_GET["t"].'&filename='.$_GET["filename"].'&SSMID='.$_SESSION["EWT_MID"].'&SSMAIL='.$_SESSION["EWT_MAIL"].'&SSorg='.$_SESSION["EWT_ORG"];
