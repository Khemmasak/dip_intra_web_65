...
return $R[tips_group_name];
	...
	?>
<table width="100%"  border="0" cellpadding="20" cellspacing="1" bgcolor="BEBEC2">
<tr> 
  ...
  <tr> 
	...
	<table width="410" border="0" cellpadding="1" cellspacing="1">
	 <tr>
          <td bgcolor="FCFCFE" ><img src="../mainpic/webboard_bullet.gif" width="17" height="13" alt="" >&nbsp;<span class="text_head"><?php echo group_name($_GET[gtips_id]);?></span></td>
        </tr>
	<?php while($R = $db->db_fetch_array($query)){ ?>
        <tr>
          <td bgcolor="FCFCFE" class="text_normal">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../mainpic/bb1.jpg"  alt="">&nbsp;<a href="#G" onClick="show_detailsub(<?php echo $R[tips_list_id];?>,<?php echo $_GET[gtips_id];?>);" accesskey=<?php echo $db->genaccesskey();?>><span class="text_normal"><?php echo $R[tips_list_title];?></span></a></td>
        </tr>
		<? } ?>
      </table>
	<?php
	...
	<table width="410" border="0" cellpadding="1" cellspacing="1">
	 <tr>
          <td bgcolor="FCFCFE" class="text_head"><img src="../mainpic/webboard_bullet.gif" width="17" height="13"  alt="">&nbsp;<?php echo group_name($_GET[gtips_id]);?></td>
        </tr>
	<?php while($R = $db->db_fetch_array($query)){ ?>
        <tr>
          <td bgcolor="FCFCFE" class="text_normal">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../mainpic/bb1.jpg" alt="">&nbsp;<?php echo $R[tips_list_title];?></td>
        </tr>
        <tr>
	...
	<?php while($R = $db->db_fetch_array($query)){ ?>
        <tr>
          <td bgcolor="FCFCFE" class="text_normal"><img src="../mainpic/bb1.jpg"  alt="">&nbsp;<?php echo $R[tips_list_title];?><br ><?php echo nl2br($R[tips_list_detail]);?></td>
        </tr>
        <tr>
