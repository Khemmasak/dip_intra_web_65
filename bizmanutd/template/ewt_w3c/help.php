...
<table width="100%"  height="100%" border="0" bgcolor="#CCCCCC">
  ...
  <tr>
    <td id="td1"  align="center" class="text_normal" onClick="select_page('1');" style="cursor:hand">HOME</td>
	<td id="td2"  width="44" align="center" class="text_normal" onClick="select_page('2');" style="cursor:hand">PAGE</td>
    <td width="190">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
    <tr>
