...
?>
  <tr  > 
    <td align="<?php echo $C1["ad_align"]; ?>" valign="top"><?php if($C1["ad_pic_s"] != ""){ ?><div>
      <a href="<?php if($C1["ad_pic_b"] != ""){ echo "../images/article/news".$nid."/".$C1["ad_pic_b"]; }else{ echo "../../../images/o.gif"; } ?>" accesskey=<?php echo $db->genaccesskey();?>><img src="<?php if($C1["ad_pic_s"] != ""){ echo "../images/article/news".$nid."/".$C1["ad_pic_s"]; }else{ echo "../../../images/o.gif"; } ?>"  alt="<?php if($C1["ad_des"] != ''){echo  preg_replace ($search, $replace,stripslashes($C1["ad_des"]));}else{ echo $C1["ad_pic_s"];}?>"  border="0"></a>
</div>
      <?php } ?>
    ...
    <td   valign="top" align="<?php echo $C1["ad_align"]; ?>"> 
      <?php if($C1["ad_pic_s"] != ""){ ?>
      <div><a href="<?php if($C1["ad_pic_b"] != ""){ echo "../images/article/news".$nid."/".$C1["ad_pic_b"]; }else{ echo "../../../images/o.gif"; } ?>" accesskey=<?php echo $db->genaccesskey();?>><img src="<?php if($C1["ad_pic_s"] != ""){ echo "../images/article/news".$nid."/".$C1["ad_pic_s"]; }else{ echo "../../../images/o.gif"; } ?>"  alt="<?php if($C1["ad_des"] != ''){echo  preg_replace ($search, $replace,stripslashes($C1["ad_des"]));}else{ echo $C1["ad_pic_s"];}?>"  border="0"></a></div>
      <?php } ?>
     <?php echo stripslashes($C1["ad_des"]); ?></td>
  </tr>
  <?php $b++; }} ?>
