...
<?php echo stripslashes($C1["ad_des"]); ?></td>
    ...
    <td valign="top" align="<?php echo $C1["ad_align"]; ?>"> 
      <?php if($C1["ad_pic_s"] != ""){ ?>
 <div><a href="<?php if($C1["ad_pic_b"] != ""){ echo "../images/article/news".$nid."/".$C1["ad_pic_b"]; }else{ echo "../../../images/o.gif"; } ?>" accesskey=<?php echo $db->genaccesskey();?>><img src="<?php if($C1["ad_pic_s"] != ""){ echo "../images/article/news".$nid."/".$C1["ad_pic_s"]; }else{ echo "../../../images/o.gif"; } ?>" border="0" alt="<?php if($C1["ad_des"] != ''){echo  preg_replace ($search, $replace,stripslashes($C1["ad_des"]));}else{ echo $C1["ad_pic_s"];}?>"></a></div>
      <?php } ?>
<?php echo stripslashes($C1["ad_des"]); ?></td>
    <?php
...
<?php echo stripslashes($C1["ad_des"]); ?></td>
  ...
  <table width="90%" border="0" align="center" cellpadding="8" cellspacing="0" class="text_normal">
  <?php
  ...
  <tr align="<?php echo $C1["ad_align"]; ?>" > 
    <td  valign="top"><?php echo  stripslashes($C1["ad_des"]); ?>
      </td>
  </tr>
</table>
