...
if($_POST[Flag] == 'Add') {
	...
	if($_POST[typeFiles] == 'web') { $link = $_POST[event_link];
		...
		$Current_Dir = "../../ewt/".$EWT_FOLDER_USER."/calendar";
...
//echo $_SESSION["EWT_MID"];
	$sql_insert = "
		...
		VALUES(
			...
			'".$date_start."', '".$time_start."', '".$date_end."', '".$time_end."',' ".$_SESSION["EWT_MID"]."', 
	...
	if($_POST[invite_id]) { // ส่ง E-mail ให้เป็นรายคน
		...
		for($i=0; $i<count($invite_id_explode); $i++) {
			...
			$sql1 = "SELECT * FROM gen_user WHERE gen_user_id = '".$_SESSION["EWT_MID"]."' ";
	...
	if($_POST[repeat_chk]) {
		...
		if($_POST[repeat_chk] == '1'){
			for($i=1; $i<$repeat_time; $i++){
				...
				VALUES('".$_POST[event_title]."','".$_POST[cat_id]."','".$_POST[col_id]."','".$_POST[event_detail]."','".$all_day."','".$date_start_week."','".$time_start."','".$date_end_week."','".$time_end."','".$_SESSION["EWT_MID"]."','','','".$date_sh_start_week."','".$date_sh_end_week."','".$main_event_id_repeat."','".$event_private."','".$_POST[event_link]."','".$add_register."', '".$_POST[num_register]."', '".$_POST[type_register]."')";
				$db->query($sql_insert);
				$sql_event_id = "select max(event_id) as max_event_id from cal_event";
				$sql_event_id = $db->query($sql_event_id);
				$event_id_max= $db->db_fetch_array($sql_event_id);	
			...
			for($i=1;$i<$repeat_time;$i++){
				...
				//$db->query($sql_repeat);
				$sql_insert = "INSERT INTO cal_event (event_title,cat_id,color_id,event_detail,event_all_day,event_date_start,event_time_start,event_date_end,event_time_end,event_user_id,event_repeat,event_repeat_time,event_show_start,event_show_end,main_event_id_repeat,event_private,event_link,event_registor,event_registor_num,event_registor_type) 
				VALUES('".$_POST[event_title]."','".$_POST[cat_id]."','".$_POST[col_id]."','".$_POST[event_detail]."','".$all_day."','".$show_date_start1."','".$time_start."','".$show_date_end1."','".$time_end."','".$_SESSION["EWT_MID"]."','','','".$show_date_sh_start1."','".$show_date_sh_end1."','".$main_event_id_repeat."','".$event_private."','".$_POST[event_link]."','".$add_register."', '".$_POST[num_register]."', '".$_POST[type_register]."')";
				$db->query($sql_insert);
				$sql_event_id = "select max(event_id) as max_event_id from cal_event";
				$sql_event_id = $db->query($sql_event_id);
				$event_id_max= $db->db_fetch_array($sql_event_id);	
	...
	print "window.location.href = \"calendar_all.php?filename=".$_POST[filename]."\";";
...
if($_POST[Flag] == 'Edit') {
	...
	,event_user_id = '".$_SESSION["EWT_MID"]."' , event_repeat = '".$_POST[repeat_chk]."' , event_repeat_time = '".$_POST[repeat_time]."',event_show_start = '".$date_sh_start."', event_show_end = '".$date_sh_end."' , event_private = '".$event_private."'
	...
	if($_POST[repeat_chk]){
		...
		if($_POST[repeat_chk] == '1'){
			for($i=1;$i<$repeat_time;$i++){
				...
				$sql_insert = "INSERT INTO cal_event (event_title,cat_id,color_id,event_detail,event_all_day,event_date_start,event_time_start,event_date_end,event_time_end,event_user_id,event_repeat,event_repeat_time,event_show_start,event_show_end,main_event_id_repeat,event_private,event_link,event_registor,event_registor_num,event_registor_type) 
				VALUES('".$_POST[event_title]."','".$_POST[cat_id]."','".$_POST[col_id]."','".$_POST[event_detail]."','".$all_day."','".$date_start_week."','".$time_start."','".$date_end_week."','".$time_end."','".$_SESSION["EWT_MID"]."','','','".$date_sh_start_week."','".$date_sh_end_week."','".$_POST[event_id]."','".$event_private."','".$_POST[event_link]."','".$add_register."', '".$_POST[num_register]."', '".$_POST[type_register]."')";
				$db->query($sql_insert);
			...
			for($i=1;$i<$repeat_time;$i++){
				...
				//$db->query($sql_repeat);
				$sql_insert = "INSERT INTO cal_event (event_title,cat_id,color_id,event_detail,event_all_day,event_date_start,event_time_start,event_date_end,event_time_end,event_user_id,event_repeat,event_repeat_time,event_show_start,event_show_end,main_event_id_repeat,event_private,event_link,event_registor,event_registor_num,event_registor_type) 
				VALUES('".$_POST[event_title]."','".$_POST[cat_id]."','".$_POST[col_id]."','".$_POST[event_detail]."','".$all_day."','".$show_date_start1."','".$time_start."','".$show_date_end1."','".$time_end."','".$_SESSION["EWT_MID"]."','','','".$show_date_sh_start1."','".$show_date_sh_end1."','".$_POST[event_id]."','".$event_private."','".$_POST[event_link]."','".$add_register."', '".$_POST[num_register]."', '".$_POST[type_register]."')";
				$db->query($sql_insert);
...
if($_GET[Flag] == "Del"){
	...
	print "window.location.href = \"calendar_allphp\";";
	print "</script>";
}
$db->db_close(); ?>
