...
<table id="ewt_main_structure" width="800" border="0" cellpadding="0" cellspacing="0"  align="center" >
        <tr  valign="top" > 
		  ...
		  <DIV ><span style="FONT-SIZE: 36pt"><strong>HEADER</strong></span></DIV>
				  </td>
        </tr>
        <tr valign="top" > 
    ...
    <td id="ewt_main_structure_body"  width="400"  style="  height:160px;">#w3c_spliter#
