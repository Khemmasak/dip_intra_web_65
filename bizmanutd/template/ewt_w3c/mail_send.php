...
if($send){
$to  =$email_to;
$subject = "คุณ  ".$name_from."   ได้ส่งเว็บที่น่าสนใจให้คุณ  ".$name_to;
$message = '
<html><head><title>เพื่อนอยากให้คุณดู</title></head><body>
<table>
 <tr> <th>URL  :<a href="'.$page.'" target="_blank" accesskey=a>'.$page.'</a></th></tr>
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#B07331" class="normal_font">
	 <tr bgcolor="#FFDA45">
	  <td colspan="2" valign="TOP" style="background:url(../mainpic/toolbars.gif)"><img src="../mainpic/mail2.gif"  alt=""><font size="2"><strong> ส่งต่อให้เพื่อน</strong></font>  </td>   
	</tr>
</table><br>
