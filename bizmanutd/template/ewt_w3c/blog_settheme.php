      ...
      <tr>
        <td height="300" align="center" valign="top" bgcolor="#E1D4C0"><table width="600" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td style="background:url(../../blog/images/bottom_bg.jpg)">&nbsp;<a href="http://validator.w3.org/check?uri=referer"><img src="images/w3c_gold.bmp" alt="Valid HTML 4.01 Transitional" height="31" width="88" border="0"></a><?php  include("ewt_span.php");?></td>
