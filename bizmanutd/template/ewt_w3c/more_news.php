...
$path = "../";
				...
				if($_GET[offset]!=''){
				$wh .="&offset=".$_GET[offset];
				}
$file_template =$Website.$folder .'/main_auto_morenews.php?cid='.$_GET["cid"].'&filename='.$_GET["filename"].'&SSMID='.$_SESSION["EWT_MID"].'&SSMAIL='.$_SESSION["EWT_MAIL"].'&SSorg='.$_SESSION["EWT_ORG"].$forg.$wh;
