...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
	...
	$cond=" WHERE 1=1 ";
	if($_GET['txtblog']){
		$cond.=" AND (`blog_list`.`blog_title` LIKE '%".$_GET['txtblog']."%' or blog_detail.blog_detail_detail LIKE '%".$_GET['txtblog']."%')";
	}
	
	//$sql1="SELECT * FROM `blog_list` $cond ";
	$sql1="select blog_list.blog_id,blog_title,blog_picture,blog_lastdate from blog_list inner join blog_detail on blog_list.blog_id=blog_detail.blog_id $cond group by blog_list.blog_id";
	...
	$sql_profile="SELECT blog_list.blog_id,blog_title,blog_picture,blog_lastdate FROM `blog_list`  inner join blog_detail on blog_list.blog_id=blog_detail.blog_id $cond ORDER BY  `blog_list`.`blog_lastdate` DESC LIMIT $start,$limit";
          ...
          <tr>
            <td height="25" bgcolor="#DBDBF2" class="font_basic"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  ?>
                ...
                <td width="54%" align="right"><a href="?curPage=<?php echo $p1.$search; ?>" accesskey=<?php echo $db->genaccesskey();?>><img src="../../blog/images/arrow_first.gif" width="10" height="12" border="0" alt="first"></a> 
				<a href="?curPage=<?php echo $p2.$search; ?>" accesskey=<?php echo $db->genaccesskey();?>><img src="../../blog/images/arrow_prev.gif" width="7" height="12" border="0"  alt="prev"></a> 
				<a href="?curPage=<?php echo $p3.$search; ?>" accesskey=<?php echo $db->genaccesskey();?>><img src="../../blog/images/arrow_next.gif" width="7" height="12" border="0"  alt="next"></a> 
				<a href="?curPage=<?php echo $p4.$search; ?>" accesskey=<?php echo $db->genaccesskey();?>><img src="../../blog/images/arrow_last.gif" width="10" height="12" border="0" alt="last"></a> &nbsp;</td>
              </tr>
            </table></td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="25" bgcolor="#DBDBF2" class="font_basic"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
				...
				<a href="?curPage=<?php echo $p1.$search; ?>" accesskey=<?php echo $db->genaccesskey();?>><img src="../../blog/images/arrow_first.gif" width="10" height="12" border="0"  alt="first"></a>
				 <a href="?curPage=<?php echo $p2.$search; ?>" accesskey=<?php echo $db->genaccesskey();?>><img src="../../blog/images/arrow_prev.gif" width="7" height="12" border="0" alt="prev"></a> 
				 <a href="?curPage=<?php echo $p3.$search; ?>" accesskey=<?php echo $db->genaccesskey();?>><img src="../../blog/images/arrow_next.gif" width="7" height="12" border="0" alt="next"></a> 
				 <a href="?curPage=<?php echo $p4.$search; ?>" accesskey=<?php echo $db->genaccesskey();?>><img src="../../blog/images/arrow_last.gif" width="10" height="12" border="0"  alt="last"></a> 
				&nbsp;</td>
              </tr>
            </table></td>
          </tr>
...
?>
      <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CC99CC" class="font_basic">
		...
		if($count_profile>0){
		?>
              <a href="<?php echo $blog_url; ?>?blog_id=<?php echo  $row_profile[blog_id]; ?>" target="_blank" accesskey=<?php echo $db->genaccesskey();?>><b>จัดการ My Blog</b></a>
              <?
		}else{
		?>
              <a href="<?php echo $blog_url; ?>blog_install.php" target="_blank" accesskey=<?php echo $db->genaccesskey();?>><b>ติดตั้ง My Blog</b></a>
              <?
		}
		?></td>
          </tr>
