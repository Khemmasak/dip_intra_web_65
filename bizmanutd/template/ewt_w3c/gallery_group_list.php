...
?>
	<!-----add code for gallery-->
		...
		if($i%$cal == 0 ) {?> <tr ><?php }?>
		 <td width="<?php echo $w ;?>%" align="center" valign="top" style="cursor:hand"  onClick="location.href='gallery_view_catelogy.php?category_id=<?php echo $rs_img[category_id];?>'">
		 <?php
			//chk img or swf
		...
		?>
		 <a href="gallery_view_catelogy.php?category_id=<?php echo $rs_img[category_id];?>&filename=<?php echo $_GET[filename];?>" accesskey=<?php echo $db->genaccesskey();?>><img src="<?=$img_p;?>" hspace="0" height="100" width="100" vspace="0"   border="1" alt="<?php echo $rs_img[category_name];?>" align="top"  style="border:1px #C3C3C3 double ; padding:5px;"></a>
			<?php } ?>																		
