...
$file_template =$Website.$folder .'/main_auto_calendar_all.php?ssorg='.$_SESSION["EWT_ORG"].'&sessmid='.$_SESSION["EWT_MID"].'&SSMID='.$_SESSION["EWT_MID"].'&SSMAIL='.$_SESSION["EWT_MAIL"].'&SSorg='.$_SESSION["EWT_ORG"].'&cur_year='.$_GET["cur_year"].'&cur_month='.$_GET["cur_month"].'&filename='.$_GET["filename"];
