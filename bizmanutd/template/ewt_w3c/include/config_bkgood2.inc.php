...
$Website = "http://192.168.0.250/ewtadmin/ewt/ictweb/";  // ictweb
$CS_WWW = "http://192.168.0.250"; // อันเก่าคือ "www.mwa.co.th";
*/ 
$folder = 'ewt_w3c'; //สามารถเปลี่ยนชื่อ folder ที่เก็บดปรแกรมได้
$UserPath =  "D:\\wamp\\www\\ewtadmin\\ewt\\".$EWT_FOLDER_USER."\\"; // 
$Website = "http://203.154.183.18/ewtadmin/ewt/".$EWT_FOLDER_USER."/"; // "http://localhost/ewtadmin/ewt/parliament_parcy/";  
$CS_WWW = "http://203.154.183.18/ewtadmin/ewt/".$EWT_FOLDER_USER."/"; // อันเก่าคือ "http://localhost/ewtadmin/ewt/parliament_parcy/"
$phpMainPage=$Website."main.php?filename=";
$phpMainBody=$Website."main_body.php?filename=";
$phpMainTemplate=$Website.$folder."/ewt_preview_template.php?filename=";

$dir1="checked/";  // w3c\\checked\\
$dir2="template/";
$dir3="mainbkup/";
$SPLITTER = '<input name="w3c_spliter" type="hidden" value="##" alt="" >';
