...
<?php echo show_block($TB[0]); ?>
        ...
        <tr valign="top" > 
		  ...
		  ?>
<?php echo show_block($LB[0]); ?>
		<?php } ?>
		  </td>
          
    <td id="ewt_main_structure_body" <?php if($RR["d_site_content"] != ''){ ?> width="<?php echo $RR["d_site_content"]; ?>" <?php } ?> style=" <?php if($RR["d_body_bg_p"] != ''){?>background:url(<?php echo $RR["d_body_bg_p"]; ?>);<?php } ?><?php if($RR["d_body_bg_c"] != ''){?> background-color:<?php echo $RR["d_body_bg_c"]; ?>;<?php }?> height:160px;">
	<?php
