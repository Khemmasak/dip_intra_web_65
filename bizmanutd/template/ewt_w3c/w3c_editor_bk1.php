...
echo $labelShow; ?>
 ...
 <tr><td >
 <img src="images/photo_portrait.gif" alt="กรอกคำบรรยายภาพ" border="0"  align="absmiddle" onClick="if(confirm('ล้างข้อมูล HTML ของหน้าเว็บ <?php echo $filecheck; ?> ก่อนหรือไม่?')) {
