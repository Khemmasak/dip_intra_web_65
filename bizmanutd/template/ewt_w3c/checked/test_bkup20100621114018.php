...
<body>
<div>
<form name="PollFormjfX5498" onsubmit="return show_data_pollviewjfX5498();" action="ewt_vote.php?lang_sh=" method="post" target=""></form>
...
<tr>
<td width="50%" align="center"><label><input type="hidden" name="flag" alt=""> <input type="image" name="imageField2" src="../mainpic/vote/vote.gif" onclick="document.PollFormjfX5498.flag.value='0'; return chkPolljfX5();" alt=""></label></td>
<td width="50%" align="center"><label><input type="image" name="imageField2" src="../mainpic/vote/result.gif" onclick="document.PollFormjfX5498.flag.value='1';" alt=""></label> <input name="cad_id" type="hidden" id="cad_id" value="1" alt=""></td>
</tr>
</table>
</td>
</tr>
</table>
<iframe name="iframe_showpolljfX5498" src="" frameborder="0" width="1" height="1" scrolling="no"></iframe> <script language="javascript" type="text/javascript">
    function show_data_pollviewjfX5498(){
    var flag = document.PollFormjfX5498.flag.value;
    
      if(flag == '0'){
      
        document.PollFormjfX5498.target = "iframe_showpolljfX5498";
        return true;
      }else if(flag == '1'){
        PollFormjfX5498.target = "PollVote";
    ...
    function chkPolljfX5(){
      var x = 0;
        for (var i=0; i<document.PollFormjfX5498.vote.length; i++) {
          if (document.PollFormjfX5498.vote[i].checked) {
            var x = 1;
           }
         }
        if(x==0){
