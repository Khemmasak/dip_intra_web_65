...
?>
  <tr>
    <td width="40%" valign="top"><a href="faq.php"><strong>หน้าหลัก FAQ</strong> </a>|<a href="faq_add.php?f_id=<?php echo $f_id?>&f_sub_id=<?php echo $f_sub_id?>"><strong>เพิ่ม FAQ</strong>  </a></td>
    <td width="60%" height="25" align="right" valign="top"><form name="search_faq" method="post" action="">
  ...
  <tr>
    <td height="265" colspan="2" valign="top"><DIV align="center"  ><strong><font size="2" face="Tahoma"><?php
...
?>
   FAQ ในหมวด "<?php echo $QQ[f_cate]; ?>"</font></strong> <br>
                <strong><font size="2" face="Tahoma">หมวดย่อย "<?php echo $QQ[f_subcate]; ?>"</font></strong>  
                <br>
                <br>
...
echo   "<a href='$PHP_SELF?offset=$prevoffset&f_id=$f_id&f_sub_id=$f_sub_id'>
<font face=\"MS Sans Serif\" size=\"1\" color=\"red\"><< ก่อนหน้า</font></a>\n\n";
    ...
    for ($i=1;$i<=$pages;$i++) { 
        ...
        if (($offset/$limit) == ($i-1)) { 
            ...
            $newoffset=$limit * ($i-1); 
                  echo  "<a href='$PHP_SELF?offset=$newoffset&f_id=$f_id&f_sub_id=$f_sub_id' ". 
