<?php
	...
	if($limit){ $limit = checkNumeric($limit); }
	if($_GET["limit"]){ $_GET["limit"] = checkNumeric($_GET["limit"]); }
	if($_POST["limit"]){ $_POST["limit"] = checkNumeric($_POST["limit"]); }
	...
	if(!$orderby){ $orderby = "event_time_start"; } else { $orderby = $orderby; }
	...
	where 
	(cal_event.event_date_start <= '".$display_date."' and  cal_event.event_date_end >= '".$display_date."') and 
	...
	if($_REQUEST['txtsearch']!='') {
		$sql_event.='AND (cal_event.event_title LIKE \'%'.$_REQUEST['txtsearch'].'%\' OR cal_event.event_detail LIKE \'%'.$_REQUEST['txtsearch'].'%\') ';
	}
	$sql_event.="group by cal_event.event_id  
	order by cal_event.event_time_start desc, cal_event.event_time_end desc";
	...
	if($deasc == 'DESC') { $pic_order = '> '; } else { $pic_order = '< '; }
	$pict = "";
	...
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td style="margin-left:0px; margin-right:5px;" nowrap="nowrap"><span class="text_head"><?php echo  $head_test ;?></span>
					<hr width="100%" size="1"  align="left"  color="#D8D2BD">
						<span class="text_normal">
							<?php if($_SESSION["EWT_MID"] && $_SESSION["EWT_ORG"] != 0) { ?><a href="javascript:void(0);" class="text_eng" onClick="window.open('calendar_addevent.php?sh=<?php echo $sh;?>','','width=800 , height=580, location=0');"><img src="<?php echo $path_cal;?>mainpic/calendar/add_calendar.jpg" style="cursor:hand" align="absmiddle" border="0" width="16" height="16">&nbsp;</a><a href="javascript:void(0);" class="text_eng" onClick="window.open('calendar_addevent.php?sh=<?php echo $sh;?>&BID=<?php echo $BID;?>','','width=800 , height=580, location=0');"><?php echo $text_Gencalendar_textaddactivity;?></a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<?php } ?>
							<a href="main_calendar.php?display_date=<?php echo $display_date;?>&sh=<?php echo $sh;?>&BID=<?php echo $BID;?>" class="text_eng"><img src="<?php echo $path_cal;?>mainpic/calendar/icon_calendar.jpg" style="cursor:hand" align="absmiddle" border="0" width="16" height="16">&nbsp;</a><a href="main_calendar.php?display_date=<?php echo $display_date;?>&sh=<?php echo $sh;?>&BID=<?php echo $BID;?>" class="text_eng"><?php echo $text_Gencalendar_textday;?></a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
							<a href="calendar_week.php?display_date=<?php echo $display_date;?>&sh=<?php echo $sh;?>&BID=<?php echo $BID;?>" class="text_eng"><img src="<?php echo $path_cal;?>mainpic/calendar/icon_calendar.jpg" style="cursor:hand" align="absmiddle" border="0" width="16" height="16">&nbsp;</a><a href="calendar_week.php?display_date=<?php echo $display_date;?>&sh=<?php echo $sh;?>&BID=<?php echo $BID;?>" class="text_eng"><?php echo $text_Gencalendar_textweek;?></a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
							<a href="calendar_month.php?display_date=<?php echo $display_date;?>&sh=<?php echo $sh;?>&BID=<?php echo $BID;?>" class="text_eng"><img src="<?php echo $path_cal;?>mainpic/calendar/icon_calendar.jpg" style="cursor:hand" align="absmiddle" border="0" width="16" height="16">&nbsp;</a><a href="calendar_month.php?display_date=<?php echo $display_date;?>&sh=<?php echo $sh;?>&BID=<?php echo $BID;?>" class="text_eng"><?php echo $text_Gencalendar_textmonth;?></a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
							<a href="calendar_year.php?display_date=<?php echo $display_date;?>&sh=<?php echo $sh;?>&BID=<?php echo $BID;?>" class="text_eng"><img src="<?php echo $path_cal;?>mainpic/calendar/icon_calendar.jpg" style="cursor:hand" align="absmiddle" border="0" width="16" height="16">&nbsp;</a><a href="calendar_year.php?display_date=<?php echo $display_date;?>&sh=<?php echo $sh;?>&BID=<?php echo $BID;?>" class="text_eng"><?php echo $text_Gencalendar_textyear;?></a>
						</span><br/>
                        <p class="text_normal" style="text-align:right;"><input type="text" name="txtsearch" id="txtsearch" value="<?php echo $_REQUEST['txtsearch']; ?>" />&nbsp;<input type="button" onClick="window.location.href='main_calendar.php?display_date=<?php echo $display_date;?>&sh=<?php echo $sh;?>&BID=<?php echo $BID;?>&txtsearch='+document.getElementById('txtsearch').value;" value="ค้นหา" /></p>
						<hr width="100%" size="1"  align="left"  color="#D8D2BD">
					</td></tr>
			</table>
		</td>
			...
			<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CECECE">
				<tr>
					<td bgcolor="#E7E7E7">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td align="right"><a href="main_calendar.php?display_date=<?php echo $prev_date;?>&sh=<?php echo $sh;?>"><img src="<?php echo $path_cal;?>mainpic/calendar/navi_left.gif" style="cursor:hand" align="absmiddle" border="0"></a></td>
								<td align="center" width="500">
									<span class="text_head"><?php echo  $head_test ;?>&nbsp;<?php//php echo $text_Gencalendar_textofday;?>&nbsp;<?php echo date('j', mktime(0, 0, 0, $cur_month, $cur_date, $cur_year))?>&nbsp;<?php 
										switch($cur_month) {
										...
										?>&nbsp;<?php echo $text_Gencalendar_textpsyear;?>&nbsp;<?php echo (date('Y', mktime(0, 0, 0, $cur_month, $cur_date, $cur_year))+$y_y);?>									</span>								</td>
								<td align="left"><a href="main_calendar.php?display_date=<?php echo $next_date;?>&sh=<?php echo $sh;?>"><img src="<?php echo $path_cal;?>mainpic/calendar/navi_right.gif" style="cursor:hand" align="absmiddle" border="0"></a></td>
							</tr>
						</table>
					</td>
				</tr>
				<?php
					...
					if($num_rows_2>0) {
						...
						while($row_event = $db->db_fetch_array($query)) {
							if($row_event[event_user_id] != $_SESSION["EWT_MID"]) { $chk_num_rows = false; }
							...
							if($chk_num_rows || true) {
								...
								if(($row_event['event_date_start'] != $row_event['event_date_end']) && ($row_event['event_date_end'] != '0000-00-00') && ($row_event['event_all_day'] != '1')) {
									...
									if(sprintf('%02d', $end_time[0]).':'.sprintf('%02d', $end_time[1]).$end_ampm != '00:00'.$start_ampm){
				...
				<tr>
					<td bgcolor="#FFFFFF">
						...
						<?php if($row_event[event_link]) { ?><img src="mainpic/document_view.gif" align="absmiddle" alt="ดู" onClick="window.open('calendar_view_link.php?flag=link&img_name=<?php echo $row_event[event_link]?>&sh=<?php echo $sh;?>','calendar_view_link','width=500 , height=400,scrollbars=1,resizable = 1'); " style="cursor:hand"><?php } ?>
					<?php if($_SESSION["EWT_MID"] == $row_event['event_user_id']) {
						if($row_event['main_event_id_repeat'] == 0) { ?>
                      <a href="calendar_editevent.php?event_id=<?php echo $row_event['event_id'];?>&ref=yes&sh=<?php echo $sh;?>"><img src="<?php echo $path_cal?>mainpic/calendar_edit.gif" alt="Edit Event" width="16" height="16" border="0" align="absmiddle">&nbsp;</a><a href="javascript:void(0);" class="text_eng" onClick="window.open('calendar_editevent.php?event_id=<?php echo $row_event['event_id'];?>&ref=yes&sh=<?php echo $sh;?>','','width=800 , height=580, location=0');"><?php echo $text_general_edit;?></a>&nbsp; <a href="javascript:if(confirm('คุณต้องการจะลบ Event นี้')) {
																					window.location.href = 'calendar_process.php?event_id=<?php echo $row_event['event_id'];?>&Flag=Del&ref=yes&sh=<?php echo $sh;?>';
																					}"><img src="<?php echo $path_cal?>mainpic/calendar_delete.gif" alt="Delete Event" width="16" height="16" border="0" align="absmiddle">&nbsp;</a><a href="javascript:if(confirm('คุณต้องการจะลบ Event นี้')) {
																					window.location.href = 'calendar_process.php?event_id=<?php echo $row_event['event_id'];?>&Flag=Del&ref=yes&sh=<?php echo $sh;?>';
																					}"><?php echo $text_general_del;?></a>
                      <?php
						}
						?>
			...
			<table width="100%" border="0" align="left" cellpadding="3" cellspacing="1">
				<tr>
					<td height="30" scope="col" ><div align="left"> <?php echo $text_general_numpage;?>
						...
						<input name="button" type="button" onClick="document.frm1.submit();" value="<?php echo $text_general_changepage;?>"></div>
					</td>
					<td height="30" scope="col"><div align="right"><?php echo $text_general_page;?>
						...
						/
						<?php echo $page_all?>
						<?php echo $text_general_page;?> &nbsp;</div>
					</td>
				</tr>
			</table>
		</td>
