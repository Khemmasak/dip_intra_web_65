...
<script src="js/jquery/jquery.flydom.js" type="text/javascript"></script>
...
function selectedStaff(id, name) {
	$('#selectedTbl').createAppend(
		'tr', { align:'left', id:'selected'+id}, [
			'td', {  bgcolor:'#FFFFFF', height:'25' }, '&nbsp;&nbsp;&nbsp;<input type="hidden" name="id[]" value="'+id+'" id="id"><input type="hidden" name="name[]" value="'+name+'" id="name"><div align="left" id="divname'+id+'">'+name+'</div>', 
			'td', {  bgcolor:'#FFFFFF', width:'30', align:"center", valign:"middle" }, '<img src="mainpic/b_delete.gif" align="absmiddle" style="cursor:hand;" border="0" onclick="delSelected(\''+id+'\')">'
		]
	);
}
		...
		<tr>
			<th bgcolor="#F9F9F9" scope="col" valign="top"><br>
				<table width="90%" height="30" border="0" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
					<tr><th height="30" bgcolor="#F4F4FF" align="left">&nbsp;<img src="mainpic/icon_more.gif" width="12" height="7" align="absmiddle"> <strong>รายชื่อผู้ที่เกี่ยวข้อง</strong></th></tr>
					<tr>
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
												...
												<th align="center" valign="top" bgcolor="#FFFFFF" scope="col">
													<table width="98%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" align="center">
														<tr>
															...
															<td height="25" bgcolor="#F4F4FF"><div align="center"><strong>ชื่อ-นามสกุล</strong></div></td>
														</tr>
														<?php
															$page = $_POST[page];
															if(!$limit) $limit = 10;
														...
														?><?php echo $result[title_thai]." ".$result[name_thai]." ".$result[surname_thai]?>&nbsp;(<?php echo $text_org?>)</div></td></tr>
														<?php 
															}
														?>
													<tr>
													...
													?>
													<tr><td height="25" colspan="2" bgcolor="#FFFFFF"><div align="center"><strong style="color:#FF0000">ไม่พบข้อมูล</strong></div></td></tr>
													<?php }?>
												</table>
											</th>
											<th width="250" align="center" valign="top" bgcolor="#FFFFFF" scope="col">
												<table width="98%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" align="center" id="selectedTbl">
													<tr>
														<td height="25" bgcolor="#F4F4FF" align="center"><strong>รายชื่อที่ถูกเลือก</strong></td>
													...
													<tr id="selected<?php echo $id[$kk]; ?>">
														<td height="25" bgcolor="#FFFFFF" align="left" valign="middle">&nbsp;&nbsp;&nbsp;<input type="hidden" name="id[]" value="<?php echo $id[$kk];?>" id="id"><input type="hidden" name="name[]" value="<?php echo $name[$kk];?>" name="name"><div align="left" id="divname<?php echo $id[$kk];?>"><?php echo $name[$kk]?></div></td>
													    <td width="30" align="center" bgcolor="#FFFFFF"><img src="mainpic/b_delete.gif" align="absmiddle" style="cursor:hand;" border="0" onClick="delSelected('<?php echo $id[$kk]?>')"></td>
													</tr>
													<?php
														}
													?>
