         ...
         $.fn.galleriffic = function(thumbsContainerSel, settings) { 
                 ...
                 $.extend(this, { 
                                 ...
                                 if (this.interval) { 
                                         ...
                                         if (this.$controlsContainer) { 
                                                 this.$controlsContainer 
                                                         ...
                                                         .attr('title', this.pauseLinkText1) 
                                                         .attr('href', '#pause')
                         ...
                         rebuildThumbs: function() { 
                                 ...
                                 // Rebuild bottom pager แสดงตัวตัดหน้าด้านล่างลูกค้าให้เอาออก
                 ...
                 if (this.controlsContainerSel) { 
                         ...
                         if (this.renderSSControls) { 
                                 if (this.autoStart) { 
                                         this.$controlsContainer 
                                                 .append('<div class="ss-controls"><a href="#pause" class="pause" title="'+this.pauseLinkText1+'">'+this.pauseLinkText+'</a></div>'); 
                                 } else { 
                                         this.$controlsContainer 
                                                 .append('<div class="ss-controls"><a href="#play" class="play" title="'+this.playLinkText1+'">'+this.playLinkText+'</a></div>'); 
                                 } 
                         ...
                         if (this.renderNavControls) { 
                                 this.$controlsContainer 
                                         .append('<div class="nav-controls"><a class="prev" rel="history" title="'+this.prevLinkText1+'">'+this.prevLinkText+'</a><a class="next" rel="history" title="'+this.nextLinkText1+'">'+this.nextLinkText+'</a></div>') 
