...
include("../../NewsLetterMgt/lang_newsletter.php"); ?>
...
?>
<FORM action="../../NewsLetterMgt/temp_function.php" method="post" name="frmSaveContents" <?php if($Flag=="Add"){ ?>onSubmit="return Chk2();"<?php } ?>>
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="B2B4BF" bgcolor="ECEBF0">
    <tr> 
      <td align="right"> <textarea name="Text2" cols="40" rows="5" wrap="VIRTUAL" id="Text2">  <?php
