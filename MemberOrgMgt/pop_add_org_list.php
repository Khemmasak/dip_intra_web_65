				...
				<div class="modal-body">
					<div class="card ">
						<div class="card-body">
							...
							<div class="form-group row">
								<label for="txt_org_list_name_eng" class="col-sm-12 control-label"><b><?php echo $txt_org_list_name_eng; ?> :</b></label>
								<div class="col-md-12 col-sm-12 col-xs-12">
									<input type="text" class="form-control" placeholder="<?php echo $txt_org_list_name_eng; ?>" id="txt_org_list_name_eng" name="txt_org_list_name_eng" />
								</div>
							</div>

							<div class="form-group row">
								<label for="txt_org_list_surname_eng" class="col-sm-12 control-label"><b><?php echo $txt_org_list_surname_eng; ?> :</b></label>
								<div class="col-md-12 col-sm-12 col-xs-12">
									<input type="text" class="form-control" placeholder="<?php echo $txt_org_list_surname_eng; ?>" id="txt_org_list_surname_eng" name="txt_org_list_surname_eng" />
								</div>
							</div>

							<div class="form-group row">
								<label for="txt_org_list_surname_thai" class="col-sm-12 control-label"><b><?php echo $txt_org_list_nickname_thai; ?> :</b></label>
								<div class="col-md-12 col-sm-12 col-xs-12">
									<input type="text" class="form-control" placeholder="<?php echo $txt_org_list_nickname_thai; ?>" id="txt_org_list_nickname_thai" name="txt_org_list_nickname_thai" />
								</div>
							</div>
							...
							<div class="col-md-12 col-sm-12 col-xs-12" >
							<input type="text" class="form-control checkidc idcard" placeholder="<?php echo $txt_org_list_idcard;?>" id="txt_org_list_idcard" name="txt_org_list_idcard"  required="required" />
							...
							<div class="form-group row">
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									<input type="text" class="form-control" placeholder="<?php echo $txt_org_list_afft_name; ?>" id="txt_org_list_afft_name" name="txt_org_list_afft_name" />
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									<input type="text" class="form-control phone" placeholder="<?php echo $txt_org_list_mobile; ?>" id="txt_org_list_mobile" name="txt_org_list_mobile">
									<span class="text-danger">
										<code>
											Ex. 999-999-9999
										</code>
							...
							<div class="form-group row">
								<label for="txt_org_list_tel_in" class="col-sm-12 control-label"><b><?php echo $txt_org_list_tel_in; ?> <span class="text-danger"> :</b></label>
								<div class="col-md-12 col-sm-12 col-xs-12">
									<input type="text" class="form-control phone" placeholder="<?php echo $txt_org_list_tel_in; ?>" id="txt_org_list_tel_in" name="txt_org_list_tel_in">
									<span class="text-danger">
										<code>
											Ex. 999-999-9999
										</code>
							...
							<div class="form-group row">
								<label for="txt_org_list_line_id" class="col-sm-12 control-label"><b><?php echo $txt_org_list_line_id; ?> <span class="text-danger"><?php /*<code>*</code>*/ ?> :</b></label>
								<div class="col-md-12 col-sm-12 col-xs-12">
									<input type="text" class="form-control phone" placeholder="<?php echo $txt_org_list_line_id; ?>" id="txt_org_list_line_id" name="txt_org_list_line_id">
								</div>
							</div>

							<div class="form-group row">
								<label for="txt_org_list_address" class="col-sm-12 control-label"><b><?php echo $txt_org_list_address; ?> <span class="text-danger"><?php /*<code>*</code>*/ ?> :</b></label>
								<div class="col-md-12 col-sm-12 col-xs-12">
									<textarea class="col-sm-12 control-label" name="txt_org_list_address" id="txt_org_list_address" cols="30" rows="5"></textarea>
								</div>
							</div>
							...
							<div class="form-group rowuserpass_section">
							...
							<div class="form-group rowuserexpire_section" hidden>
								<?php /*
