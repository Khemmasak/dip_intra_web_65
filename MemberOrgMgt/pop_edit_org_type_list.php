...
$u_id = $_GET['u_id'];
$sql = "SELECT * FROM emp_type WHERE emp_type_id = '".$u_id."'";
$res = $db->query($sql);
...
<form id="form_main" name="form_main" method="POST" action="<?php echo getLocation('func_edit_org_type_list') ?>" enctype="multipart/form-data">
