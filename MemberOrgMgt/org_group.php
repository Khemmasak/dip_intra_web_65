										...
										<div class="panel panel-default " id="<?php echo $a_data['org_id']; ?>">
											...
											<div id="collapseOne<?php echo $i; ?>" class="panel-collapse collapse">
												<div class="panel-body">
													...
													<div><? php //=org::chkStatusOrg($a_data['org_status']);
															?></div><br>
													<div class="text-left">
												...
												<div class="panel-footer ewt-bg-white text-right">
													<div class="ewt-icon-wrap ewt-icon-effect-1 ewt-icon-effect-1b">
														...
														<!--<a onClick="JQSet_Lang_Calendar('<? //=$a_data['event_id'];
																								?>','')" data-toggle="tooltip" data-placement="right" title="<? //=$txt_ewt_create_multilang;
																																													?>">
