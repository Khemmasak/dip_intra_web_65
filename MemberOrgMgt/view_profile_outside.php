...
<form  name="frm" method="post" action="">
    ...
    <tr>
      <td align="center"><table width="50%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td align="center" background="../images/border_25.jpg" class="ewtfunction style1">ข้อมูลสมาชิกจากภายนอก </td>
  ...
  LEFT OUTER JOIN `org_name` ON (`gen_user`.`org_id` = `org_name`.`org_id`) Where  gen_user.gen_user_id='$emp_id'  ";
			...
			if($rst_user[path_image]){
			   $path_image=$rst_user[path_image];
			...
			//ลำดับการสมัคร
			$sql_regis = "select * from history where gen_user_id ='$emp_id' and status ='add'";
			$query_regis = $db->query($sql_regis);
			$rec_regis = $db->db_fetch_array($query_regis);
		?> 
			
          <tr>
            <td height="20" align="right" bgcolor="#FFFFFF" class="Table-Text-Head">ลำดับการสมัคร : </td>
            <td colspan="2" bgcolor="#FFFFFF"><?php echo $rec_regis[his_id];?></td>
          </tr>
               <tr>
            <td height="20" align="right" bgcolor="#FFFFFF" class="Table-Text-Head">&nbsp;&nbsp;รหัสบัตรประชาชน : </td>
            <td width="323" bgcolor="#FFFFFF"><?php echo $rst_user[emp_id];?></td>
          </tr><tr>
       
            <td width="209" height="20" align="right" bgcolor="#FFFFFF" class="table_text_header">&nbsp;&nbsp;ชื่อ-นามสกุล :</td>
            <td bgcolor="#FFFFFF">&nbsp;<?php echo $rec[title_thai]." ".$rst_user[name_thai]."&nbsp;&nbsp;".$rst_user[surname_thai]; ?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td bgcolor="#FFFFFF">&nbsp;<?php echo $rst_user[email_person];?></td>
          </tr>


          <tr>
            <td height="20" align="right" bgcolor="#FFFFFF" class="Table-Text-Head">&nbsp;&nbsp;เบอร์ต่อสะดวก :</td>
            <td bgcolor="#FFFFFF">&nbsp;<?php echo $rst_user[tel_in];?></td>
          </tr>

          <tr>
            <td height="20" align="right" bgcolor="#FFFFFF" class="Table-Text-Head">&nbsp;&nbsp;สถานที่ทำงาน :</td>
            <td bgcolor="#FFFFFF">&nbsp;<?php echo $rst_user[officeaddress];?></td>
          </tr>
          <tr>
            <td height="20" align="right" bgcolor="#FFFFFF" class="Table-Text-Head">กลุ่มสมาชิก : </td>
            <td bgcolor="#FFFFFF">&nbsp;<?php echo $rst_user[emp_type_name];?></td>
          </tr>
         <tr>
