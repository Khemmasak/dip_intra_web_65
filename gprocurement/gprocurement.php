...
<table class="table table-bordered">
    <thead>
      <tr>
        ...
        <th style="text-align:center;width:75%;">หัวข้อ</th>
		<th style="text-align:center;width:10%;">วันที่</th>
        <th style="text-align:center;width:10%;">ขั้นตอนการทำงาน</th>
...
$s_feed  = $db->query("SELECT * FROM egp_list  ORDER BY egp_list_pubdate DESC
LIMIT {$start} , {$perpage}");
$a_row = $db->db_num_rows($s_feed);   

$s_feed2 = $db->query("SELECT * FROM egp_list  ORDER BY egp_list_id ASC");
...
<td style="text-align:left;"><?=$a_feed['egp_list_pubdate'];?></td>
<td>
<a  onclick="boxPopup('http://<?php echo $_SERVER['SERVER_NAME']; ?>/ewtadmin86_mots_province_utf8_dev/gprocurement/pop_system.php?id=<?=$a_feed['egp_list_id']; ?>');" data-toggle="tooltip" data-placement="right" title="เพิ่มวิธีการจัดหา" >
<button type="button" class="btn btn-info" >
<span class="glyphicon glyphicon-search"></span>&nbsp;&nbsp;ดูขั้นตอนการทำงาน
</button>
</a>
</td>
</tr>
