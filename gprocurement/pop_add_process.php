...
$s_egp_process = $db->query("SELECT * FROM egp_process WHERE egp_process_id = '{$_GET[id]}' ");	 
...
<div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">วิธีการจัดหา</h4>
        </div>
<div class="modal-body">       
<div class="form-group row">
<div class="col-md-12 col-sm-12 col-xs-12">
<label for="topic"><?="รหัส";?><span class="text-danger">*</span> : </label>        
<input name="topic1" type="text" id="topic1"  class="form-control" required value="<?=$a_egp_process['egp_process_code']; ?>" />	
</div>
</div>
<div class="form-group row">
<div class="col-md-12 col-sm-12 col-xs-12">
<label for="topic"><?="วิธีการจัดหา";?><span class="text-danger">*</span> : </label>        
<input name="topic2" type="text" id="topic2"  class="form-control" required value="<?=$a_egp_process['egp_process_name']; ?>" />	
</div>
</div>
</div>
