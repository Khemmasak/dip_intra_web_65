...
<h4>รหัสหน่วยจัดซื้อย่อย</h4>
</div>
<div class="col-md-6 col-sm-6 col-xs-12"  style="text-align:right;" >
<a  onclick="boxPopup('http://<?php echo $_SERVER['SERVER_NAME']; ?>/ewtadmin86_mots_province_utf8_dev/gprocurement/pop_add_deptsub.php?proc=AddProc');" data-toggle="tooltip" data-placement="right" title="เพิ่มวีดีโอ" >
<button type="button" class="btn btn-success" >
<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;เพิ่มรหัสหน่วยจัดซื้อย่อย
</button>
</a>
</div>
</div>
...
<div class="panel-body">
    ...
    <thead>
      ...
      <th style="text-align:center;width:70%;">หน่วยจัดซื้อย่อย</th>
...
$s_feed  = $db->query("SELECT * FROM egp_dept WHERE egp_dept_sub = '1'  ORDER BY egp_dept_id ASC
LIMIT {$start} , {$perpage}");
$a_row = $db->db_num_rows($s_feed);   

$s_feed2 = $db->query("SELECT * FROM egp_dept WHERE egp_dept_sub = '1'  ORDER BY egp_dept_id ASC");
...
<td style="text-align:center;"><?=$a_feed['egp_dept_code'];?></td>
<td><?=$a_feed['egp_dept_name'];?></td>
<td></td>
</tr>
<?php	  
	$i++;
