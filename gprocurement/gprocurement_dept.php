...
<h4>รหัสหน่วยงานรัฐ</h4>
</div>
<div class="col-md-6 col-sm-6 col-xs-12"  style="text-align:right;" >
<a  onclick="boxPopup('http://<?php echo $_SERVER['SERVER_NAME']; ?>/ewtadmin86_mots_province_utf8_dev/gprocurement/pop_add_dept.php?proc=AddProc');" data-toggle="tooltip" data-placement="right" title="เพิ่มรหัสหน่วยงานรัฐ" >
<button type="button" class="btn btn-success" >
<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;เพิ่มรหัสหน่วยงานรัฐ
</button>
</a>
</div>
</div>
  ...
  <div class="panel-body">
    ...
    <thead>
	  ...
	  <th style="text-align:center;width:5%;">&nbsp;</th>
        ...
        <th style="text-align:center;width:70%;">ชื่อหน่วยงานรัฐ</th>
...
$s_feed  = $db->query("SELECT * FROM egp_dept WHERE egp_dept_sub = '0'  ORDER BY egp_dept_id ASC
LIMIT {$start} , {$perpage}");
$a_row = $db->db_num_rows($s_feed);   

$s_feed2 = $db->query("SELECT * FROM egp_dept WHERE egp_dept_sub = '0'  ORDER BY egp_dept_id ASC");
