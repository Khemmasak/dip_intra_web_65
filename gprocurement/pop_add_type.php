...
$s_egp_type = $db->query("SELECT * FROM egp_type WHERE egp_type_id = '{$_GET[id]}' {$wh} ");	 
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">ประเภทประกาศ</h4>
        </div>
...
<input name="topic1" type="text" id="topic1"  class="form-control" required />	
</div>
</div>
<div class="form-group row">
<div class="col-md-12 col-sm-12 col-xs-12">
<label for="topic2"><?="ประเภทประกาศ";?><span class="text-danger">*</span> : </label>        
<input name="topic2" type="text" id="topic2"  class="form-control" required />	
</div>
</div>
        </div>
