...
<a  onclick="boxPopup('http://<?php echo $_SERVER['SERVER_NAME']; ?>/ewtadmin86_mots_province_utf8_dev/gprocurement/pop_add_type.php?proc=AddType');" data-toggle="tooltip" data-placement="right" title="เพิ่มวีดีโอ" >
<button type="button" class="btn btn-success" >
<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;เพิ่มประเภทประกาศ
</button>
</a>
</div>
</div>
...
<th style="text-align:center;width:70%;">ประเภทประกาศ</th>
...
$s_feed  = $db->query("SELECT * FROM egp_type  ORDER BY egp_type_id ASC
LIMIT {$start} , {$perpage}");
$a_row = $db->db_num_rows($s_feed);   

$s_feed2 = $db->query("SELECT * FROM egp_type  ORDER BY egp_type_id ASC");
...
<td style="text-align:center;"><?=$a_feed['egp_type_code'];?></td>
<td><?=$a_feed['egp_type_name'];?></td>
<td></td>
</tr>
<?php	  
	$i++;
