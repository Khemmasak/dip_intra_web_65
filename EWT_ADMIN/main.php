...
<body class="ewt-bg-body">
	...
	## >> Get site-userinfo
	//$_SESSION["EWT_SUSER"]
	$siteuserinfo_data = $db->query("SELECT url FROM $EWT_DB_USER.user_info WHERE EWT_User = 'dip_intranet'");
	$siteuserinfo_info = $db->db_fetch_array($siteuserinfo_data);

	## >> Get module list
	$module_array = array();

	$module_data = $db->query("SELECT * FROM $EWT_DB_USER.web_module_ewt WHERE m_name NOT IN ('Dashboard') AND m_status = 'Y' ORDER BY m_order ASC, m_name ASC");
	...
	$moduleside_data = $db->query("SELECT * FROM $EWT_DB_USER.web_module_ewt WHERE m_status = 'Y' ORDER BY m_order ASC, m_name ASC");
	...
	<section id="menu-area">
		<nav class="navbar navbar-default main-navbar" role="navigation">
			...
			<div id="navbar-logo">
				...
				<a class="navbar-brand logo animated fadeInLeft" href="<?php echo $EWT_PATH; ?>EWT_ADMIN/main.php" target="_black"> 
			...
			<div id="navbar" class="navbar-collapse collapse">
				<div class="collapse navbar-collapse navbar-right">
					<div class="home-cms ">
						...
						<span class="text-dark"> User : <?php //echo $_SESSION["EWT_SMUSER"]; ?></span></p>-->
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12 m-b-sm">
						<div class="card">
							<div class="card-body">
								<img src="<?php echo $IMG_PATH; ?>images/visitor2.png" class="animated fadeInDown " style="height: 60px;width: 60px;">
								...
								<div id="menu-home" class="m-t-md">
									<ul class="nav">
										...
										foreach ($module_array as $module) {
											...
											if ($show_module == "Y") { ?>
												<li class="whi col-md-3 col-xl-3 col-lg-3 col-sm-3 col-xs-6 animated fadeInDown m-b">
													<a href="<?php echo $module_link; ?>" <?php echo $target_rel; ?>>
														<img src="../EWT_ADMIN/<?php echo $module["m_image"]; ?>" style="width:90px;height:90px" class="icon">
														<span class="text-center"> <?php echo $module["m_name"]; ?></span>
													</a>
												</li>
										<?php
						...
						<div class="card ">
							...
							<div class="card-body" id="tab1">
								...
								<ul class="list-group">
									...
									$s_art_new = $db->query("SELECT n_id,n_topic,n_owner FROM article_list WHERE n_id != '' AND  n_approve = 'Y' AND n_date = '" . $Y . $MD . "' ORDER BY n_id DESC LIMIT 0,5");
					...
					<div class="col-md-12 col-sm-12 col-xs-12 m-b-sm">
						<div class="card ">
							...
							<div class="card-body" id="tab2">
								<ul class="list-group">
									<?php
									$s_art_approve = $db->query("SELECT n_id,n_topic,n_owner FROM article_list WHERE n_id != '' AND n_approve = '' ORDER BY n_id DESC LIMIT 0,5");
	...
	<div id="loader" class="loader_main"></div>
	...
	<style>
		...
		#menu-home .nav li.whi:hover {
			/*
				...
				border-bottom:3px solid rgba(117, 27, 125, 1);
			*/
		}

		#menu-home img.icon {
			background: rgba(117, 27, 125, 0.4);
			padding: 5px;
			border-radius: 100%;
			margin: 20px auto;
			display: block;
			...
			box-shadow: 0 0 0 30px rgba(117, 27, 125, 0.1);
			-webkit-box-shadow: 0 0 0 14px rgba(117, 27, 125, 0.1);
		}

		#menu-home .nav li:hover img.icon {
			background: rgba(117, 27, 125, 0.9);
			box-shadow: 0 0 0 10px rgba(117, 27, 125, 0.8);
			-webkit-box-shadow: 0 0 0 0 rgba(117, 27, 125, 0.8);
		}
		...
		#loader
		{
			...
			background:#FFF url(https://assets.materialup.com/uploads/fa8430a1-4dea-49d9-a4a3-e5c6bf0b2afb/preview.gif) 50% 50% no-repeat;
		}
		...
		#loaderqq {
			...
			z-index:9999;
			background:#fff
			url(https://assets.materialup.com/uploads/fa8430a1-4dea-49d9-a4a3-e5c6bf0b2afb/preview.gif) 50% 50% no-repeat;
		}
	</style>
