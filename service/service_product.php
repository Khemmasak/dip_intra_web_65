<html>
<head>
<title><?php echo iconv('UTF-8','TIS-620','แนวโน้มสินค้า');?></title>
...
// header ('Content-type: text/html; charset=utf-8');
	...
	$client = new nusoap_client("https://www.ditp.go.th/ditp_web61/service/MarketServiceServer.php?wsdl",true); 
	$params = array(
			   'Market' => 'ProductKey'
	);
	$data = $client->call('ResultMarket', $params);
	echo'<h2>WDSL</h2>';
	echo '<pre>https://www.ditp.go.th/ditp_web61/service/MarketServiceServer.php?wsdl</pre>';
	echo'<h2>Call</h2>';
		...
		?>
				...
				?>
					  <tr>
						...
						<td><?php echo $result["cate_title"];?></td>
