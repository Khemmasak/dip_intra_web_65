...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#333333">
  ...
  <tr> 
    <td width="60" height="58"><img src="../theme/main_theme/g_poll_64.gif"> </td>
          <td><span class="ewthead"><?php echo $text_genpoll_module;?> </span>
                  <hr width="100%" size="1"  align="left"  color="#D8D2BD">
            <span class="ewtsubmenu"><a href="main.php" target="iframe_data"><img src="../theme/main_theme/bullet.gif" width="16" height="16" border="0" align="absmiddle"> <?php echo $text_genpoll_modulesub_main;?></a>
			<?php if($db->check_permission("poll","s","")){?>
                       <a href="poll_setting.php" target="iframe_data"><img src="../theme/main_theme/bullet.gif" width="16" height="16" border="0" align="absmiddle"> <?php echo $text_genpoll_modulesub_setting;?></a>
			<?php } ?>
			</span></td>
  </tr>
</table>
