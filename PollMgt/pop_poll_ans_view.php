...
<h4 class="modal-title  color-white"><i class="fas fa-plus-circle"></i> <?php echo 'สถิติการสำรวจความคิดเห็น';?></h4> 
</div>
...
<div class="col-md-12 col-sm-12 col-xs-12" > 
		...
		<i class="far fa-calendar-alt text-dark"></i> <?php echo $r_quest['c_start'];?> to <?php echo $r_quest['c_stop'];?> 
	</div>
</div>
<div class="form-group row " >
<div class="col-md-12 col-sm-12 col-xs-12" >
...
<div class="form-group row">
	...
	<div class="col-md-4">
	<?php echo $a_data_ans['a_name'];?>
	</div>
	<div class="col-md-3">
	<?php echo $a_data_ans['a_counter'];?> 
	</div>
	<div class="col-md-3"> 
	คน
	</div>
...
$('document').ready(function(){
	/*var url = "../ewt/<?php echo $_SESSION['EWT_SUSER'];?>/popup/pop_poll_ans_result.php";
