...
ฉ 2007, InnovaStudio (www.innovastudio.com). All rights reserved.
************************************************************/
...
function InnovaEditor(oName)
  ...
  */
  ...
  this.arrFontName=["Arial","Arial Black","Arial Narrow",
            ...
            "Impact","Lucida Console","Lucida Sans","Lucida Unicode","MS Sans Serif",
...
function tbAction(tb, id, edt, sfx) {
  ...
  switch(btn) {
    ...
    case "btnImage": e.hide();modelessDialogShow(e.scriptPath+"image.php",440,351); break;
