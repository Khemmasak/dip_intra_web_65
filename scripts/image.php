...
function bodyOnLoad()
	...
	if(dialogArguments.oUtil.obj.cmdImageManager!="")btnAsset.style.display="block";
...
function openAsset()
	...
	if(dialogArguments.oUtil.obj.cmdImageManager!="")
		inpImgURL.value=eval(dialogArguments.oUtil.obj.cmdImageManager);
	}
...
function doInsert()
	...
	dialogArguments.oUtil.obj.doCmd("InsertImage",inpImgURL.value);
...
<td valign=top style="padding:5;height:100%">
	...
	<tr>
		...
		<td colspan=4 style="width:100%">
				...
				<tr>
				<td style="width:100%"><input name=inpImgURL type="text" class="inpTxt" id="inpImgURL" style="width:100%" value=""></td>
				<td><input type="button" value="" onclick="window.open('../FileMgt/gallery_insert.php?stype=images&Flag=Link&o_value=window.opener.document.all.inpImgURL.value','','width=700,height=500')" id="btnAsset" name="btnAsset" style="background:url('openAsset.gif');width:23px;height:18px;border:#a5acb2 1px solid;margin-left:1px;"></td>
				</tr>
				</table>	
		</td>
	</tr>
