...
//echo "SELECT UID,db_db FROM user_info WHERE EWT_User = '".$_GET["usr"]."'";
...
$sql = $db->query("SELECT * FROM article_group WHERE c_parent = '$c' ORDER BY c_id ASC ");
  ...
  ?>
    <tr bgcolor="#FFFFFF" > 
      <td > <img src="../images/o.gif" width="20" height="20" border="0" align="absmiddle"><?php GenPic($y); ?><input type="checkbox" name="use[]" value="<?php echo $decho."_".$U[c_id]; ?>">
...
?><tr bgcolor="#FFFFFF" > 
      <td ><input type="checkbox" name="use[]" value="<?php echo $D[0]."_".$R[c_id]; ?>"> <img src="../images/folder_closed.gif" width="16" height="16" border="0" align="absmiddle"><?php echo $R[c_name]; ?>
	  </td>
    </tr>
<?php
child($R["c_id"],0,$D[0]);
