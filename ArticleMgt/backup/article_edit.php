							...
							<div class="col-md-6 col-sm-6 col-xs-12 float-right text-right visible-xs">
								<div class="btn-group ">
									...
									<ul class="dropdown-menu dropdown-menu-right">
										<li><a href="<?php echo article_backto($cid); ?>"><i class="fas fa-undo-alt"></i>&nbsp;<?php echo $txt_ewt_back; ?></a></li>
									</ul>
								</div>
							</div>
						</div>
							...
							<div class="card ">
								...
								<div class="card-body">
									<form action="article_function.php" method="post" enctype="multipart/form-data" name="form1" onSubmit="return chk();">
											...
											<div class="col-md-12 col-sm-12 col-xs-12">
												...
												<div class="form-inline">
													...
													<a href="#browse" onClick="boxPopup('<?php echo linkboxPopup(); ?>pop_article_select.php?cid=<?php echo $cid; ?>');">
														<!--<a href="#browse" title="เลือกกลุ่ม" onClick="win2 = window.open('article_select.php?cid=<?php echo $_GET['cid']; ?>','WebsiteLink','top=100,left=100,width=800,height=600,resizable=1,status=0,scrollbars=1');win2.focus();">-->
										...
										<div class="form-group row">
											<div class="col-md-12 col-sm-12 col-xs-12">
												<label for="description"><b><?php echo "รายละเอียดหัวข้อข่าว"; ?> : </b></label>
										...
										<div class="form-group row">
											<div class="col-md-4 col-sm-4 col-xs-12">
												...
												<!--<input class="form-control" style="width:60%;" name="date_n" type="text" id="date_n" value="<?php //echo date("d")."/".date("m")."/".(date("Y")+543); 
											...
											<div class="col-md-2 col-sm-2 col-xs-12">
												...
												<div class="form-inline">
													<div class="checkbox">
														<label>
															<input name="checkbox" type="checkbox" value="Y" onClick="chktime(this);" <?php if ($R['n_time'] != "") {
																																			echo "checked";
																																		} ?> />
										...
										<div class="form-group row">
										<div class="col-md-6 col-sm-6 col-xs-12">
										<label for="source"><? //="ที่มา/แหล่งข่าว";
															?> : </label>        
										<input name="source" type="text" id="source" value="<? //=$R['source']; 
																							?>" onKeyUp="txt_data(this.value);"  autocomplete="off" class="form-control" />
										</div>
										<div class="col-md-6 col-sm-6 col-xs-12">
										<label for="source_url"><? //="URL ของที่มา/แหล่งข่าว";
																?> : </label>  
										<input name="source_url" type="text" id="source_url" class="form-control" value="<? //=$R['sourceLink']; 
																															?>" />  
										</div>
										</div>-->
										...
										?>
											<div class="form-group row">
												...
												<label for=""><b><?php echo "วิดีโอ";?> : </b></label>
												<div class="form-inline">     
												<a  onclick="self.location.href='article_video.php?nid=<?php echo $R['n_id'];?>';"  title="วิดีโอ" >
												<button type="button" class="btn btn-warning btn-sm" >
										...
										<?php } else { ?>
											<div class="form-group row">
												<div class="col-md-12 col-sm-12 col-xs-12">
													...
													<!--<div class="form-inline">       
													<input name="browsefile" type="radio" value="1" checked="checked" />
													<input class="form-control" name="link" type="text" id="link" value="<?php echo $R['link_html']; ?>" style="width:90%">
													<input type="hidden" name="hdd_file" value="<?php echo $R['link_html']; ?>">
																	<a href="#browse" onClick="win2 = window.open('../FileMgt/website_main.php?stype=link&Flag=Link&o_value=window.opener.document.form1.link.value','WebsiteLink','top=100,left=100,width=800,height=600,resizable=1,status=0');document.form1.browsefile[0].checked=true;win2.focus();">
																	<button type="button" class="btn btn-info  btn-sm">
													...
													<!-- <div class="radio">
														<label><input name="browsefile" type="radio" value="1" checked="checked" />เลือก URL ของเว็บหรือไฟล์ </label>
													</div> -->
													<div class="form-inline">
														<input class="form-control" name="link" type="text" id="link" value="<?php echo $R['link_html']; ?>" style="width:90%" />
														<input type="hidden" name="hdd_file" value="<?php echo $R['link_html']; ?>">
											...
											<div class="form-group row">
												<div class="col-md-12 col-sm-12 col-xs-12">
													<label for=""><?php echo "เลือกไฟล์จากเครื่อง "; ?> : </label>
													<!--<div class="form-inline">  
													<input name="browsefile" type="radio" value="2" />
													<input type="file" name="filebrowse"  onClick="document.form1.browsefile[1].checked=true" class="form-control" style="width:98%" />
													</div>-->
													<!-- <div class="radio">
														<label><input name="browsefile" type="radio" value="2" />เลือกไฟล์จากเครื่อง</label>
													</div> -->
													<input type="file" name="filebrowse" id="filebrowse" onchange="JSCheck_file(this.id,this.value);" onClick="document.form1.browsefile[1].checked=true" class="form-control" />
												</div>
											</div>
											...
											<div class="form-group row">
												<div class="col-md-12 col-sm-12 col-xs-12">
													...
													<div class="checkbox">
														<label>
															<input name="chk_show_count_level1" type="checkbox" id="chk_show_count_level1" value="3" <?php if ($R['show_count'] == "3") {
																																							echo "checked";
																																						} ?> />
										...
										<div class="form-group row">
											<div class="col-md-3 col-sm-3 col-xs-12">
												...
												<select name="target" id="select" class="form-control">
													<option value="_blank" <?php if ($R['target'] == "_blank") {
																				echo "selected";
																			} ?>>เปิดหน้าต่างใหม่</option>
													<option value="_self" <?php if ($R['target'] == "_self") {
																				echo "selected";
																			} ?>>เปิดหน้าต่างเดิม</option>
												</select>
											</div>
											...
											<div class="col-md-4 col-sm-4 col-xs-12">
												<label for="icon"><b><?php echo "Icon ท้ายข่าว"; ?> : </b></label>
												<div class="form-inline">
													<span id="iconname">
														<?php
														$iconpath = "../ewt/gistda_web/icon/" . $R['logo'];
														if (file_exists($iconpath) == true && $R['logo'] != "") {
														?>
															<img src="<?php echo $iconpath; ?>" border="0">
														<?php
														}
														?>
													</span>
													<input type="hidden" name="icon" id="icon" value="<?php echo $R['logo']; ?>">
													<a href="#browse" onClick="boxPopup('<?php echo linkboxPopup(); ?>pop_article_icon.php?cid=<?php echo $cid; ?>');">
											...
											?>
											<div class="col-md-4 col-sm-4 col-xs-12">
												<label for="date_e"><b><?php echo "วันสิ้นสุดการแสดงไอคอน"; ?> : </b></label>
												<div class='input-group date datepicker' id='datetimepicker1'>
													<input name="date_e" id="date_e" type="text" class="form-control form-control-sm " value="<?php echo $date1[2] . "/" . $date1[1] . "/" . $date1[0]; ?>" />
													<span class="input-group-addon">
														<a href="#date">
												...
												<div class="form-inline">
													<select name="time_H_start" class="form-control">
														...
														<?php for ($i = 0; $i < count($time_H); $i++) { ?>
															<option value="<?php echo $time_H[$i]; ?>" <?php if ($time_Hn_start == $time_H[$i]) {
																											echo 'selected';
																										} ?>><?php echo $time_H[$i]; ?></option>
														<?php } ?>
													</select>
													:
													<select name="time_s_start" class="form-control">
														...
														<?php for ($i = 0; $i < count($time_s); $i++) { ?>
															<option value="<?php echo $time_s[$i]; ?>" <?php if ($time_sn_start == $time_s[$i]) {
																											echo 'selected';
																										} ?>><?php echo $time_s[$i]; ?></option>
														<?php } ?>
													</select>.น
											...
											<div class="col-md-2 col-sm-2 col-xs-12">
												...
												<div class="form-inline">
													<select name="time_H_end" class="form-control">
														<option value=""></option>
														<?php for ($i = 0; $i < count($time_H); $i++) { ?>
															<option value="<?php echo $time_H[$i]; ?>" <?php if ($time_Hn_end == $time_H[$i]) {
																											echo 'selected';
																										} ?>><?php echo $time_H[$i]; ?></option>
														<?php } ?>
													</select>
													...
													<select name="time_s_end" class="form-control">
														<option value=""></option>
														<?php for ($i = 0; $i < count($time_s); $i++) { ?>
															<option value="<?php echo $time_s[$i]; ?>" <?php if ($time_sn_end == $time_s[$i]) {
																											echo 'selected';
																										} ?>><?php echo $time_s[$i]; ?></option>
														<?php } ?>
													</select>.น
