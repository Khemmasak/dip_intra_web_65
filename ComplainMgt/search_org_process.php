...
##============================================================================================================##
$name_org = trim($_POST["name_org"]);
##============================================================================================================##
$where = " AND 1=1 ";

if ($name_org != "") {
    $where_user .= " AND name_org LIKE '%" . $name_org . "%' ";
}
##============================================================================================================##
$_GET['ug'] = $_SESSION["EWT_SUID"];

$sql_gen_user  = "SELECT * FROM org_name WHERE org_status = 'Y' $where";
$sql_gen_user .= " ORDER BY org_id";
