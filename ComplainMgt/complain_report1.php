...
<label for="start_date"><b><?php echo "วันที่เริ่มต้น";?> : </b></label>
            <div class='input-group date' id='datetimepicker1'>
                <input type='text' class="form-control datepicker cal" placeholder="<?php echo "วันที่เริ่มต้น";?>" name="start_date"  id="start_date" value="" readonly >
...
<label for="end_date"><b><?php echo "วันที่สิ้นสุด";?> : </b></label>
            <div class='input-group date' id='datetimepicker2'>
                <input type='text' class="form-control datepicker cal" placeholder="<?php echo "วันที่เริ่มต้น";?>"  name="end_date"  id="end_date" value="" readonly >
                <span class="input-group-addon">
                    <i class="far fa-calendar-alt"></i>
                </span>
            </div>
...
<div class="btn-group ">
        ...
        <ul class="dropdown-menu dropdown-menu-right"> 
            <li><a onClick="window.location.href='export_report1_xlsx.php';" ><i class="fas fa-file-excel text-medium text-success"></i>&nbsp;<?php echo "Excel";?></a></li>
			<!--<li><a onClick="window.location.href='export_report1_pdf.php';" ><i class="fas fa-file-pdf text-medium text-danger"></i>&nbsp;<?php //echo "PDF";?></a></li>
...
<table width="60%" border="0" align="center" class="table table-bordered" >
<thead>
<tr class="success">
<th width="10%"  class="text-center" ><b>#</b></th>
<th width="60%" class="text-center" ><b><?php echo 'หมวดเรื่องร้องเรียน';?></b></th>
<th width="30%" class="text-center" ><b><?php echo 'จำนวน(เรื่อง)';?></b></th>
...
<td class="text-left" ><?php echo $a_data['Complain_lead_name'];?></td>
<td class="text-center" ><?php echo FuncCount($a_data['Complain_lead_ID'],$wh);?></td>
