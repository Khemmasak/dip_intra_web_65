...
<h4><?php echo $txt_complain_menu_main;?></h4>
<p></p> 
...
<ol class="breadcrumb">
<li><a href="complain_main.php"><?php echo $txt_complain_menu_main;?></a></li>
<li class=""></li>       
</ol>
</div>
...
<div class="panel panel-default ">
            <div class="panel-heading ewt-bg-success">
                <h4 class="panel-title">
					...
					<?php echo $a_data['topic'];?> <?php echo complain_category($a_data['flag']);?>
					</a>					
                </h4>
            </div>
...
<?php } ?>
		...
		<div><b><?php echo "วันที่";?> :</b> <?php echo $a_data['date'];?> <?php echo $a_data['time'];?></div><br> 			
...
<button type="button" class="btn btn-danger  btn-circle  btn-sm " onClick="JQDelete_Complain('<?php echo $a_data['id']?>');" data-toggle="tooltip" data-placement="top" title="<?php echo $txt_complain_delete;?>" >
<i class="far fa-trash-alt" aria-hidden="true"></i>
</button>

<button type="button" class="btn btn-info  btn-circle  btn-sm " onClick="boxPopup('<?php echo linkboxPopup();?>pop_add_complain_comment.php?com_id=<?php echo $a_data['id']?>');" data-toggle="tooltip" data-placement="top" title="<?php echo $txt_complain_comment;?>" >
