...
$com_cid = (int)(!isset($_GET['com_cid']) ? 0 : $_GET['com_cid']);
...
$_sql = $db->query("SELECT *					
					...
					ORDER BY m_page_id DESC LIMIT {$start} , {$perpage} ");

$statement = "SELECT count(m_page_id) AS b
			  FROM m_complain_page 
			  {$wh} ";
...
<h4><?php echo "Complain Add Page";?></h4>
<p></p> 
...
<ol class="breadcrumb">
<li><a href="complain_page.php"><?php echo "Complain Add Page";?></a></li>
<li></li>  
</ol>
</div>
...
<div class="card-title text-white"> Page list
</div>
</div>
<div class="card-body">
...
<button type="button" class="btn btn-warning  btn-circle  btn-sm " onClick="boxPopup('<?php echo linkboxPopup();?>pop_set_page.php?m_page_id=<?php echo $a_data['m_page_id']?>');" data-toggle="tooltip" data-placement="top" title="<?php echo 'Setting Complain Form';?>" >
<i class="far fa-edit" aria-hidden="true"></i>
</button>
<a href="../ewt/<?php echo $_SESSION['EWT_SUSER']."/";?><?php echo $a_data['m_page_url']?>" target="_blank">
<button type="button" class="btn btn-info  btn-circle  btn-sm "  data-toggle="tooltip" data-placement="top" title="<?php echo $txt_ewt_viewform;?>" >
