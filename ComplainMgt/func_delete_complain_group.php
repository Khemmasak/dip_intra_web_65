...
if($a_data['proc']=='DelComGroup'){
	
$s_data['Complain_status_use']  = 'N';

$ss_data['status']  = 'N';

update('m_complain_info',$s_data,array('Complain_lead_ID'=>$a_data['id']));
	
update('m_complain',$ss_data,array('flag'=>$a_data['id']));
