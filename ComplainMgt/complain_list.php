...
$_sql = $db->query("SELECT *					
					FROM m_complain					
					WHERE m_complain.status = '' AND m_complain.flag = '{$com_cid}'
					{$wh} 
...
<li><?php echo complain_category($com_cid);?></li>  
</ol>
</div>

<div class="col-md-12 col-sm-12 col-xs-12 float-right text-right hidden-xs"  >	  
<a href="complain_group.php" target="_self">
...
<div class="btn-group ">
        ...
        <ul class="dropdown-menu dropdown-menu-right">
         <li><a href="complain_group.php" target="_self"><i class="fas fa-undo-alt"></i>&nbsp;<?php echo $txt_ewt_back;?></a></li>  
		</ul>
</div>
</div>	
</div>
...
<?php echo pagination_ewt($statement,$perpage,$page,$url='?com_cid='.$com_cid.'&');?>	
</div>
</div>
