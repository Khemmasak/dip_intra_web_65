...
<form id="form_main" name="form_main" method="POST" action="<?php echo getLocation('func_edit_complain_pdpa')?>" enctype="multipart/form-data" >
<input type="hidden" name="proc" id="proc"  value="Edit_Pdpa">
<input type="hidden" name="pdpa_id" id="pdpa_id"  value="<?php echo $pdpa_id;?>">
<input type="hidden" name="pdpa_file_old" id="pdpa_file_old"  value="<?php echo $a_data['pdpa_file'];?>">
<div class="container" >   
...
<div >
<label class="switch">
  <input type="checkbox" value="Y" name="pdpa_status" id="pdpa_status" <?php if($a_data['pdpa_status'] == 'Y'){ echo 'checked="checked"'; } ?> />
...
<div >
<label class="switch">
  <input type="checkbox" value="Y" name="pdpa_checkbox" id="pdpa_checkbox" <?php if($a_data['pdpa_checkbox'] == 'Y'){ echo 'checked="checked"'; } ?> />
  <span class="slider round"></span>
  <span class="absolute-no">NO</span> 
</label>
</div>
...
<?php
if(!empty($a_data['pdpa_file'])){
?>
<span><code><?php echo $a_data['pdpa_file'];?></code></span><br><br>
<?php } ?>
