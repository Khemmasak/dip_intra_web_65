...
$_sql = $db->query("SELECT *
					FROM permission 
					WHERE pu_id = '{$pu_id}' AND p_type = 'U' AND s_type = 'dlFo'  AND UID = '{$UID}' AND s_permission = '{$p_type}' AND s_id = '0' AND s_name != ''
					ORDER BY p_id ASC ");
...
<?php /*<ul id="sortableLv1" class="sortableLv1 connectedSortable " style="width: 100%;">
<li class="productCategoryLevel1 ewt-bg-color ui-state-disabled text-left " id="0" >

<div class="checkbox">&nbsp;&nbsp;
          <label>
			<input name="chk" id="chk"  type="checkbox" value="0" <?=$check;?> _onClick="chkdis(this,'0',0,<?=$numfolder?>);" />
