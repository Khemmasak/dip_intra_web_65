...
function Set(string) {                   // select color
  ...
  if (color == null) { alert("Invalid color code: " + string); }        // invalid color
    ...
    if(document.form1.status.value=="body"){
window.opener.document.all.CPreview1.style.backgroundColor = color;       
window.opener.top.ewt_main.document.all.tbbg.style.backgroundColor = color;    
window.opener.document.form1.bg_color.value = color;
	} else  if(document.form1.status.value=="bodyi"){
window.opener.document.all.CPreview2.style.backgroundColor = color;       
window.opener.top.ewt_main.document.all.tbbody.style.backgroundColor = color;    
window.opener.document.form1.bg_icolor.value = color;
	}       // set return value
...
<table border=0 cellspacing=0 cellpadding=4 width=100%>
 <tr>
  ...
  <td bgcolor="buttonface" width=100%><input name="status" type="hidden" id="status" value="<?php echo $_GET["t"]; ?>"></td>
 </tr>
</table>
