...
DEFINE("FF_AngsanaUPC", 40);
DEFINE("FF_BrowalliaUPC", 41);
DEFINE("FF_CordiaUPC", 42);
DEFINE("FF_DilleniaUPC", 43);
DEFINE("FF_EucrosiaUPC", 44);
DEFINE("FF_FreesiaUPC", 45);
DEFINE("FF_IrisUPC", 46);
DEFINE("FF_JasmineUPC", 47);
DEFINE("FF_KodchiangUPC", 48);
DEFINE("FF_LilyUPC", 49);
...
function tis2utf8_beauty($thaistr) {
	$thai_utf16 =  iconv("UTF-8","UTF-16",preg_replace(array("/(่|้|๊|๋)ำ/", "/ำ/"),array("ํ\\1า", "ํา"),$thaistr));
	...
	return iconv("UTF-16", "UTF-8",$thai_utf16);
}
...
class LanguageConv {
	...
	elseif( $aFF >= 40 && $aFF <=80 ) {
	    if( !function_exists('iconv') ) {
		JpGraphError::Raise('Usage of THAI font family requires that your PHP setup has the iconv() function. By default this is not compiled into PHP (needs the "--width-iconv" when configured).');
	    }
	    //return tis2utf8_beauty($aTxt);
	    return tis2utf8_beauty($aTxt);
	}
...
// CONSTRUCTOR
	...
	$this->font_files=array(
	    ...
	    // Thai Font
	    , FF_AngsanaUPC => array(FS_NORMAL=>'ANGSAU.TTF', FS_BOLD=>'ANGSAUB.TTF', FS_ITALIC=>'ANGSAUI.TTF', FS_BOLDITALIC=>'ANGSAUZ.TTF' )
	    , FF_BrowalliaUPC => array(FS_NORMAL=>'BROWAU.TTF', FS_BOLD=>'BROWAUB.TTF', FS_ITALIC=>'BROWAUI.TTF', FS_BOLDITALIC=>'BROWAUZ.TTF' )
	    , FF_CordiaUPC => array(FS_NORMAL=>'CORDIAU.TTF', FS_BOLD=>'CORDIAUB.TTF', FS_ITALIC=>'CORDIAUI.TTF', FS_BOLDITALIC=>'CORDIAUZ.TTF' )
	    , FF_DilleniaUPC => array(FS_NORMAL=>'UPCDL.TTF', FS_BOLD=>'UPCDB.TTF', FS_ITALIC=>'UPCDI.TTF', FS_BOLDITALIC=>'UPCDBI.TTF' )
	    , FF_EucrosiaUPC => array(FS_NORMAL=>'UPCEL.TTF', FS_BOLD=>'UPCEB.TTF', FS_ITALIC=>'UPCEI.TTF', FS_BOLDITALIC=>'UPCEBI.TTF' )
	    , FF_FreesiaUPC => array(FS_NORMAL=>'UPCFL.TTF', FS_BOLD=>'UPCFB.TTF', FS_ITALIC=>'UPCFI.TTF', FS_BOLDITALIC=>'UPCFBI.TTF' )
	    , FF_IrisUPC => array(FS_NORMAL=>'UPCIL.TTF', FS_BOLD=>'UPCIB.TTF', FS_ITALIC=>'UPCII.TTF', FS_BOLDITALIC=>'UPCIBI.TTF' )
	    , FF_JasmineUPC => array(FS_NORMAL=>'UPCJL.TTF', FS_BOLD=>'UPCJB.TTF', FS_ITALIC=>'UPCJI.TTF', FS_BOLDITALIC=>'UPCJBI.TTF' )
	    , FF_KodchiangUPC => array(FS_NORMAL=>'UPCKL.TTF', FS_BOLD=>'UPCKB.TTF', FS_ITALIC=>'UPCKI.TTF', FS_BOLDITALIC=>'UPCKBI.TTF' )
	    , FF_LilyUPC => array(FS_NORMAL=>'UPCLL.TTF', FS_BOLD=>'UPCLB.TTF', FS_ITALIC=>'UPCLI.TTF', FS_BOLDITALIC=>'UPCLBI.TTF' )
