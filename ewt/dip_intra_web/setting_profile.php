...
$km_point_total = km::getKmtotal(null, null, $_SESSION["EWT_MID"])["km_total"];
...
$ecard_user = array_chunk($ecard_user_birthdate['data'], 6);
$ecard_count = sizeof($ecard_user);
?>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 col-md-9 col-12">
        ...
        <!--<div class="bg--white shadow">
          <div class="mt-3 mb-5">
            <h6 class=""><i class="fa  fa-trophy"></i> KM Point ของคุณ </h6>
			      <h1 class="mt-3 mb-3"><?php /*echo $km_point_total ?> Point</h1>
            <div class="row">
        ...
        <div class="mt-4 bg--white shadow">
          <div class="mt-3 mb-5">
            <div class="row">
              ...
              <!-- Open add class="w-100" 10/05/65 -->
              <div class="card-carousel w-100">
                <!-- Close add class="w-100" 10/05/65 -->
                <div id="carouselExampleIndicators2" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                    <?php for ($i = 0; $i < $ecard_count; $i++) { ?>
                      <div class="carousel-item <?php echo $i == 0 ? "active" : null; ?>">
                        <div class="row">
                          <?php foreach ($ecard_user[$i] as $key => $value) { ?>
                            <?php
                            ...
                            $full_name = $user['name_thai'] . ' ' . $user['surname)thai']; //ชื่อ-นามสกุลผู้ส่งการ์ดวันเกิด
                            //$user_image = getImgbase64("profile/" . $user_sso["USR_PICTURE"], "images/user_profile_empty.png"); //รูปผู้ส่งการ์ดวันเกิด
                            $user_image = getImage("profile/", $user["webb_pic"], "images/user_profile_empty.png"); //รูปผู้ส่งการ์ดวันเกิด
                            ?>
