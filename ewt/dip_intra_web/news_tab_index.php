                                        ...
                                        <div style="padding:10px;">
                                            ...
                                            <?php } elseif ($c_group['c_show_pic'] != "Y" && $c_group['c_show_pic'] != "N") { ?>
                                                <div class="icon__block">
                                                    <a href="<?php echo ($val['news_use'] == 1 ? $val['link_html'] : "news_view.php?n_id=" . $val['n_id'] . " "); ?>" target="<?php echo $val['target']; ?>" title="<?php echo trim($c_group['c_name']); ?>">
                                            ...
                                            <div class="card-body p-2">
                                                <div class="card-title font17px">
                                                    ...
                                                    <a onclick="newsCount(<?php echo $val['c_id']; ?>,<?php echo $val['n_id']; ?>,'news_tab_index');" href="<?php echo ($val['news_use'] == 1 ? $val['link_html'] : "news_view.php?n_id=" . $val['n_id'] . " "); ?>" target="<?php echo $val['target']; ?>" title="<?php echo trim($val['n_topic']); ?>" class="txt-gray-dark2 font17px">
                                                ...
                                                <p class="card-text font13px">
                                                    ...
                                                    <span class="mr-2">
                                                        <a href="<?php echo ($val['news_use'] == 1 ? $val['link_html'] : "news_view.php?n_id=" . $val['n_id'] . " "); ?>">
