...
<table border="0" >
	...
	<tr> 
		<td style=""><p style="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is to certify that <?php echo $_GET['FULL_NAME_EN'];?>, presently the Indus trial Technical Officer, Practitioner Level, has been working at the Information and Communication Technology Center, Department of Industrial Promotion, His current salary is <?php echo number_format($_GET["INCOME_MONEY"]);?> bath per month.</p></td>
	</tr>
	<!--<tr>
