...
function getTxt(s)
    ...
    switch(s)
        ...
        case "Cannot delete column.":
            return "Ne pas supprimer la colonne. La colonne contient des cellules \u00E9tendues provenant d\u0027autres colonnes. Commencer เ supprimer l\u0027extention en premier.";
        case "Cannot delete row.":
            return "Ne pas supprimer la ligne. La ligne contient des cellules \u00E9tendues provenant d\u0027autres lignes. Commencer เ supprimer l\u0027extention en premier.";
        default:return "";
        }
    }
function writeTitle()
