	...
	<body leftmargin="0" topmargin="0" >
		...
		<table width="90%" border="0" align="center" class="table table-bordered">
			...
			<form name="form1" method="post" action="proc_ebook.php" onSubmit="return chkForm(document.form1);" enctype="multipart/form-data">
				<?php  ?>
				<tr bgcolor="#FFFFFF">
					<td width="30%" height="25"  valign="top">ชื่อE-Book<!--Name--> <span style="color:red;">*</span> </td>
					<td width="70%"  align="left" valign="top"><label>
						<input class="form-control" style="width:40%;" name="name" type="text" size="50" value="<?php echo $rec['ebook_name']?>">
					</label></td>
				</tr>
				<tr bgcolor="#FFFFFF">
					<td height="25"  valign="top">รายละเอียด<!--Description--> </td>
					<td  align="left" valign="top"><label>
						<textarea class="form-control" style="width:40%;" name="desc" cols="50" rows="3"><?php echo $rec['ebook_desc'];?></textarea>
					</label></td>
				</tr>
				<tr bgcolor="#FFFFFF">
					<td height="25"  valign="top">เลือกขนาด<!--Preset&nbsp;--> </td>
					<td  align="left" valign="top">
						<select name="presetSize" onChange="getPresetSize (this);" class="form-control" style="width:40%;">
				...
				<tr bgcolor="#FFFFFF">
					...
					<td  align="left" valign="top">
						<select name="groupebook" class="form-control" style="width:40%;">
							<?php
				...
				<tr bgcolor="#FFFFFF">
					...
					<td  align="left" valign="top"><label>
						ความกว้าง
						<input class="form-control" style="width:10%;" name="w" type="text" size="5" value="<?php echo $rec['ebook_w']?>">
						X ความสูง
						<input class="form-control" style="width:10%;" name="h" type="text" size="5" value="<?php echo $rec['ebook_h']?>">
					pixel</label></td>
				</tr>
				<tr bgcolor="#FFFFFF">
					...
					<td  align="left" valign="top">
						...
						?>
					<input class="form-control" style="width:40%;" type="text" name="by" id="by" value="<?php echo $c_by;?>"></td>
				</tr>
				<!-- <tr bgcolor="#FFFFFF">
				...
				<tr bgcolor="#FFFFFF">
					...
					<td  align="left" valign="top">
						<input class="form-control" style="width:40%;" type="file" name="pageFile" id="pageFile" onChange="chkFile (this);">
				...
				<tr bgcolor="#FFFFFF">
					...
					<td  align="left" valign="top"><label>
						...
						<input type="Button" name="saveButton2" value="  ยกเลิก   " class="btn btn-warning" Onclick="window.location.href='book_mgt_list.php?ebookCode=<?=$_SESSION['g_ebook_id']?>';">
