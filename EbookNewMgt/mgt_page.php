		...
		<form name="form1" method="post" action="proc_ebook.php" enctype="multipart/form-data" onsubmit="show_loading();">
			...
			<table width="90%" border="0" align="center" class="table table-bordered">
				...
				<tr bgcolor="#FFFFFF">
					...
					<td width="62%"  align="left" valign="top">
						...
						?>
						<input class="form-control"   style="width:10%;" name="amtFile" type="text" size="5" value="<?php echo $amtFile;?>">
						<input class="btn btn-info ptn-ml"  type="button" name="Button" value="Ok" onClick="self.location.href='mgt_page.php?amtFile='+this.form.amtFile.value+'&ebookCode=<?php echo $ebookCode;?>';"> 
				...
				<?php 
					...
					<tr bgcolor="#FFFFFF">
						...
						<input class="form-control"   style="width:40%;" type="file" name="pageFile<?php echo $refPage?>" onChange="chkFile (this);"><br>
						<font color="red">
					...
					<tr bgcolor="#FFFFFF">
						...
						<td  align="left" valign="top"><label>
							<input type="submit" name="saveButton" value="Save" class="btn btn-success ptn-ml"  disabled >
			...
			<table width="70%" border="0" cellpadding="5" cellspacing="1" bgcolor="FFFFFF" align="center" class="ewttableuse" >
				...
				<tr bgcolor="#FFFFFF">
					...
					<td width="62%"  align="left" valign="top">
						หน้า <input class="form-control"   style="width:30%;"  name="insertPage" type="text" id="insertPage" size="2">
					</td>
				</tr>
				<tr bgcolor="#FFFFFF">
						<td height="7" valign="top"></td>
						<td width="81%"  align="left" valign="top">
						<input class="form-control"   style="width:30%;" type="file" name="pageFileInsert" onChange="chkFileInsert (this);">
							<font color="red">
				...
				<tr bgcolor="#FFFFFF">
						<td height="25" align="right" valign="top">&nbsp;</td>
						<td  align="left" valign="top"><label>
							<input type="submit" name="saveButton" value="Save" class="btn btn-success btn-ml"  disabled>
							<input type="hidden" name="ebookCode" value="<?php echo $ebookCode;?>">
							<input type="hidden" name="proc" value="savePage">
							<input type="hidden" name="mode" value="<?php echo $mode;?>">
						</label><span id="status_load"></span>
			...
			<table width="90%" align="center" class="table table-bordered">
				<tr>
					<td align="left"><button class="btn btn-info btn-ml" type="button" onclick="window.open('<?php echo $dest.'/index.html';?>');"><img src="../theme/main_theme/g_view.gif" width="16" height="16" alt="Preview E-Book" border="0" align="absmiddle"> แสดง E-Book</button></td>
				</tr>
			</table>
			<br>
			<table width="90%" border="0" align="center" class="table table-bordered">
					...
					<td valign="top" bgcolor="#F4F4F4" class="MemberTitle">
						<table width="100%" align="center" class="table table-bordered">
							...
							<tr align="center"  class="ewttablehead">
								<td width="10%" ><input class="btn btn-warning btn-ml"  name="btn_chk_all" id="btn_chk_all" type="button" onclick="chk_all(this);" value="เลือกทั้งหมด"/></td> 
								<td width="10%" > </td> 
								<td width="40%" >หน้า</td>
							...
							<?php
								...
								$query=$db->query($sql1."  LIMIT $start,$limit");
							...
							?>
							<tr bgcolor="#FFFFFF">
								<td  colspan="5"><input class="btn btn-danger btn-ml"  type="button" value="ลบที่เลือก" onclick="delByChek();"></td>
							</tr>
							<tr bgcolor="#FFFFFF">
