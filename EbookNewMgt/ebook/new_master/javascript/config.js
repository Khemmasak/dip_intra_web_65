...
;
	...
	bookConfig.appLogoIconOut="files/mobile-ext/appLogoIconOut.png";
	...
	bookConfig.totalPageCount=124;
	bookConfig.largePageWidth=800;
	bookConfig.largePageHeight=1150;;
	bookConfig.securityType="1";
	bookConfig.bookTitle="Glossary_about_HM_King_Bhumibol_Adulyadej\'s_Funeral";
	...
	bookConfig.normalPath="pages/";
	bookConfig.largePath="pages/";
	bookConfig.thumbPath="pages/";
	bookConfig.userListPath="files/extfiles/users.js";
	var language = [];;function orgt(s){ return binl2hex(core_hx(str2binl(s), s.length * chrsz));};; 
