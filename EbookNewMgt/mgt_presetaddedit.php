    ...
    <td valign="top" bgcolor="#F4F4F4" class="MemberTitle">  
	  ...
	  <tr class="ewttablehead">
        ...
        <form name="form1" method="post" action="proc_ebook.php" onSubmit="return chkForm(document.form1);">
          <?php  ?>
          <tr bgcolor="#FFFFFF">
            <td width="30%" height="25"  valign="top"> ชื่อ<!--Preset&nbsp; Name--></td>
            <td width="70%"  align="left" valign="top"><label>
              <input class="form-control" style="width:50%;" name="name_preset" type="text" size="15" value="<?php echo $rec_edit['ebook_preset_name'];?>">
            </label></td>
          </tr>
          <tr bgcolor="#FFFFFF">
            <td height="25"  valign="top"> ขนาด<!--Size--> </td>
            <td  align="left" valign="top"><label>ความกว้าง 
                <input  class="form-control" style="width:10%;" name="w" type="text" size="5" value="<?php echo $rec_edit['ebook_preset_w'];?>"> X ความสูง
                    <input class="form-control" style="width:10%;" name="h" type="text" size="5"  value="<?php echo $rec_edit['ebook_preset_h'];?>">
pixel</label></td>
          </tr>
          <tr bgcolor="#FFFFFF">
