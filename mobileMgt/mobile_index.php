...
//$db->write_log("view","Vulgar ","เข้าสู่ module การตั้งค่าคำไม่สุภาพ ");
?>
<html>
<head>
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#333333">
  ...
  <tr> 
    <td width="60" height="58"><img src="../theme/main_theme/g_mobile_64.gif"> </td>
                
          <td><span class="ewthead">Mobile</span> 
            <hr width="100%" size="1"  align="left"  color="#D8D2BD">
            <span class="ewtsubmenu"><a href="mobile_contents.php" target="iframe_data"><img src="../theme/main_theme/bullet.gif" width="16" height="16" align="absmiddle" border="0"> <?php echo $text_genrude_modulesub_main;?></a></span>		  
            &nbsp;&nbsp;&nbsp;&nbsp; <span class="ewtsubmenu"><a href="mobile_setting.php" target="iframe_data"><img src="../theme/main_theme/bullet.gif" width="16" height="16" border="0" align="absmiddle"> 
            ตั้งค่า</a></span>
            </td>
  </tr>
</table>
  ...
  <tr> 
    <td valign="top" bgcolor="#FFFFFF"><table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
                      <tr> 
                        <td bgcolor="#FFFFFF"><iframe name="iframe_data" src="mobile_contents.php"  frameborder="0"  width="100%" height="100%" scrolling="yes"></iframe></td>
                      </tr>
