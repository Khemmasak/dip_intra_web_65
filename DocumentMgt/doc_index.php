...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#333333">
  ...
  <tr> 
    <td width="60" height="58"><img src="../theme/main_theme/g_download_64.gif"> </td>
                <td><span class="ewthead">Document Download Management</span>
                  <hr width="100%" size="1"  align="left"  color="#D8D2BD">
            <span class="ewtsubmenu"><a href="main_download_group.php" target="iframe_data"><img src="../theme/main_theme/bullet.gif" border="0" width="16" height="16" align="absmiddle"> 
            หน้าหลัก</a></span>
			<span class="ewtsubmenu"><a href="download_setting.php" target="iframe_data"><img src="../theme/main_theme/bullet.gif" border="0" width="16" height="16" align="absmiddle"> 
            ตั้งค่าการอัพโหลด</a></span> 
			<span class="ewtsubmenu"><a href="download_stat.php" target="iframe_data"><img src="../theme/main_theme/bullet.gif" border="0" width="16" height="16" align="absmiddle"> 
          รายงานความนิยมในการดาวน์โหลด</a></span> </td>
  </tr>
</table>
	  </td>
  </tr>
