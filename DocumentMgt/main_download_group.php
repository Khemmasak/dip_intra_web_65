...
$sel = "SELECT * FROM docload_group  WHERE  dlg_parent = '0' ORDER BY dlg_id ASC";
...
<table width="94%" border="0" align="center" cellpadding="0" cellspacing="0" class="ewtfunctionmenu">
  <tr>
    <td align="right"><a href="javascript:void(0);" onClick="load_divForm('../FavoritesMgt/favorites_add.php?name=<?php echo urlencode ("หน้าหลัก->กลุ่ม Download "); ?>&module=document&url=<?php echo urlencode  ( "main_download_group.php");?>', 'divForm', 300, 80, -1,433, 1);"><img src="../images/star_yellow_add.gif" width="16" height="16" border="0" align="middle">&nbsp;Add to favorites </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="download_group_add.php" ><img src="../theme/main_theme/g_add.gif" width="16" height="16" align="absmiddle" border="0"> เพิ่มกลุ่มใหม่</a> 
	<hr>
    </td>
  </tr>
</table>
