                  ...
                  <td valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr height="25"> 
                     ...
                     <td width="100" align="center" background="../images/bg3_off.gif"><a href="article_useshare.php">Use Share Article</a> </td>
                      <td width="100" align="center" background="../images/bg1_on.gif">Setting Share Auto</td>
                    ...
                    <tr> 
					  ...
					  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="919B9C">
                          <tr> 
                            <td bgcolor="#FFFFFF"><iframe name="article_sitting_auto" src="article_sitting_auto.php" frameborder="0"  width="100%" height="100%" scrolling="yes" ></iframe></td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr align="right"> 
