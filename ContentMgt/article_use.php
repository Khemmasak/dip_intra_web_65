...
<table width="94%" border="0" align="center" cellpadding="0" cellspacing="0" class="ewtfunctionmenu">
  <tr> 
    <td>
	<span class="ewtfunction"><a href="article_use.php?cid=0">หน้าหลัก</a>  &gt;&gt;  <?php echo findparent($G["c_parent"]); ?> 
...
<br>
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="ewtfunctionmenu">
  <tr> 
...
<table  width="90%"  border="0" align="center" class="table table-bordered">
    <tr bgcolor="E0DFE3" class="ewttablehead"> 
      ...
      <td  width="90%" height="18" align="center">ชื่อกลุ่มข่าว/บทความ</td>
    </tr>
    <?php
	$i = 0;
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="center"><nobr>
        <input class="btn btn-info" name="Button" type="button" value="เลือก" OnClick="Editfile('more_news.php?cid=<?php echo $G["c_id"]; ?>');">
        </nobr></td>
...
<table width="90%" border="0" align="center"  class="table table-bordered">
	...
	<td width="10%" align="center" >&nbsp;</td>
      ...
      <td width="60%"  height="18" align="center" >หัวข้อข่าว/บทความ</td>
      <td width="10%" align="center" >ผู้สร้าง</td>
      <td width="10%" align="center" >สร้าง</td>
    </tr>
    <?php
	$i = 0;
	...
	?>
    <tr bgcolor="#FFFFFF" > 
      <td height="20" align="center" valign="top" nowrap><input class="btn btn-info"  name="Button2" type="button" value="เลือก" OnClick="Editfile('ewt_news.php?nid=<?php echo $N["n_id"]; ?>');"></td>
