...
$db->write_log("update","main","แก้ไข block Rss Reader ");
?>
<script language="JavaScript">
window.location.href = "rss_list.php?B=<?php echo $_POST["B"]; ?>";
//self.close();
</script>
<?php
}else{
...
$BLink=$R[block_link];
$sql_menu = $db->query("SELECT * FROM rss ORDER BY rss_id ASC ");
?>
<html>
<head>
...
<form name="form1" method="post" action="rss_list.php">
 <input name="Flag" type="hidden" id="Flag" value="SET">
  ...
  <tr bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='F7F7F7'" onMouseOut="this.style.backgroundColor='FFFFFF'"> 
	...
	<?php }?> <?php echo $R["rss_title"]; ?></td>
    <td align="center"><a href="#select" onClick="selectG('<?php echo $R["rss_id"]; ?>');">Apply</a></td>
  </tr>
  <?php
		}
		}else{
  ...
  <tr align="center" bgcolor="#FFFFFF"> 
    <td colspan="2"><strong><font color="#FF0000">RSS not found.</font></strong></td>
  </tr>
  <?php } ?>
</table>
</body>
