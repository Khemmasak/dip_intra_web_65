  ...
  <tr> 
    <td width="60" height="58"><img src="../theme/main_theme/g_sitestats_64.gif"> </td>
                <td><span class="ewthead"> ระบบสร้างกราฟ</span>
				  ...
				  <span class="ewtsubmenu"><nobr><a href="grap_main.php" target="iframe_data"><img src="../theme/main_theme/bullet.gif"  border="0" width="16" height="16" align="absmiddle"> ข้อมูลกราฟ</a></nobr></span></td>
  </tr>
</table>
	  </td>
  </tr>
