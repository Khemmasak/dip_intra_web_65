...
window.location.href = "poll_list.php?B=<?php echo $_POST["B"]; ?>";
//top.self.close();
</script>
<?php
}else{
...
$BLink=$R[block_link];
$sql_menu = $db->query("SELECT * FROM poll_cat where c_approve = 'Y'ORDER BY c_id ASC ");
?>
<html>
<head>
...
<form name="form1" method="post" action="poll_list.php">
 <input name="Flag" type="hidden" id="Flag" value="SET">
  ...
  <tr bgcolor="#E6E6E6"> 
    <td width="70%"><strong>Poll name</strong></td>
  ...
  <tr bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='F7F7F7'" onMouseOut="this.style.backgroundColor='FFFFFF'"> 
	...
	<?php }?><?php echo $R["c_name"]; ?> </td>
    <td align="center"><a href="#select" onClick="selectG('<?php echo $R["c_id"]; ?>');">Apply</a></td>
  </tr>
  <?php
		}
		}else{
  ...
  <tr align="center" bgcolor="#FFFFFF"> 
    <td colspan="2"><strong><font color="#FF0000">Poll not found.</font></strong></td>
  </tr>
  <?php } ?>
</table>
</body>
