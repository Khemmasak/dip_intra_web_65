...
function used_user(){
var alli = m_data2.form1.alli.value;
var uid = '';
var uname='';
var chkused;
window.opener.document.getElementById('hdd_ugroup').value = '';
window.opener.document.all.txtshowugroup.innerHTML = '';
	for(var i=0;i<alli;i++){
		if(m_data2.form1.document.getElementById('chk'+i).checked == true){
			if(uid == '') {
			uid = m_data2.form1.document.getElementById('uid'+i).value;
			uname = m_data2.form1.document.getElementById('uname'+i).value;
			}else{
			uid = uid+','+m_data2.form1.document.getElementById('uid'+i).value;
			uname = uname+','+m_data2.form1.document.getElementById('uname'+i).value;
			}
		}
		window.opener.document.getElementById('tr_group').style.display = '';
		window.opener.document.getElementById('hdd_ugroup').value = uid;
		window.opener.document.all.txtshowugroup.innerHTML = uname;
	}
}
</script>
<body>
              ...
              <tr>
                  <td valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr height="25"> 
                      ...
                      <td width="100" align="center" background="../images/bg1_on.gif">กลุ่มสิทธิ์</td>
                    ...
                    <tr> 
                      <td height="30"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <form name="form1" method="post" action="member_list3_group.php" target="m_data2"><tr> 
                    ...
                    <tr> 
                      <td><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="919B9C">
                          <tr> 
                            <td bgcolor="#FFFFFF"><iframe name="m_data2"  frameborder="0"  width="100%" height="100%" scrolling="yes" ></iframe></td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr align="right"> 
...
form1.document.getElementById('id2').value = window.opener.document.getElementById('hdd_ugroup').value;
