...
//	buttonName2[6]  = "seperator";
	buttonName2[7]  = "unorderedlist";
	buttonName2[8]  = "orderedlist";
	buttonName2[9]  = "seperator";
	buttonName2[10]  = "outdent";
	buttonName2[11]  = "indent";
	 buttonName2[12]  = "seperator";
	buttonName2[13]  = "subscript";
	buttonName2[14]  = "superscript";
	buttonName2[15]  = "seperator";
	buttonName2[16]  = "inserttable";
	buttonName2[17]  = "createlink";
	buttonName2[18]  = "seperator";
	buttonName2[19]  = "viewSource";
//	buttonName2[15]  = "seperator";
//  buttonName2[16]  = "help";
...
function sendCode(n,c,d) {
  ...
  if (browserName == "Microsoft Internet Explorer") {
    var iHTML = getDocument.body.innerHTML;
    //getDocument.body.innerText = iHTML;
	document.getElementById(n).value = iHTML;
	}
