                  ...
                  <td valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<!--
                      <td width="100" align="center" background="../images/bg1_off.gif"><a href="content_article.php?B=<?php echo $_GET["B"]; ?>">Article 
                        Group</a> </td>
						-->
                      <td width="100" align="center" background="../images/bg1_off.gif"><a href="article_position.php?B=<?php echo $_GET["B"]; ?>">Manage 
                        Position</a> </td>
                    ...
                    <tr> 
                      <td><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="919B9C">
                          <tr> 
                            <td bgcolor="#FFFFFF"><iframe name="article_design" src="article_gdesign.php?B=<?php echo $_GET["B"]; ?>"  frameborder="0"  width="100%" height="100%" scrolling="yes" ></iframe></td>
                          </tr>
                        </table></td>
                    </tr>
                  </table></td>
