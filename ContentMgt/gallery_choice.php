...
window.location.href = "gallery_choice.php?B=<?php echo $_POST["B"]; ?>";
<?php }else if($_POST[choice] == '2'){?>
...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
  ...
  <tr> 
    <td><input name="choice" type="radio" value="1"  <?php if($choice[0]== '1' || $choice[0]==''){ echo 'checked';} ?>>
      แสดงห้องแสดงภาพแบบ[Row * Columns] 
    ...
    <td><input name="choice" type="radio" value="2" <?php if($choice[0]== '2' ){ echo 'checked';} ?>>
      แสดงห้องแสดงภาพแบบเลือกรายการเอง <?php if($choice[0]== '2'){ ?>[<a href="gallery_list.php?B=<?php echo $_GET["B"]; ?>">เลือกหมวดห้องแสดงภาพ</a>] <?php } ?></td>
  </tr>  <tr>
      <td>เลือกรูปแบบการแสดงผล
        <input name="display" type="radio" <?php if($choice[0]== '2' ){ echo 'checked';} ?>>
        แบบมาตราฐาน
        <input name="display" type="radio" value="Y" <?php if($choice[0]== '2' ){ echo 'checked';} ?>>
        แบบที่ 2</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
