...
<div style="width:100%; text-align:right; margin:5px 5px 0 0;">
<form method="post" action="content_graph_data_upload.php" enctype="multipart/form-data" onSubmit="javascript:return chkFileType();">
<span style="color:#FFF;">Only .csv file is acceptable.&nbsp;&nbsp;</span>
	<input type="hidden" name="graph_id" id="graph_id" value="<?php echo $graph_id?>" />
	<input type="file" name="csvFile" id="csvFile" />&nbsp;&nbsp;<input type="submit" value="Upload" />&nbsp;&nbsp;<a href="content_graph_data_export.php?graph_id=<?php echo $graph_id?>" target="_blank" style="color:#FFF;">Export</a>
</form>
	</div> 
