...
GROUP BY news_id ");
	   $body .= $db->db_num_rows($sql_nid);
		...
		//set mail
		$to  =$_POST[email_user];
		$subject = "รายงานการ Download ข่าว/บทความ";
			...
			$body ='<html>
						...
						<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
							...
							<tr > 
								  ...
								  <table width="100%" border="0" >
								<tr > 
								  <td height="18" colspan="3" align="center" bgcolor="#FFFFFF" >รายงานการ Download ข่าว/บทความ['.$_POST[search_word].']</td>
								</tr>
									<tr > 
								  <td height="18" colspan="3" align="center" bgcolor="#FFFFFF" >ระหว่างวันที่ '.$start_date.' ถึงวันที่ '.$end_date.'</td>
								</tr>
						...
						<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
							  ...
							  <tr >
								<td height="18" colspan="4" align="center" bgcolor="#FFFFFF"><table width="100%" border="0" >
								  <tr >
									<td height="18" colspan="4" align="center" bgcolor="#FFFFFF" >รายงานการ Download ข่าว/บทความ['.$_POST[search_word].']</td>
								  </tr>
								  <tr >
							...
							$wh = substr($wh1,0,-3);
							if($wh != ''){
							$wh = "WHERE " .$wh."  and   news_use='4'  and n_owner =".$_POST[n_owner];
							}
...
<form name="form1" method="post" action="article_admin_stat_mail.php">
  <table width="300" border="0" class="ewtnormal">
    <tr>
      <td height="33" colspan="2"><p class="ewtsubmenu"><strong><img src="../images/arrow_r.gif" width="7" height="7"> ส่งรายงานการ Download ข่าว/บทความทางอีเมล์</strong></p></td>
    </tr>
    <tr>
