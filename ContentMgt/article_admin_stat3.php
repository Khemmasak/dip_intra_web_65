...
<table width="80%" border="0" align="center" cellpadding="5" cellspacing="0">
  <tr>
	...
	<span class="ewtfunction"><a href="article_admin_stat.php">รายงานการใช้งานข่าว/บทความ</a> >> <a href="article_admin_stat2.php?search_word=<?php echo $_GET[search_word]; ?>&&start_date=<?php echo $_GET[start_date];?>&&end_date=<?php echo $_GET[end_date];?>"><?php echo $_GET[search_word];?></a> >>  <?php echo  $name;?></span></td>
  </tr>
</table>
