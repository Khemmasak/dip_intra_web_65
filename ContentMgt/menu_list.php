...
$BID = $bid_a[1];
$db->query("UPDATE block SET block_link = '".$_POST["selected"]."', block_name='".$_POST['hdBlockName']."' WHERE BID = '".$BID."' ");
...
<form name="form1" method="post" action="menu_list.php">
 <input name="Flag" type="hidden" id="Flag" value="SET">
  ...
  <tr bgcolor="#E6E6E6"> 
    <td width="70%"><strong>Menu name</strong></td>
  ...
  <tr bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='F7F7F7'" onMouseOut="this.style.backgroundColor='FFFFFF'"> 
	...
	<?php }?><?php echo $R["m_name"]; ?> </td>
    <td align="center"><a href="#select" onClick="selectG('<?php echo $R["m_id"]; ?>');">Apply</a></td>
  </tr>
  <?php
		}
		}else{
  ...
  <tr align="center" bgcolor="#FFFFFF"> 
    <td colspan="2"><strong><font color="#FF0000">Menu not found.</font></strong></td>
  </tr>
  <?php } ?>
  <tr align="center" bgcolor="#FFFFFF"> 
    <td colspan="2" align="left"><img src="../theme/main_theme/blank.gif" width="16" height="16" border="0" align="absmiddle">Block name : <input type="text" name="block_name" id="block_name" value="<?php echo $block_name; ?>"></td>
  </tr>
</table>
</body>
</html>
