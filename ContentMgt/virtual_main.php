...
<html>
<head>
<title>Virtual Tour Management</title>
          ...
          <td bgcolor="F7F7F7"><table width="100%" height="100%" border="0" cellpadding="3" cellspacing="0">
              ...
              <tr>
                <td height="10"><hr width="100%" size="1"  align="left"  color="#D8D2BD">
                  <span class="ewtsubmenu"><a href="virtual_list.php?B=<?php echo $_GET["B"]; ?>" target="virtual_move"><img src="../theme/main_theme/bullet.gif" border="0" width="16" height="16" align="absmiddle">Virtual Tour name</a></span>&nbsp;&nbsp;&nbsp;&nbsp;
				  <span class="ewtsubmenu"><a href="themes_list.php?B=<?php echo $_GET["B"]; ?>"  target="virtual_move"><img src="../theme/main_theme/bullet.gif" width="16" height="16" border="0" align="absmiddle">Theme Design for block </a></span>			 </td>
              </tr>
              <tr>
                  <td valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td><iframe name="virtual_move" src="virtual_list.php?B=<?php echo $_GET["B"]; ?>" frameborder="1" width="100%" height="100%" scrolling="yes"></iframe></td>
                    </tr>
                  </table></td>
              </tr>
            </table></td>
