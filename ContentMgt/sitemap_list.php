...
$db->write_log("update","main","แก้ไข block Sitemap ");
?>
<script language="JavaScript">
window.location.href = "sitemap_list.php?B=<?php echo $_POST["B"]; ?>";
//self.close();
</script>
<?php
}else{
...
$BLink=$R[block_link];
$sql_menu = $db->query("SELECT s_id,s_name FROM menu_setting ORDER BY s_id ASC ");
?>
<html>
<head>
...
<form name="form1" method="post" action="sitemap_list.php">
 <input name="Flag" type="hidden" id="Flag" value="SET">
  ...
  <tr bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='F7F7F7'" onMouseOut="this.style.backgroundColor='FFFFFF'"> 
	...
	<?php }?><?php echo preg_replace ($search, $replace, $R["s_name"]); ?> </td>
  ...
  <tr align="center" bgcolor="#FFFFFF"> 
    <td colspan="2"><strong><font color="#FF0000">Sitemap not found.</font></strong></td>
  </tr>
  <?php } ?>
</table>
</body>
