...
$group = "SELECT filename FROM  temp_index  WHERE temp_index.filename = '".$_GET["filename"]."'";
...
exit;
		...
		$pass = "Y";
			...
			for($i=0;$i<$num;$i++){
				if($_SESSION["EWT_OPEN_SAVE"][$i] == $_GET["filename"]){
					$pass = "N";
				}
			}
			if($pass == "Y"){
				array_push($_SESSION["EWT_OPEN_SAVE"],$_GET["filename"]);
			}
...
function SaveChange_old(){
		iframe_data.auto_save.document.form1.tagdetect.value=plustext();
		iframe_data.auto_save.form1.submit();
}
function SaveAsTemplate(c){
				SaveChange();
				win2 = window.open('content_template.php?filename=' + c + '','ContentTemplate','scrollbars=yes,top=20,left=80,width=640,height=550,resizable=1,status=0');
				win2.focus();
}
...
function Properties(c){
				win2 = window.open('<?php echo $EWT_PATH; ?>ContentMgt/content_properties.php?filename='+c+'','ContentProperties','top=20,left=80,width=800,height=550,resizable=1,status=0');
				win2.focus();
}
</script>
</head>
...
<?php include("../menu_ajax.php");?>
  ...
  <tr> 
    <td width="64" height="75"><img src="../theme/main_theme/g_page_64.gif" > </td>
                <td>	<span class="ewthead">Page : <?php echo $_GET["filename"]; ?></span>
                  <hr width="100%" size="1"  align="left"  color="#D8D2BD">
                  &nbsp;<?php if($cms_hidden){ ?><a href="#new" onClick="newPage()"><img src="../images/bar_new.gif"  alt="../theme/main_theme/icon_jquery_gif64/bar_new.gif" border="0"  title="New Page"></a> 
			<a href="#open" onClick="openPage()"><img  src="../images/bar_open.gif"  alt="../theme/main_theme/icon_jquery_gif64/bar_open.gif" border="0"  title="Open"></a> 
			...
			<a href="#save" onClick="SaveChange()"><img src="../images/bar_save.gif"  alt="../theme/main_theme/icon_jquery_gif64/bar_save.gif" border="0" title="Save"></a>
            <?php if($db->check_permission("cms","a",$R[Main_Group_ID])){ ?>
            <a href="#public"  onClick="Public()"><img src="../images/bar_public.gif"  alt="../theme/main_theme/icon_jquery_gif64/bar_public.gif" border="0"title="Public"></a>
            <?php } ?>
        <a href="#properties" onClick="Properties('<?php echo $_GET["filename"]; ?>')"><img src="../images/bar_properties.gif"  alt="../theme/main_theme/icon_jquery_gif64/bar_properties.gif" border="0"title="Page Properties"></a> 
		<a href="#preview" onClick="SaveAsTemplate('<?php echo $_GET["filename"]; ?>')"><img src="../images/bar_save_as.gif"  alt="../theme/main_theme/icon_jquery_gif64/bar_save_as.gif" border="0"title="Save As Template..."></a> 
	<a href="#preview" onClick="ContentShare('<?php echo $_GET["filename"]; ?>')"><img  src="../images/share.gif"  alt="../theme/main_theme/icon_jquery_gif64/share.gif" border="0" title="Share Content..."></a><img  src="../images/o.gif"  alt="../theme/main_theme/icon_jquery_gif64/g_blank.gif" border="0" title=" "><?php } ?>
	<br><br><br><br>
		  </td>
  </tr>
</table>
  ...
  <tr>
    <td  bgcolor="#9D9DA1" ><iframe name="iframe_data" src="../ewt/<?php echo $_SESSION["EWT_SUSER"]; ?>/ewt_preview.php?filename=<?php echo $_GET["filename"]; ?>" frameborder="1" width="100%" height="100%" scrolling="yes"></iframe></td>
  </tr>
</table>
</body>
</html>
