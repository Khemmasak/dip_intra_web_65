    ...
    <td valign="top" bgcolor="#F4F4F4" class="MemberTitle">  
	  ...
	  <tr class="ewttablehead">
        ...
        <form name="form1" method="post" action="proc_ebook.php" onsubmit="return ck();">
          <?php  ?>
          <tr bgcolor="#FFFFFF">
            <td width="38%" height="13" valign="top">ขนาดที่จำกัดของไฟล์ประเภท Media<!--Media file maximumsize *--></td>
            <td width="62%"  align="left" valign="top"><label>
              <input class="form-control" style="width:50%;" name="ebook_value1" type="text" id="ebook_value1" size="7" maxlength="5" value="<?php echo $maxSize?>">
            KB </label></td>
          </tr>
          <tr bgcolor="#FFFFFF">
            <td width="22%" height="12" valign="top">ขนาดที่จำกัดของไฟล์ประเภท PDF<!--PDF file maximumsize  *--></td>
            <td  align="left" valign="top">
			<input class="form-control" style="width:50%;" name="ebook_value2" id="ebook_value2" type="text"  size="7" maxlength="5" value="<?php echo $maxPDFSize?>">
              MB </td>
          </tr>
          <tr bgcolor="#FFFFFF">
