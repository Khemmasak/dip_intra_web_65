...
$sel = "select ebook_group.g_ebook_name,ebook_info.* from ebook_info inner join ebook_group on  ebook_info.g_ebook_id = ebook_group.g_ebook_id where ebook_info.g_ebook_id = '".$_SESSION['g_ebook_id']."' $wh order by ebook_code";
