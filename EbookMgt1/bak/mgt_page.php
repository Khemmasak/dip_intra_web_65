...
<script language="javascript">
   function chkFile (obj) {
	 ...
	 sur =  sur.toLowerCase();
      ...
      if (sur!='jpg' && sur!='gif' && sur!='png' && sur!='jpeg' && sur!='swf' && sur!='pdf') {
...
<form name="form1" method="post" action="proc_ebook.php" enctype="multipart/form-data">
    ...
    <tr>
      <td valign="top" bgcolor="#F4F4F4" class="MemberTitle">
        <table width="100%" height="100%" border="0" cellpadding="5" cellspacing="1"  class="ewttableuse">
		 <td  colspan="2" class="ewttablehead"> Modify Page : &quot; <?php echo $recEbook['ebook_name'];?> &quot;  </td>  </tr>
       ...
       <span id="rowPic">
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td width="81%"  align="left" valign="top">
                  <input type="file" name="pageFile<?php echo $refPage?>" onChange="chkFile (this);">             </td>
            </tr>
            <tr bgcolor="#FFFFFF" id="pdfout" style="display:none">
              ...
              <input name="zoom" type="text" size="5" value="60"> 
              % Quality 
              <input name="quality" type="text" size="5" value="60"> 
              % </td>
            </tr>
			<?php 
			  $refPage++;
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td  align="left" valign="top"><label>
                 * ต้องเป็นไฟล์นามสกุล GIF,PNG,JPG,JPEG,SWF(Flash 8 up) /ขนาดไฟล์ไม่เกิน 
                 <?php echo $maxSize;?>
              K<br>
                <?php 
				if($pos == '1' || $pos2 == '1'){
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="3">
          <tr>
            <td  ><a href="mgt_page.php?ebookCode=<?php echo $ebookCode;?>"><img src="images/element_new.png" alt="เพิ่มหน้า" width="16" height="16" border="0" align="absmiddle">เพิ่มหน้า</a> | <img src="images/element_new_before.png" alt="แทรกหน้า" width="16" height="16" align="absmiddle">แทรกหน้า
              <input name="insertPage" type="text" id="insertPage" size="2">
