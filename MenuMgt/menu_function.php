...
$m_name = str_replace("&lt;br&gt;","<br>",$m_name);
...
if($_POST["Flag"] == "Add"){
	...
	if($db->db_num_rows($sql_check) > 0){
		...
		$M = $db->db_fetch_row($sql_max);
				...
				?>
			<script language="javascript">
				location.href = "menu_main.php?m_id=<?php echo sprintf("%04d",$M[0]); ?>";
			</script>
		<?php
}
	...
	$exec = $db->query("SELECT mp_id FROM menu_properties WHERE m_id = '".$_POST["m_id"]."' ORDER BY mp_id DESC");
		...
		$_SESSION["EWT_MENU_POSITION"] = $gen_menu;
			...
			<script language="javascript">
				...
				parent.menu_main.location.reload();
				location.href = "menu_detail.php?mp_id=<?php echo $gen_menu; ?>";
			</script>
		<?php
				exit;
}
...
<script language="JavaScript">
				parent.menu_left.location.reload();
				parent.menu_main.location.reload();
				location.href = "menu_detail.php?mp_id=<?php echo $_POST["mp_id"]; ?>";
</script>
<?php
}
if($_POST["Flag"] == "AFTER"){
...
<script language="JavaScript">
		parent.menu_left.location.reload();
				parent.menu_main.location.reload();
		location.href = "menu_properties.php?m_id=<?php echo sprintf("%04d",$_POST["m_id"]); ?>";
</script>
<?php 
	}
if($_POST["Flag"] == "EDIT"){
	...
	$mp_name = str_replace(" ","&nbsp;",$mp_name);
	$mp_name = str_replace("&lt;br&gt;","<br>",$mp_name);
	...
	<script language="JavaScript">
		parent.menu_left.location.reload();
					parent.menu_main.location.reload();
		location.href = "menu_apply1.php?m_id=<?php echo $_POST["m_id"]; ?>&mp_id=<?php echo $_POST["mp_id"]; ?>&tb_show=<?php echo $_POST["tbshow"]; ?>";
	</script>
	<?php
}
...
<script language="JavaScript">
	parent.menu_left.location.reload();
				parent.menu_main.location.reload();
	location.href = "menu_detail.php?mp_id=<?php echo $_POST["mp_id"]; ?>&tb_show=<?php echo $_POST["tbshow"]; ?>";
</script>
<?php
		}
	}
...
if($_POST["Flag"] == "EDIT_MAIN"){
	...
	<script language="JavaScript">
		parent.menu_left.location.reload();
		parent.menu_main.location.reload();
		location.href="menu_properties.php?m_id=<?php echo $_POST["m_id"]; ?>&tb_show=<?php echo $_POST["tbshow"]; ?>";
	</script>
	<?php
}
  ...
  //  $db->query("Update article_group SET c_rss='' WHERE c_id = '$chk'");
	...
	?>
			<script language="javascript">
				...
				location.href = "menu_sitemap.php";
			</script>
	<?php
}
