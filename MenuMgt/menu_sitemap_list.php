                  ...
                  <td colspan="2" valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr height="25"> 
                      ...
                      <td width="100" align="center" background="../images/bg1_on.gif">Manage 
                        Position </td>
                      <td width="100" align="center" background="../images/bg3_off.gif"><a href="menu_sitemap_design.php?sid=<?php echo $sid; ?>">Design</a> </td>
                      <td background="../images/bg2_off.gif">&nbsp;</td>
                    </tr>
					</table>					</td>
                    </tr>
                    <tr> 
                      <td><iframe name="sitemap_data" src="menu_sitemap_all.php?sid=<?php echo $sid;?>" frameborder="1" width="100%" height="100%" scrolling="yes"></iframe></td>
                    </tr>
                  </table></td>
              </tr>
            </table></td>
