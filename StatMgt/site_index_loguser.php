...
<table width="96%" border="0" align="center" cellpadding="5" cellspacing="0">
  ...
  <tr> 
    <td><img src="../theme/main_theme/logo.gif" width="32" height="32" align="absmiddle"> 
      <span class="ewtfunction">สถิติการใช้งานระบบบริหาร(Log User)ย้อนหลัง</span> </td>
  </tr>
</table></td>
    </tr>
  </form>
...
<table width="94%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#CECECE" class="ewttableuse">
  ...
  $sql = "select * from list_name where list_type ='log_user' and list_site = '".$EWT_FOLDER_USER."' order by list_id ASC";
  $query = $db->query($sql);
  while($R = $db->db_fetch_array($query)){
  ?>
  <tr bgcolor="#FFFFFF"> 
    <td align="center"><nobr><a href="view_log_old.php?db=<?php echo base64_encode ( $R["list_id"]."EX".$R["list_dbname"]."EX"); ?>"><img src="../theme/main_theme/g_view.gif" width="16" height="16" border="0" align="absmiddle" alt="ดูข้อมูล"></a> </nobr></td>
