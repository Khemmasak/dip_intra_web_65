...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#333333">
  ...
  <tr> 
    <td width="60" height="58"><img src="../theme/main_theme/g_sitestats_64.gif"> </td>
                <td><span class="ewthead">สถิติเว็บไซต์</span>
                  <hr width="100%" size="1"  align="left"  color="#D8D2BD">
                  <span class="ewtsubmenu"><a href="site_index_main.php" target="iframe_data"><img src="../theme/main_theme/statday_modulesub.gif" width="16" height="16" align="absmiddle" border = "0">
      สถิติการเยี่ยมชมเว็บไซต์(Visitor stat)</a></span>
	  <span class="ewtsubmenu"><a href="site_index_article.php" target="iframe_data"><img src="../theme/main_theme/statday_modulesub.gif" width="16" height="16" align="absmiddle" border = "0">
      สถิติการข่าว/บทความ(Article Stat)</a></span>
	  <span class="ewtsubmenu"><a href="site_index_loguser.php" target="iframe_data"><img src="../theme/main_theme/statday_modulesub.gif" width="16" height="16" align="absmiddle" border = "0">
      สถิติการใช้งานระบบบริหาร(Log User)</a></span> </td>
  </tr>
</table>
	  </td>
  </tr>
  ...
  <tr> 
    <td valign="top" bgcolor="#FFFFFF"><table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
                      <tr> 
                        <td bgcolor="#FFFFFF"><iframe name="iframe_data" src="site_index_main.php" frameborder="0"  width="100%" height="100%" scrolling="yes"></iframe></td>
                      </tr>
