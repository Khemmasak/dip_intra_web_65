...
<tr> 
<td align=\"center\" class=\"cal_head\"><a class=\"cal_head\" href=\"" . $_SERVER['PHP_SELF'] . "?searchs=".$searchs."&amp;searche=".$searche."&amp;date=" . 
...
$date1 = sprintf("%02d",$i)."/".sprintf("%02d",$month)."/".($year + 543);
   ...
   $a1 = "onClick=\"parent.location.href='site_index.php?start_date=".$date1."'\"";
