          ...
          <div class="box box-border">
			...
			<form id="form_main" name="form_main" method="POST" action="process.php" enctype="multipart/form-data" >
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<input class="form-control" type="text" name="EWT_User" value="admin" required />
					</div>
					<div class="form-group">
					...
					<input class="form-control" type="password" name="EWT_Password" value="admin" required />
					</div>
					...
					<input class="form-control " type="text" name="chkpic" id="chkpic" required="required" value="<? echo $_SESSION['captchacode'] ?>" autocomplete="off" />
					</div>
				</div>
				<div class="col-md-12 col-sm-12 col-xs-12">	
