...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#333333">
  ...
  <tr> 
    <td width="60" height="58"><img src="../theme/main_theme/g_gallery_64.gif" width="64" height="64" > </td>
          <td><span class="ewthead">E-Card Management</span>
                  <hr width="100%" size="1"  align="left"  color="#D8D2BD">
                  <span class="ewtsubmenu"><img src="../theme/main_theme/virtual_modulesub_main.gif" width="16" height="16" align="absmiddle"><a href="ecard_list.php" target="iframe_data"> E-Card </a>
				  <img src="../theme/main_theme/virtual_modulesub_main.gif" width="16" height="16" align="absmiddle"><a href="ecard_history.php" target="iframe_data"> ประวัติการส่ง E-Card </a>
				  </span></td>
  </tr>
</table>
	  </td>
