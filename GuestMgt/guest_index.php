...
$db->write_log("view","guesbook","เข้าสู่ module การจัดการสมุดเยี่ยมชม ");
	if($_GET[url] != ''){
	$link = $_GET[url];
	}else{
	$link = 'guest_cate.php';
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#333333">
  ...
  <tr> 
    <td width="60" height="58"><img src="../theme/main_theme/g_guestbook_64.gif"> </td>
                
          <td><span class="ewthead"><?php echo $text_genguest_module;?></span> 
            <hr width="100%" size="1"  align="left"  color="#D8D2BD">
            <span class="ewtsubmenu"><a href="guest_cate.php" target="iframe_data"><img src="../theme/main_theme/guest_modulesub_main.gif" width="16" height="16" align="absmiddle" border="0"> <?php echo $text_genguest_modulesub_main1;?></a></span>
            <span class="ewtsubmenu"><a href="guest_config.php" target="iframe_data"><img src="../theme/main_theme/guest_modulesub_setting.gif" width="16" height="16" align="absmiddle" border="0"> <?php echo $text_genguest_modulesub_main2;?></a></span>
            <span class="ewtsubmenu"><a href="guest_group.php" target="iframe_data"><img src="../theme/main_theme/guest_modulesub_setting.gif" width="16" height="16" align="absmiddle" border="0"> หัวข้อสมุดเยี่ยมชม</a></span>
		  </td>
  </tr>
</table>
	  </td>
