...
<img src="<?=$IMG_PATH ;?>images/Gallery.png" class="animated fadeInDown " style="height: 60px;width: 60px;">  
<span class="animated fadeInDown text-large hidden-xs"><?="Gallery Management";?></span>
</div>
...
<a href="gallery_main.php" title="<?='หน้าหลัก Gallery';?>"  target="_self">
<button type="button" class="btn btn-default btn-sm" >
          <i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?='หน้าหลัก Gallery';?>
</button>
</a>
...
<div class="btn-group ">
        ...
        <ul class="dropdown-menu dropdown-menu-right">
            ...
            <li><a href="gallery_main.php"><i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?='หน้าหลัก Gallery';?></a></li>
