...
<h4><?php echo $txt_site_menu_embad;?></h4>
<p></p> 
...
<ol class="breadcrumb">
<li><a href="site_embad.php"><?php echo $txt_site_menu_embad;?></a></li>
<li class=""></li>       
</ol>
</div>
...
<img src="<?php echo $IMG_PATH ;?>images/messenger-logo.png" _class="animated fadeInDown " style="height: 80px;width:80px;">  
</div>
<div class="col-md-8 col-sm-8 col-xs-8"  >
เครื่องมือแชทผ่านหน้าเว็บไซต์ โดยไม่ต้องเปิดเว็บไซต์ Facebook
<div>
