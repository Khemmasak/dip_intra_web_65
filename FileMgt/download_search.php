...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <form name="formSearch" method="post" action="download_search.php"><tr>
    <td height="40" bgcolor="F3F3EE">&nbsp;&nbsp;&nbsp;<a href="<?php if($_SERVER["HTTP_REFERER"] != ""){ echo $_SERVER["HTTP_REFERER"]; }else{ echo "download_index.php"; } ?>" ><img src="../images/content_back.gif" width="24" height="24" border="0" align="absmiddle"> 
...
<tr>
  ...
  <tr>
	...
	if($_POST["Flag"] == "Search"){
		...
		$db->write_log("search","uploadfile","ค้นหา file name :   ".$_POST["c_search"]);
...
echo "<tr> 
              <td width=\"65%\" height=\"30\" bgcolor=\"F7F7F7\">&nbsp;&nbsp;<a onDblClick=\"self.location.href='download_index.php?myfolder=".base64_encode($mdir.$file)."';\"><img src=\"../images/content_folder.gif\" width=\"24\" height=\"24\" border=\"0\" align=\"absmiddle\"> ".$file."</a> </td>
              <td width=\"35%\" nowrap>";
			  if($mdir == ""){
			  echo "<a onDblClick=\"self.location.href='download_index.php';\"><img src=\"../images/folder_dl.gif\" width=\"16\" height=\"16\" border=\"0\" align=\"absmiddle\"> My Download";
			  }else{
			  echo "<a onDblClick=\"self.location.href='download_index.php?myfolder=".base64_encode(substr($mdir,0,-1))."';\"><img src=\"../images/folder_closed.gif\" width=\"16\" height=\"16\" border=\"0\" align=\"absmiddle\"> ".substr($mdir,0,-1);
			  }
echo "</a></td>
            </tr>";
					}
				LooPDir($Current_Dir."/".$file,$obj_pos,$mdir.$file."/");
					...
					$ftype = explode(".",$file);
echo "<tr> 
              <td width=\"65%\" height=\"30\" bgcolor=\"F7F7F7\">&nbsp;&nbsp;<a onDblClick=\"Editfile('".$mdir.$file."','".$ftype[1]."')\"><img src=\"".imageShow($ftype[1])."\" width=\"24\" height=\"24\" border=\"0\" align=\"absmiddle\"> ".$file."</a> </td>
              <td width=\"35%\" nowrap>";
			  if($mdir == ""){
			  echo "<a onDblClick=\"self.location.href='download_index.php';\"><img src=\"../images/folder_dl.gif\" width=\"16\" height=\"16\" border=\"0\" align=\"absmiddle\"> My Download";
			  }else{
