...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="A3C7E2">
  <tr> 
    <td height="30" background="../images/f_bg.gif" bgcolor="E8F1F8">&nbsp;&nbsp;<strong><img src="../images/arrow_r.gif" width="7" height="7" align="absmiddle"> 
      Images file </strong> </td>
  </tr>
  <tr> 
    <td height="50" valign="top" bgcolor="E8F1F8"><table width="90%" border="0" align="center" cellpadding="3" cellspacing="1">
        <!-- <tr> 
        ...
        <form name="form2" enctype="multipart/form-data" method="post" action="file_images.php">
          <tr> 
          ...
          <tr> 
            ...
            <td><input type="submit" name="Submit2" value="Upload">
              <input name="Flag" type="hidden" id="Flag" value="Upload"></td>
          </tr>
        </form>
      </table></td>
  </tr>
    ...
    <td bgcolor="F7F7F7"><iframe name="img_preview"  frameborder="1"  width="100%" height="100%" scrolling="auto"></iframe></td>
		  ...
		  <DIV align="center"  style="HEIGHT: 100%;OVERFLOW-Y: auto;WIDTH: 100%"> 
              <table width="100%" border="0" cellspacing="0" cellpadding="2">
                <form name="form3" method="post" action="file_images.php">
