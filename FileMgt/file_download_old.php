...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="AFA9B4">
  <tr> 
    <td height="30" background="../images/d_bg.gif" bgcolor="E8F1F8">&nbsp;&nbsp;<strong><img src="../images/arrow_r.gif" width="7" height="7" align="absmiddle"> 
      Download file </strong> </td>
  </tr>
  <tr> 
    <td height="50" valign="top" bgcolor="F1EFF4"><table width="90%" border="0" align="center" cellpadding="3" cellspacing="1">
        ...
        <form name="form2" enctype="multipart/form-data" method="post" action="file_download.php">
          <tr> 
        ...
        <tr bgcolor="#FFFFFF"> 
		  ...
		  <DIV align="center"  style="HEIGHT: 100%;OVERFLOW-Y: auto;WIDTH: 100%"> 
              <table width="100%" border="0" cellspacing="0" cellpadding="2">
                <form name="form3" method="post" action="file_download.php">
