...
<tr>
  ...
  <tr>
    ...
    <tr>
    <td height="<?php if($db->check_permission("dl","w","")){ echo "40"; }else{ echo "1"; } ?>" bgcolor="F3F3EE"><span <?php if(!$db->check_permission("dl","w","")){ echo "style=\"display:none\""; } ?>>&nbsp;&nbsp;&nbsp;<a href="#new" onClick="create_folder();"><img src="../images/content_new_folder.gif" width="24" height="24" border="0" align="absmiddle"> 
    ...
    <td valign="top" bgcolor="#FFFFFF"><table width="100%" height="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
		...
		$objFolder = opendir($Current_Dir);
			...
			$f++;
			  ...
			  ?>
        <tr bgcolor="#FFFFFF"> 
          <td align="center" valign="top"><a id="divstart">
  ...
  ?>
                <td width="25%" valign="top" align="center"  id="ah<?php echo $i; ?>"  onClick="hlah('<?php echo $i; ?>','<?php echo $array_file[$y][0]; ?>','<?php echo $preview_path_en; ?>','Fi')" onDblClick="Editfile('<?php echo $preview_path; ?>','<?php echo $ftype[1]; ?>')"><img src="<?php echo imageShow($ftype[1]); ?>" width="24" height="24" border="0" align="absmiddle" title="<?php echo ShowSize($array_file[$y][1]); ?>"> 
                  <div><?php echo $array_file[$y][0]; ?></div></td>
                <?php 
    		if($i%4 == 3){
				echo "</tr>";
			}
