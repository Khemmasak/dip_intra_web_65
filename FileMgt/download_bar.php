...
<td width="100" style="font-size:12px;" align="center" background="../images/bg1_off.gif" ><a href="#design" onClick="self.parent.location.href='article_main.php?stype=<?php echo $_REQUEST["stype"]; ?>&Flag=<?php echo $_REQUEST["Flag"]; ?>&filename=<?php echo $_REQUEST["filename"]; ?>&o_value=<?php echo $_REQUEST["o_value"]; ?>&o_preview=<?php echo $_REQUEST["o_preview"]; ?>';">
My Article </a></td>
...
My Gallery </a></td>
<td width="100" style="font-size:12px;" align="center" background="../images/bg1_on.gif"><a href="#design" onClick="self.parent.location.href='download_main.php?stype=<?php echo $_REQUEST["stype"]; ?>&Flag=<?php echo $_REQUEST["Flag"]; ?>&filename=<?php echo $_REQUEST["filename"]; ?>&o_value=<?php echo $_REQUEST["o_value"]; ?>&o_preview=<?php echo $_REQUEST["o_preview"]; ?>';">
My Download </a></td>
...
</tr><input type="hidden" name="num" value="0">
</form>
</table>
</body>
</html>
