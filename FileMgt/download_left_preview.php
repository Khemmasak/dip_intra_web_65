...
$width = "";
	...
	}elseif($size[0] > 240 AND $size[1] <= 200){
		$width = "240";
	}elseif($size[0] <= 240 AND $size[1] > 200){
		$height = "240";
	}else{
...
<table width="100%" height="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="9D9DA1">
  ...
  <div align="center">(<?php echo $size[0]; ?> X <?php echo $size[1]; ?>)
	<?php
	}elseif(($file_type[1] == "gif") OR ($file_type[1] == "jpg") OR ($file_type[1] == "bmp") OR ($file_type[1] == "png") OR ($file_type == "jpeg")){
	?>
	<img src="<?php echo $Current_Dir; ?>" hspace="0" vspace="0" border="2" style="border-color:EEEEEE" <?php if($width != ""){ echo " width = \"".$width."\""; } if($height != ""){ echo " height = \"".$height."\""; } ?>> 
