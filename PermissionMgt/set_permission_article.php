...
<div class="card ">
	...
	<div class="scrollbar scrollbar-near-moon thin">
		<div class="card-body">
			...
			<div class="checkbox">&nbsp;&nbsp;
					<label>
						<input name="chk" id="chk0"  type="checkbox" value="0" <?php echo $check; ?> _onClick="chkdis(this,'0',0,<?php echo $numfolder ?>);" />
			...
			<ul id="ditp_tree" class="demo1" style="width: 100%;">
				...
				<li class="expanded " data-value="0">
					<div class="checkbox">&nbsp;&nbsp;
						<label>
							<input name="chk" id="chk" type="checkbox" value="0" <?php echo $supcheck; ?> />
						...
						if ($a_rows) {
							while ($_item = $db->db_fetch_array($s_group)) {
								...
								<li>
									<div class="checkbox">&nbsp;&nbsp;
										<label>
											<input type="checkbox" <?php echo $s_chk; ?> id="c_cate<?php echo $_item['c_id']; ?>" name="c_cate[<?php echo $_item['c_id']; ?>]" value="<?php echo $_item['c_id']; ?>" />
