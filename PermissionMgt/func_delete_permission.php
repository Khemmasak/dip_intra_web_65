...
if($a_data['proc']=='DelPer'){

del('permission','p_id='.$a_data['id']);

if($a_data['s_type'] == 'art'){
	del('permission','pu_id='.$a_data['pu_id'].' AND s_type="Ag"');
}elseif($a_data['s_type'] == 'webboard'){
	del('permission','pu_id='.$a_data['pu_id'].' AND s_type="Wb"');
}
