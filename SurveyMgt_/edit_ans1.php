...
<body leftmargin="0" topmargin="0"><form name="form1" method="post" action="function_eqa.php" ><br>

  <table width="95%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="B2B4BF" class="txt11">
    <tr bgcolor="B2B4BF"> 
      <td colspan="2"> 
        <div align="left"><strong><font face="MS Sans Serif"> 
  ...
  $i=0;
   while($Q = mysql_fetch_array($SQL2)){ ?>
    <tr bgcolor="ECEBF0"> 
      <td width="30%"> 
        <div align="center"><font face="MS Sans Serif"><?php echo $lang_add_question_answerrank; ?> 
          <?php echo $i+1; ?>
          </font></div>      </td>
	  ...
	  <td width="9%" align="center"><font face="MS Sans Serif"> 
        <input name="pos<?php echo $i; ?>" type="text" id="pos<?php echo $i; ?>" value="<?php echo $Q[option3]; ?>" size="3">
        </font></td>
      
      <td width="17%" align="center"><font face="MS Sans Serif"> 
  ...
  $i++;
    ...
    <tr bgcolor="ECEBF0"> 
      ...
      <td width="8%" align="center"><input name="weight<?php echo $i; ?>" type="text" id="weight<?php echo $i; ?>" value="0" size="4"></td><td width="9%" align="center"><font face="MS Sans Serif"> 
