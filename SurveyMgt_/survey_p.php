...
function txt_area(prov,amph,gid) {
	...
	url='./ewt/<?php $EWT_FOLDER_USER;?>/list_tumbon.php?prov='+prov+'&&amph='+amph+'&gid='+gid;
...
<table  width="<?php if($SubjectPartW!=""){ echo $SubjectPartW; }else{ echo "98%"; } ?>" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#ECEBF0">
	...
	?>		
	  <tr bgcolor="<?php echo $Question1BGC; ?>">
	    <td valign="top"><font color="<?php echo $Question1C; ?>" size="<?php echo $Question1S; ?>" face="<?php echo $Question1F; ?>"><?php if($Question1B=="Y"){ echo "<b>"; } ?><?php if($Question1I=="Y"){ echo "<em>"; } ?><?php echo $X[q_name]; ?><?php if($Question1I=="Y"){ echo "</em>"; } ?><?php if($Question1B=="Y"){ echo "</b>"; } ?></font> <?php if($X[q_req]=="Y"){ echo "<font color='#FF0000'>*</font>"; } ?></td>
...
//selectChange_tumpon(document.getElementById('addr_amp'),document.getElementById('addr_prov'), document.getElementById('addr_tamb'), arrItemsTxt_tumpon1,arrItemsValue_tumpon1,arrItemsGrp_tumpon1,arrItemsGrp_tumpon21,'');
function GoNext(){
<?php
