...
<body leftmargin="0" topmargin="0"><form name="form1" enctype="multipart/form-data" method="post" action="function_eqa.php" onSubmit="return GoNext();"><br>
<table width="95%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt11">
  <tr>
      <td bgcolor="B2B4BF"><font face="MS Sans Serif"><?php echo $lang_edit_ansitem; ?><?php echo $qname; ?>
        <select name="sel" id="sel" onChange="ChangeBox(this.value);">
          <option value="A" <?php if($PR[q_anstype]=="A"){ echo "selected"; } ?>>Radio 
          Box</option>
          <option value="B" <?php if($PR[q_anstype]=="B"){ echo "selected"; } ?>>Check 
          Box</option>
          <option value="C" <?php if($PR[q_anstype]=="C"){ echo "selected"; } ?>>Select 
          Box</option>
          <option value="D" <?php if($PR[q_anstype]=="D"){ echo "selected"; } ?>>Text 
          Box</option>
		  <option value="E" <?php if($PR[q_anstype]=="E"){ echo "selected"; } ?>>Browse File</option>
		  <option value="F" <?php if($PR[q_anstype]=="F"){ echo "selected"; } ?>>Calendar</option>
		  <option value="G" <?php if($PR[q_anstype]=="G"){ echo "selected"; } ?>>Area</option>
        </select>
  ...
  <table id="tb1" style="display:'<?php if($PR[q_anstype]=="D" OR $PR[q_anstype]=="E" OR $PR[q_anstype]=="F" OR $PR[q_anstype]=="G"){ echo "none";} ?>'" width="95%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="B2B4BF" class="txt10">
    <tr bgcolor="B2B4BF"> 
      <td colspan="2"><font face="MS Sans Serif">&nbsp;</font></td>
      ...
      <td> 
        <div align="center"><font face="MS Sans Serif"><?php echo $lang_survey_rank; ?></font></div>      </td>
      <td> 
        <div align="center"><font face="MS Sans Serif"><?php echo $lang_survey_delete; ?></font></div>      </td>
    </tr>
    <?php
  $i = 0;
...
echo "<div id=sho></div>";
   while($R = mysql_fetch_array($SQL2)){ ?>
    <tr bgcolor="ECEBF0"> 
      <td bgcolor="ECEBF0"> 
        <div align="center"><font face="MS Sans Serif"><?php echo $lang_edit_ansnumber; ?>
          <?php echo $i+1; ?>
          </font></div>      </td>
      <td width="53%"><font face="MS Sans Serif"> 
        <?php
  ...
  <?php      if($PR[q_anstype] != "C"){ ?><input type="file" name="file<?php echo $i; ?>">
        ...
        <input name="ch<?php echo $i; ?>" type="checkbox" value="Y" <?php if($R[a_other]=="Y"){ echo "checked"; } ?>>
        <?php echo $lang_edit_type_other; ?> <?php } ?></font></td>
      ...
      <td align="center" bgcolor="ECEBF0"><font face="MS Sans Serif"> 
        <input type="radio" name="defa" value="<?php echo $i+1; ?>" <?php if($R[option4]=="Y"){ echo "checked"; } ?>>
        </font></td>
      <td align="center" bgcolor="ECEBF0"><font face="MS Sans Serif"> 
    ...
    <tr bgcolor="ECEBF0" id="sho"> 
      <td colspan="6"> 
        <div align="center"><font color="#FF0000" face="MS Sans Serif"><?php echo $lang_edit_noans; ?></font></div>      </td>
    </tr>
    <?php
  $m="Y";
   } ?>
    <tr bgcolor="ECEBF0" id="hid" style="display:none"> 
      ...
      <td bgcolor="ECEBF0"><font face="MS Sans Serif"> 
      ...
      <td align="center" bgcolor="ECEBF0"><font face="MS Sans Serif">&nbsp;</font></td>
    </tr>
    <tr bgcolor="ECEBF0"> 
      <td bgcolor="B2B4BF"> 
        <div align="center"> <font face="MS Sans Serif"> 
      ...
      <td colspan="5" bgcolor="B2B4BF"> 
        <div align="right"> <font face="MS Sans Serif"> 
          ...
          <input name="SubmitX" type="submit" id="SubmitX" value="<?php echo $lang_survey_update; ?>" <?php if($m=="Y"){ echo "disabled"; } ?>>
          <input name="SubmitY" type="submit" id="SubmitY" value="<?php echo $lang_survey_save; ?>" <?php if($m=="Y"){ echo "disabled"; } ?>>
          </font></div>      </td>
    </tr>
  </table>
<?php
 ...
 <!-- <table  id="tb2" style="display:'<?php if($PR[q_anstype]!="D"){ echo "none";} ?>'"  width="95%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="B2B4BF" class="txt10">
    <tr bgcolor="ECEBF0"> 
      ...
      <td colspan="3"><font face="MS Sans Serif"> 
        <input type="radio" name="de" value="S" onClick="document.all.T2.style.display='<?php if($PV[a_other]=="S"){ echo "none"; } ?>';document.all.T1.style.display='<?php if($PV[a_other]!="S"){ echo "none"; } ?>';" <?php if($PV[a_other]=="S"){ echo "checked"; } ?>>
    ...
    <tr id="T1" bgcolor="ECEBF0" style="display:'<?php if($PV[a_other]=="S"){ echo "none"; } ?>'"> 
      ...
      <td width="24%"><font face="MS Sans Serif"> 
        <input name="line" type="text" id="line" value="<?php if($PV[a_other]=="M"){  echo $PV[option3]; } ?>" size="3">
      ...
      <td width="28%"><font face="MS Sans Serif"> 
        <input name="wid1" type="text" id="wid1" value="<?php if($PV[a_other]=="M"){  echo $PV[option4]; } ?>" size="3">
    ...
    <tr id="T2" bgcolor="ECEBF0" style="display:'<?php if($PV[a_other]!="S"){ echo "none"; } ?>'"> 
      ...
      <td width="24%"><font face="MS Sans Serif"> 
        <input name="wor" type="text" id="wor" value="<?php if($PV[a_other]=="S"){ echo $PV[option3]; } ?>" size="3">
        <?php echo $lang_edit_character; ?>
        </font></td>
      ...
      <td width="28%"><font face="MS Sans Serif"> 
        <input name="wid2" type="text" id="wid2" value="<?php if($PV[a_other]=="S"){  echo $PV[option4]; } ?>" size="3">
        <?php echo $lang_edit_character; ?>
        </font></td>
    </tr>
    <tr bgcolor="ECEBF0"> 
  ...
  <table  id="tb4" style="display:'<?php if($PR[q_anstype]!="F" and $PR[q_anstype]!="G"){ echo "none";} ?>'"  width="95%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="B2B4BF" class="txt10">
    <tr bgcolor="ECEBF0"> 
