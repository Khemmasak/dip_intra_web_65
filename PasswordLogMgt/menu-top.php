            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <span class="animated fadeInDown text-large hidden-xs"><?= "Password Log"; ?></span>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 float-right text-right hidden-xs" style="top:18px;">
                        ...
                        <a href="systemlog_main.php" title="<?= "Password Log"; ?>" target="_self">
                            <button type="button" class="btn btn-default btn-sm">
                                <i class="far fa-arrow-alt-circle-right"></i>&nbsp;<?= "Password Log"; ?>
                            </button>
                        </a>
                    </div>
