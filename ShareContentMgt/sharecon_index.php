...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#333333">
  ...
  <tr> 
    <td width="60" height="58"><img src="../theme/main_theme/faq_module.gif" width="58" height="58"> </td>
          <td><span class="ewthead"><?php echo $text_gensharecon_module;?></span>
                  <hr width="100%" size="1"  align="left"  color="#D8D2BD">
                  <span class="ewtsubmenu"><img src="../theme/main_theme/faq_modulesub_main.gif" width="16" height="16" align="absmiddle"><a href="sharecon_main.php" target="sharecon_body"> <?php echo $text_gensharecon_modulesub_main;?> </a></span></td>
  </tr>
</table>
	  </td>
  </tr>
  ...
  <tr> 
    <td valign="top" bgcolor="#FFFFFF"><table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
                      <tr> 
                        <td bgcolor="#FFFFFF"><iframe name="sharecon_body" src="sharecon_main.php"  frameborder="0"  width="100%" height="100%" scrolling="yes"></iframe></td>
                      </tr>
