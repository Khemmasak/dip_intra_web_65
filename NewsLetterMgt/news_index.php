...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#333333">
  ...
  <tr> 
    <td width="60" height="58"><img src="../theme/main_theme/g_enews_64.gif" > </td>
          <td><span class="ewthead"><?php echo $text_genenew_module;?></span>
		    ...
		    <span class="ewtsubmenu"><a href="file_mod.php" target="iframe_data"><img src="../theme/main_theme/enews_modulesub_attach.gif" width="16" height="16" align="absmiddle" border="0" > <?php echo $text_genrss_modulesub_attact;?></a></span>&nbsp;&nbsp;&nbsp;&nbsp;
		    <span class="ewtsubmenu"><a href="temp_mod.php" target="iframe_data"><img src="../theme/main_theme/enews_modulesub_news.gif" width="16" height="16" align="absmiddle" border="0" > <?php echo $text_genrss_modulesub_news;?></a></span>&nbsp;&nbsp;&nbsp;&nbsp;
		    <span class="ewtsubmenu"><a href="mail_send.php" target="iframe_data"><img src="../theme/main_theme/enews_modulesub_email.gif" width="16" height="16" align="absmiddle" border="0"> <?php echo $text_genrss_modulesub_email;?></a></span>&nbsp;&nbsp;&nbsp;&nbsp;
