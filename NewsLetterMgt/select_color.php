...
function Set(string) {                   // select color
  ...
  if (color == null) { alert("Invalid color code: " + string); }        // invalid color
    ...
    if(document.form1.status.value=="head"){
window.opener.tbd01.style.backgroundColor = color;       
window.opener.ColorPreview01.style.backgroundColor = color;    
window.opener.form1.NLTHeadBG.value = color;   
	} else if(document.form1.status.value=="headt"){
window.opener.Hnews01.style.color = color;       
window.opener.ColorPreview02.style.backgroundColor = color;    
window.opener.form1.NLTHeadBGTC.value = color;   	
	} else if(document.form1.status.value=="body"){
window.opener.tbd02.style.backgroundColor = color;       
window.opener.ColorPreview03.style.backgroundColor = color;    
window.opener.form1.NLTBodyBG.value = color;  	
	} else if(document.form1.status.value=="bodyt"){
window.opener.Dnews01.style.color = color;     
window.opener.newsapp.style.color = color;   
window.opener.newscan.style.color = color;     
window.opener.ColorPreview04.style.backgroundColor = color;    
window.opener.form1.NLTBodyBGT.value = color;  	
	}          // set return value
...
<body bgcolor="#000000" topmargin=0 leftmargin=0 onload="Init()" onBlur="window.focus();">

<form name="form1" method=get onSubmit="Set(document.all.ColorHex.value); return false;">
...
<table border=0 cellspacing=0 cellpadding=4 width=100%>
 <tr>
  ...
  <td bgcolor="buttonface" width=100%><input name="status" type="hidden" id="status" value="<?php echo $t; ?>"></td>
 </tr>
</table>
