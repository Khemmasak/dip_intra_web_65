...
<body leftmargin="0" topmargin="0">
  <form name="form1" method="post" action="function_eqa1.php"><br>

    <table width="95%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="B2B4BF" class="txt11">
      <tr bgcolor="B2B4BF">
        <td colspan="3">
          <div align="left"><strong><?php echo $lang_add_question_answerforpart; ?> <?php echo $post; ?> </strong><?php echo $lang_lefttoright; ?></div>
      ...
      while ($Q = $db->db_fetch_array($SQL2)) { ?>
        <tr bgcolor="ECEBF0">
          <td width="30%">
            <div align="center"><?php echo $lang_edit_ansnumber; ?><?php echo $i + 1; ?></div>
          </td>
          <td width="50%"><input name="an<?php echo $i; ?>" type="text" id="an<?php echo $i; ?>" value="<?php echo $Q[a_name]; ?>" size="40">
            ...
            <input name="oan<?php echo $i; ?>" type="hidden" id="oan<?php echo $i; ?>" value="<?php echo $Q[a_name]; ?>">
          </td>
      ...
      $RRR = $db->db_fetch_array($SELL);
      ?>
      <tr bgcolor="ECEBF0">
        <td colspan="3" bgcolor="B2B4BF">
          <div align="center">
          </div>
          <div align="right">
