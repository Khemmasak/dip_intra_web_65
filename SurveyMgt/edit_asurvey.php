...
<div class="container-fluid">
	...
	$Path_true = dirname(__DIR__) ."../ewt/" . $_SESSION["EWT_SUSER"] . "/file_attach";
	//$Path_true = HTTP_HOST . "file_attach";
	$fp1 = @fopen($Path_true . "/form_topic_" . $s_id . ".html", "r");

	if (!$fp1) {
		//die("Cannot write form_topic_" . $s_id . ".html");
	}
								...
								<div id="frm_edit_s">
									<div class="panel panel-default">
										<div class="panel-heading form-inline">
											<div class="row">
												<div class="col-md-8 col-sm-8 col-xs-12 text-left">
													<h4><?php echo $PR['s_title'];//$topic; ?></h4>
												</div>
												<div class="col-md-4 col-sm-4 col-xs-12 text-right">
													<!---//edit_s.php แก้ไขหัวข้อ // -->
													<button type="button" class="btn btn-warning btn-sm pointer" onclick="boxPopup('<?php echo linkboxPopup(); ?>pop_edit_s.php?s_id=<?php echo $s_id; ?>');" data-toggle="tooltip" data-placement="top" title="<?php echo $lang_survey_edit_topic; ?>">
										...
										<div class="panel-body">
											<div class="row m-b-sm">
												<div class="col-md-12 col-sm-12 col-xs-12 m-b-sm text-left">
													<!---//add.php เพิ่มส่วน// 
													<a onclick="boxPopup('<?php echo linkboxPopup(); ?>pop_add.php?s_id=<?php echo $s_id; ?>');" data-toggle="tooltip" data-placement="top" title="<?php echo $lang_survey_add_topic2; ?>" >
													<button type="button" class="btn btn-info btn-sm"   >
												...
												?>
													<li class="productCategoryLevel1 bg-primary " id="<?php echo $_cate['c_d']; ?>_<?php echo $_cate['c_id']; ?>" style="padding-bottom:25px;">
														...
														<span class="iconAction ">
															...
															<a onclick="boxPopup('<?php echo linkboxPopup(); ?>pop_add_question.php?post=<?php echo $_cate['c_d']; ?>&path=<?php echo $_cate['c_id']; ?>&type=<?php echo $_cate['c_gp']; ?>&pos=<?php echo $row + 1; ?>');" data-toggle="tooltip" data-placement="top" title="<?php echo $lang_add3_additem; ?>" >
															<button type="button" class="btn btn-success btn-circle  btn-sm" >
															<i class="fas fa-plus-circle" aria-hidden="true"></i>
															</button> 
															</a>-->
															<!--//edit.php ปุ่มแก้ไขส่วนที่  //-->
															<a onclick="boxPopup('<?php echo linkboxPopup(); ?>pop_edit.php?post=<?php echo $_cate['c_d']; ?>&path=<?php echo $_cate['c_id']; ?>');" data-toggle="tooltip" data-placement="top" title="<?php echo $lang_add3_edititem; ?>&nbsp;<?php echo $_cate['c_d']; ?>">
																<button type="button" class="btn btn-warning btn-circle btn-sm ">
																	<i class="fas fa-edit" aria-hidden="true"></i>
																</button>
															</a>
															<!--// ปุ่มลบส่วน //	
															<a href="" onClick="JQDel_question($('<?php echo $_cate['q_id']; ?>'));" data-toggle="tooltip" data-placement="top" title="<?php echo "ลบคำถาม"; ?> <?php echo $a_question['q_pos']; ?>">
														...
														<ul id="sortableLv<?php echo $i; ?>" class="sortableLv1 " style="width: 100%;">
															...
															?>
																<li class="productCategoryLevel1 move" id="<?php echo $a_question['q_id']; ?>">
																	...
																	<a onclick="boxPopup('<?php echo linkboxPopup(); ?>pop_edit_question.php?post=<?php echo $_cate['c_d']; ?>&path=<?php echo $_cate['c_id']; ?>&type=<?php echo $_cate['c_gp']; ?>&qid=<?php echo $a_question['q_id']; ?>');" data-toggle="tooltip" data-placement="top" title="<?php echo $lang_survey_edit_question; ?>&nbsp;<?php echo $a_question['q_name']; ?>">
																		<button type="button" class="btn btn-warning btn-circle  btn-sm"><i class="far fa-edit"></i></button>
																	</a>
																	...
																	?>
																	<!--ปุ่มลบคำถาม  //	
																	<a href="" onClick="JQDel_question($('<?php echo $a_question['q_id']; ?>'));" data-toggle="tooltip" data-placement="top" title="<?php echo "ลบคำถาม"; ?> <?php echo $a_question['q_pos']; ?>">
																	<button type="button" class="btn btn-danger btn-circle  btn-sm"  ><i class="fas fa-trash-alt"></i></button> 
																	</a>-->
																</li>
															<?php }
														} else { ?>
										...
										<div class="panel-footer text-center">
											<!--<input name="SubmitT" type="button" class="txt9" id="Submit1" value="<?php echo $lang_survey_previewpage; ?>" onClick="window.open('survey_p.php?s_id=<?php echo $s_id; ?>','preview','width=500,height=500,resizable=1,status=0,scrollbars=1,location=0,top=40,left=200');">-->
											<a onclick="boxPopup('<?php echo linkboxPopup(); ?>pop_survey.php?s_id=<?php echo $s_id; ?>');">
												<button type="button" class="btn btn-info btn-lm" data-toggle="tooltip" data-placement="top" title="<?php echo $txt_form_preview; ?>">
											...
											<!--<input type="submit" class="txt9" name="Submitz" value="<? //=$lang_survey_save; 
																										?>">-->
											<button type="submit" class="btn btn-success btn-lm" data-toggle="tooltip" data-placement="top" title="<?php echo $lang_survey_save; ?>">
