...
$sel = "SELECT * FROM download_list  WHERE dl_gid='$_GET[gid]' ORDER BY dl_id ASC";
...
<table width="94%" border="0" align="center" cellpadding="0" cellspacing="0" class="ewtfunctionmenu">
  <tr>
    <td align="right"><a href="download_add.php?gid=<?php echo $_GET[gid]?>" ><img src="../theme/main_theme/g_add.gif" width="16" height="16" align="absmiddle" border="0"> เพิ่ม File ในกลุ่ม</a> &nbsp; <a href="main_download_group.php" ><img src="../theme/main_theme/g_mainpage.gif" width="16" height="16" align="absmiddle" border="0">กลับหน้าหลัก</a>
	<hr>
    </td>
  </tr>
</table>
...
<table width="94%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#CECECE" class="ewttableuse">
  <tr bgcolor="#E7E7E7"  class="ewttablehead"> 
    ...
    <td width="15%" align="center">ชื่อไฟล์</td>
    <td width="5%" align="center">ขนาดไฟล์(Kb)</td>
    <td width="10%" align="center" >วันที่สร้าง</td>
    <td width="10%" align="center">วันที่แก้ไขล่าสุด</td>
       ...
       $i = 0;
  		while($data=$db->db_fetch_array($Execsql)){ ?>
			  <tr bgcolor="#FFFFFF"> 
				...
				<td ><?php echo $data[dl_userfile];?></td>
				<td align="center"><?php echo number_format($data[dl_filesize]/1024,2);?></td>
				<td align="center"><?php echo $data[dl_createdate];?></td>
				<td align="center"><?php echo $data[dl_update];?></td>
				<td align="center">
