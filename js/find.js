...
document.write('<DIV ID="window_body" STYLE="padding: 5px;">'
	...
	+ ' onChange="resettext();">'
	+ '<INPUT TYPE="button" VALUE="ค้นหาก่อนหน้า" onClick="findprev();">'
	+ '<INPUT ID="btn" TYPE="button" VALUE="ค้นหาถัดไป" onClick="findit();">'
	+ '</DIV>\n'
	+ '<DIV ID="test"><BR></DIV>');
document.write('</DIV>');
...
document.write('<INPUT TYPE="button" VALUE="ค้นหา"'
	+ ' onClick="show();">');
