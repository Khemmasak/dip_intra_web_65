...
( function( $ )
{
	 ...
	 * @returns this to unsure chaining
	 */
	$.fn.sortableListsToArray = function( arr, parentId , Lev )
	{
		arr = arr || [];
		var order = 0;
		...
		{   var num = 1;
			...
			listItem.leval =  parseFloat(parseInt(num) + parseInt(Lev));
			arr.push( listItem );
			li.children( 'ul,ol' ).sortableListsToArray( arr, id , listItem.leval );
			order ++;
		} );
