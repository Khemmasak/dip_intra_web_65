...
;(function($, window, document, undefined) {
  ...
  $.fn.imageuploadify = function(opts) {
    ...
    this.each(function() {
      ...
      let dragbox = $(`
      <div class="imageuploadify well pointer">
        <div class="imageuploadify-overlay">
        <i class="fas fa-picture-o"></i>
        </div>
        <div class="imageuploadify-images-list text-center">
          <i class="fas fa-cloud-upload-alt fa-4x"></i> 
          <span class='imageuploadify-message'><h5>Choose Your Image to Upload</h5></span>
		  <span class='imageuploadify-message'>Or Drag & Drop Your Image Here</span>
      ...
      const disableMouseEvents = () => {
		...
		dragbox.css("border-color", "#FFFFFF");
      ...
      const enableMouseEvents = () => {
		...
		dragbox.css("border-color", "rgb(255, 255, 255)");
      ...
      button.mouseenter(function onMouseEnter(event) {
        button.css("background", "#838282").css("color", "white");
      }).mouseleave(function onMouseLeave() {
        button.css("background", "white").css("color", "#170607");
      });
		
	  dragbox.mouseenter(function onMouseEnter(event) {
        dragbox.css("background", "#FFFFFF").css("color", "#87CEFA"); 
      }).mouseleave(function onMouseLeave() {
        //dragbox.css("background", "#9de658").css("color", "#170607");
		dragbox.css("background", "#87CEFA").css("color", "#FFFFFF");
      });
	  ...
	  dragbox.on("click", function onClick(event) {
        event.stopPropagation();
        event.preventDefault();
        $(self).click();
      });
      ...
      //$(self).closest("form").on("drop", function(event) {  
