...
window.onload = function(){
	for(var i=4; i<nDemos; i++){
		Demos[i] = document.getElementById('Demo'+i);
	}

	if(Demos[4]){
		CreateDragContainer(document.getElementById('tbtop'), document.getElementById('tbleft'), document.getElementById('tbcontent'), document.getElementById('tbright'), document.getElementById('tbbottom'));
	}
	if(Demos[4]){
