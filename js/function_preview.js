...
function showtable(c){
	for(i=1;i<7;i++){
		if(i != c){
		self.parent.parent.content_properties.document.getElementById("tr0" +i).style.display='none';
		}else{
		self.parent.parent.content_properties.document.getElementById("tr0" +i).style.display='';
		}
	}
	self.parent.parent.content_properties.document.form2.tbshow.value='0'+c;
}