...
<table width="100%" height="100%" border="0" cellpadding="5" cellspacing="0" bgcolor="E0DFE3">
  <tr>
    <td bgcolor="#FFFFFF"><table width="100%" height="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="919B9C">
        <tr>
          <td bgcolor="F7F7F7"><table width="100%" height="100%" border="0" cellpadding="3" cellspacing="0">
              <tr>
                <td height="20"> <img src="../images/arrow_r.gif" width="7" height="7" border="0" align="absmiddle"> 
                 <span class="ewtfunction"> กำหนดสิทธิ์ให้ผู้อื่น  </span></td>
              </tr>
              <tr>
                  <td valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr> 
                      <td height="30"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <form name="form1" method="post" action="send_m_permission.php" target="m_data"><tr> 
                            ...
                            <td >&nbsp;&nbsp;&nbsp;ค้นหาโดย
							  ...
							  <input name="org_id" type="text" id="org_id" onKeyUp="txt_data(this.value)" value="<?php echo $org_id; ?>" size="50" autocomplete="off"  style="display:none">
