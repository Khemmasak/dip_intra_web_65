              ...
              <tr>
                  <td valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr height="25"> 
                      ...
                      <td width="100" align="center" background="../images/bg1_off.gif"><a href="site_s_member2.php?ug=<?php echo $_GET["ug"]; ?>">แผนก/หน่วยงาน</a> </td>
                     <td width="100" align="center" background="../images/bg1_off.gif"><a href="site_s_member3.php?ug=<?php echo $_GET["ug"]; ?>">ระดับ</a> </td>
                    ...
                    <tr> 
                      <td><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="919B9C">
                          <tr> 
                            <td bgcolor="#FFFFFF"><iframe name="m_data1" src="site_s4_member.php?ug=<?php echo $_GET["ug"]; ?>"  frameborder="0"  width="100%" height="100%" scrolling="yes" ></iframe></td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr align="right"> 
