              ...
              <tr>
                  <td valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr height="25"> 
                      ...
                      <td width="141" background="../images/bg1_on90.gif"><div align="center">บุคคลในสังกัด</div></td>
                      <td width="143" background="../images/bg3_off90.gif"><div align="center"><a href="ul_s_member_group.php?G=<?php echo $_GET[G];?>">บุคคลในหน่วยงาน</a></div></td>
                    ...
                    <tr> 
                      <td><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="919B9C">
                          <tr> 
                            <td bgcolor="#FFFFFF"><iframe name="m_data"  src="site_s1_member_list.php?G=<?php echo $_GET[G];?>"  frameborder="0"  width="100%" height="100%" scrolling="yes" ></iframe></td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr align="right"> 
