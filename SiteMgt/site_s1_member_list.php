...
if($_POST["Flag"] == "Add"){
	...
	$sql_user = "SELECT * FROM gen_user INNER JOIN org_name ON org_name.org_id = gen_user.org_id WHERE gen_user.org_id='".$org_id."' and gen_user.gen_user_id <> '".$_GET[G]."'";
...
<body>
<table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#CCCCCC"><form name="form1" method="post" target="_top" action="site_s1_member_list.php">
  <tr align="center" bgcolor="E0DFE3"> 
    <td width="50%" class="head_table">ชื่อ - สกุล <input name="G" type="hidden" id="G" value="<?php echo $_GET["ug"]; ?>">
